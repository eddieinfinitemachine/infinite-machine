...
`,Xt=/boundary="?([^=";]+)"?/i,Ke=Wt+Wt;function H(e,t=Y){return e.startsWith(`${t}`)?e:`${t}: ${e}`}function B(e){return e instanceof Error?e.message:JSON.stringify(e)}function We(e){return e instanceof Error&&e.cause?e.cause:void 0}function Ye(e){return e.flatMap(({errors:t})=>t!=null?t:[])}function Ce({client:e,retries:t}){if(t!==void 0&&(typeof t!="number"||t<0||t>3))throw new Error(`${e}: The provided "retries" value (${t}) is invalid - it cannot be less than ${0} or greater than ${3}`)}function L(e,t){return t&&(typeof t!="object"||Array.isArray(t)||typeof t=="object"&&Object.keys(t).length>0)?{[e]:t}:{}}function Qe(e,t){if(e.length===0)return t;let o={[e.pop()]:t};return e.length===0?o:Qe(e,o)}function ta(e,t){return Object.keys(t||{}).reduce((a,o)=>(typeof t[o]=="object"||Array.isArray(t[o]))&&e[o]?(a[o]=ta(e[o],t[o]),a):(a[o]=t[o],a),Array.isArray(e)?[...e]:{...e})}function Ze([e,...t]){return t.reduce(ta,{...e})}function Xe({clientLogger:e,customFetchApi:t=fetch,client:a=Y,defaultRetryWaitTime:o=xe,retriableCodes:n=Zt}){let r=async(i,s,c)=>{let l=s+1,d=c+1,p;try{if(p=await t(...i),e({type:"HTTP-Response",content:{requestParams:i,response:p}}),!p.ok&&n.includes(p.status)&&l<=d)throw new Error;let v=(p==null?void 0:p.headers.get("X-Shopify-API-Deprecated-Reason"))||"";return v&&e({type:"HTTP-Response-GraphQL-Deprecation-Notice",content:{requestParams:i,deprecationNotice:v}}),p}catch(v){if(l<=d){let x=p==null?void 0:p.headers.get("Retry-After");return await lo(x?parseInt(x,10):o),e({type:"HTTP-Retry",content:{requestParams:i,lastResponse:p,retryAttempt:s,maxRetries:c}}),r(i,l,c)}throw new Error(H(`${c>0?`Attempted maximum number of ${c} network retries. Last message - `:""}${B(v)}`,a))}};return r}async function lo(e){return new Promise(t=>setTimeout(t,e))}function Je({headers:e,url:t,customFetchApi:a=fetch,retries:o=0,logger:n}){Ce({client:Y,retries:o});let r={headers:e,url:t,retries:o},i=uo(n),s=Xe({customFetchApi:a,clientLogger:i,defaultRetryWaitTime:xe}),c=po(s,r),l=ho(c),d=vo(c);return{config:r,fetch:c,request:l,requestStream:d}}function uo(e){return t=>{e&&e(t)}}async function aa(e){let{errors:t,data:a,extensions:o}=await e.json();return{...L("data",a),...L("extensions",o),headers:e.headers,...t||!a?{errors:{networkStatusCode:e.status,message:H(t?Fe:Ue),...L("graphQLErrors",t),response:e}}:{}}}function po(e,{url:t,headers:a,retries:o}){return async(n,r={})=>{let{variables:i,headers:s,url:c,retries:l,keepalive:d,signal:p}=r,v=JSON.stringify({query:n,variables:i});Ce({client:Y,retries:l});let x=Object.entries({...a,...s}).reduce((y,[N,w])=>(y[N]=Array.isArray(w)?w.join(", "):w.toString(),y),{});!x[ze]&&!x[je]&&(x[ze]=Yt,x[je]=Qt);let h=[c!=null?c:t,{method:"POST",headers:x,body:v,signal:p,keepalive:d}];return e(h,1,l!=null?l:o)}}function ho(e){return async(...t)=>{if(Ge.test(t[0]))throw new Error(H("This operation will result in a streamable response - use requestStream() instead."));let a=null;try{a=await e(...t);let{status:o,statusText:n}=a,r=a.headers.get("content-type")||"";return a.ok?r.includes(ve.json)?await aa(a):{errors:{networkStatusCode:o,message:H(`${Ve} ${r}`),response:a}}:{errors:{networkStatusCode:o,message:H(n),response:a}}}catch(o){return{errors:{message:B(o),...a==null?{}:{networkStatusCode:a.status,response:a}}}}}}async function*fo(e){let t=new TextDecoder;if(e.body[Symbol.asyncIterator])for await(let a of e.body)yield t.decode(a);else{let a=e.body.getReader(),o;try{for(;!(o=await a.read()).done;)yield t.decode(o.value)}finally{a.cancel()}}}function mo(e,t){return{async*[Symbol.asyncIterator](){try{let a="";for await(let o of e)if(a+=o,a.indexOf(t)>-1){let n=a.lastIndexOf(t),i=a.slice(0,n).split(t).filter(s=>s.trim().length>0).map(s=>s.slice(s.indexOf(Ke)+Ke.length).trim());i.length>0&&(yield i),a=a.slice(n+t.length),a.trim()==="--"&&(a="")}}catch(a){throw new Error(`Error occured while processing stream payload - ${B(a)}`)}}}}function go(e){return{async*[Symbol.asyncIterator](){try{yield{...await aa(e),hasNext:!1}}catch(t){yield{errors:{message:H(B(t)),networkStatusCode:e.status,response:e},hasNext:!1}}}}}function yo(e){return e.map(t=>{try{return JSON.parse(t)}catch(a){throw new Error(`Error in parsing multipart response - ${B(a)}`)}}).map(t=>{let{data:a,incremental:o,hasNext:n,extensions:r,errors:i}=t;if(!o)return{data:a||{},...L("errors",i),...L("extensions",r),hasNext:n};let s=o.map(({data:c,path:l,errors:d})=>({data:c&&l?Qe(l,c):{},...L("errors",d)}));return{data:s.length===1?s[0].data:Ze([...s.map(({data:c})=>c)]),...L("errors",Ye(s)),hasNext:n}})}function wo(e,t){if(e.length>0)throw new Error(Fe,{cause:{graphQLErrors:e}});if(Object.keys(t).length===0)throw new Error(Ue)}function bo(e,t){var s,c;let a=(t!=null?t:"").match(Xt),o=`--${a?a[1]:"-"}`;if(!((s=e.body)!=null&&s.getReader)&&!((c=e.body)!=null&&c[Symbol.asyncIterator]))throw new Error("API multipart response did not return an iterable body",{cause:e});let n=fo(e),r={},i;return{async*[Symbol.asyncIterator](){var l,d;try{let p=!0;for await(let v of mo(n,o)){let x=yo(v);i=(d=(l=x.find(y=>y.extensions))==null?void 0:l.extensions)!=null?d:i;let h=Ye(x);r=Ze([r,...x.map(({data:y})=>y)]),p=x.slice(-1)[0].hasNext,wo(h,r),yield{...L("data",r),...L("extensions",i),hasNext:p}}if(p)throw new Error("Response stream terminated unexpectedly")}catch(p){let v=We(p);yield{...L("data",r),...L("extensions",i),errors:{message:H(B(p)),networkStatusCode:e.status,...L("graphQLErrors",v==null?void 0:v.graphQLErrors),response:e},hasNext:!1}}}}}function vo(e){return async(...t)=>{if(!Ge.test(t[0]))throw new Error(H("This operation does not result in a streamable response - use request() instead."));try{let a=await e(...t),{statusText:o}=a;if(!a.ok)throw new Error(o,{cause:a});let n=a.headers.get("content-type")||"";switch(!0){case n.includes(ve.json):return go(a);case n.includes(ve.multipart):return bo(a,n);default:throw new Error(`${Ve} ${n}`,{cause:a})}}catch(a){return{async*[Symbol.asyncIterator](){let o=We(a);yield{errors:{message:H(B(a)),...L("networkStatusCode",o==null?void 0:o.status),...L("response",o)},hasNext:!1}}}}}}function et({client:e,storeDomain:t}){try{if(!t||typeof t!="string")throw new Error;let a=t.trim(),o=a.match(/^https?:/)?a:`https://${a}`,n=new URL(o);return n.protocol="https",n.origin}catch(a){throw new Error(`${e}: a valid store domain ("${t}") must be provided`,{cause:a})}}function _e({client:e,currentSupportedApiVersions:t,apiVersion:a,logger:o}){let n=`${e}: the provided apiVersion ("${a}")`,r=`Currently supported API versions: ${t.join(", ")}`;if(!a||typeof a!="string")throw new Error(`${n} is invalid. ${r}`);let i=a.trim();t.includes(i)||(o?o({type:"Unsupported_Api_Version",content:{apiVersion:a,supportedApiVersions:t}}):console.warn(`${n} is likely deprecated or not supported. ${r}`))}function Se(e){let t=e*3-2;return t===10?t:`0${t}`}function tt(e,t,a){let o=t-a;return o<=0?`${e-1}-${Se(o+4)}`:`${e}-${Se(o)}`}function oa(){let e=new Date,t=e.getUTCMonth(),a=e.getUTCFullYear(),o=Math.floor(t/3+1);return{year:a,quarter:o,version:`${a}-${Se(o)}`}}function at(){let{year:e,quarter:t,version:a}=oa(),o=t===4?`${e+1}-01`:`${e}-${Se(t+1)}`;return[tt(e,t,3),tt(e,t,2),tt(e,t,1),a,o,"unstable"]}function ot(e){return t=>({...t!=null?t:{},...e.headers})}function nt({getHeaders:e,getApiUrl:t}){return(a,o)=>{let n=[a];if(o&&Object.keys(o).length>0){let{variables:r,apiVersion:i,headers:s,retries:c,signal:l}=o;n.push({...r?{variables:r}:{},...s?{headers:e(s)}:{},...i?{url:t(i)}:{},...c?{retries:c}:{},...l?{signal:l}:{}})}return n}}var rt="application/json",na="storefront-api-client",ra="1.0.10",ia="X-Shopify-Storefront-Access-Token",sa="Shopify-Storefront-Private-Token",ca="X-SDK-Variant",la="X-SDK-Version",da="X-SDK-Variant-Source",Q="Storefront API Client";function ua(e){if(e&&typeof window!="undefined")throw new Error(`${Q}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`)}function pa(e,t){if(!e&&!t)throw new Error(`${Q}: a public or private access token must be provided`);if(e&&t)throw new Error(`${Q}: only provide either a public or private access token`)}function it({storeDomain:e,apiVersion:t,publicAccessToken:a,privateAccessToken:o,clientName:n,retries:r=0,customFetchApi:i,logger:s}){let c=at(),l=et({client:Q,storeDomain:e}),d={client:Q,currentSupportedApiVersions:c,logger:s};_e({...d,apiVersion:t}),pa(a,o),ua(o);let p=xo(l,t,d),v={storeDomain:l,apiVersion:t,...a?{publicAccessToken:a}:{privateAccessToken:o},headers:{"Content-Type":rt,Accept:rt,[ca]:na,[la]:ra,...n?{[da]:n}:{},...a?{[ia]:a}:{[sa]:o}},apiUrl:p(),clientName:n},x=Je({headers:v.headers,url:v.apiUrl,retries:r,customFetchApi:i,logger:s}),h=ot(v),y=Co(v,p),N=nt({getHeaders:h,getApiUrl:y});return Object.freeze({config:v,getHeaders:h,getApiUrl:y,fetch:(...$)=>x.fetch(...N(...$)),request:(...$)=>x.request(...N(...$)),requestStream:(...$)=>x.requestStream(...N(...$))})}function xo(e,t,a){return o=>{o&&_e({...a,apiVersion:o});let n=(o!=null?o:t).trim();return`${e}/api/${n}/graphql.json`}}function Co(e,t){return a=>a?t(a):e.apiUrl}var Ne={SHOPIFY_STORE_DOMAIN:"shop.infinitemachine.com",SHOPIFY_STOREFRONT_PUBLIC_TOKEN:"eefb42e32220791a7472aaa5d2cf2182",SHOPIFY_API_VERSION:"2026-04"};var G=it({storeDomain:Ne.SHOPIFY_STORE_DOMAIN,apiVersion:Ne.SHOPIFY_API_VERSION,publicAccessToken:Ne.SHOPIFY_STOREFRONT_PUBLIC_TOKEN});var ma="olto_cart_",_o="cfg_",ct="config",D=null,f=null,oe=null,pt=null,lt=null,q=null,ke=[],So=[];function V(e){oe=e,f=e}var pe=null;function ga(e){pe=e}async function ya(e){var a,o;pt=e.id,lt=((a=e.product)==null?void 0:a.handle)||null,q=ha()||_a();let t=Io();if(t)try{let n=await ko(t);n&&(D=t,V(n))}catch(n){console.warn("[Cart] Failed to restore cart, will create new:",n)}if(!D){let n=await No();V(n),D=n.id,Ao(D)}if(!ha()&&((o=f==null?void 0:f.lines)!=null&&o.length)){let n=Eo(f);n&&(q=n)}return Na(q),T(),Sa(),f}function ht(){return f}function wa(){return f==null?void 0:f.checkoutUrl}function ne(){return q}function ft(){return q=_a(),Na(q),Sa(),q}async function ba(e){re();let t=oe,a=((t==null?void 0:t.lines)||[]).filter(o=>{var n;return((n=o.attributesByKey)==null?void 0:n._config_id)===e}).map(o=>o.id);a.length!==0&&(await Ie(a),e===q&&ft())}async function mt(e){re();let t=f,a=ut(q),o=e.map(r=>Ea(r.variantId,r.quantity||a,{...r.attributes||{},_config_id:q})).filter(Boolean);o.length&&(f=Ia(f,o),T());let n=e.map(r=>({merchandiseId:r.variantId,quantity:r.quantity||a,attributes:he({...r.attributes||{},_config_id:q})}));try{return V(await Ae(()=>Z("cartLinesAdd",`
    ...
    `,{cartId:D,lines:n}))),T(),f}catch(r){throw f=t,T(),r}}async function Ie(e){re();let t=f,a=new Set(e);f&&(f={...f,lines:f.lines.filter(o=>!a.has(o.id))},T());try{return V(await Ae(()=>Z("cartLinesRemove",`
    ...
    `,{cartId:D,lineIds:e}))),T(),f}catch(o){throw f=t,T(),o}}async function gt({lineId:e,variantId:t,quantity:a,attributes:o}){re();let n=f;f&&(f={...f,lines:f.lines.map(i=>{if(i.id!==e)return i;let s={...i};if(t!==void 0){let c=wt(t)||i.merchandise;s.merchandise=c}if(a!==void 0&&(s.quantity=a),o!==void 0){let c=he(o);s.attributes=c,s.attributesByKey=Object.fromEntries(c.map(l=>[l.key,l.value]))}return s})},T());let r={id:e};t!==void 0&&(r.merchandiseId=t),a!==void 0&&(r.quantity=a),o!==void 0&&(r.attributes=he(o));try{return V(await Ae(()=>Z("cartLinesUpdate",`
    ...
    `,{cartId:D,lines:[r]}))),T(),f}catch(i){throw f=n,T(),i}}async function va(e){re();let t=[...new Set((e||[]).filter(Boolean))];return ka("cart:discounts",async()=>{V(await Z("cartDiscountCodesUpdate",`
      mutation($cartId: ID!, $discountCodes: [String!]!) {
        cartDiscountCodesUpdate(cartId: $cartId, discountCodes: $discountCodes) {
          cart { ${U} } userErrors { field message }
        }
      }
    `,{cartId:D,discountCodes:t})),T()})}function xa(e){return ke.push(e),f&&e(f),()=>{ke=ke.filter(t=>t!==e)}}var U=`
  id
  checkoutUrl
  totalQuantity
