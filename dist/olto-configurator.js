"use strict";(()=>{var Pt={id:"olto",steps:[{type:"location",no:"01",title:"Location",validation:!0,collapsible:!1},{type:"variant",no:"02",title:"Base"},{type:"wrap",no:"03",title:"Wrap"},{type:"bundle",no:"04",title:"Accessory Pack"},{type:"accessories",no:"05",title:"Configure your Accessories"},{type:"quantity",no:"06",title:"Quantity"}],product:{handle:"olto-1"},accessoriesCollection:"olto-accessories",testInstructionVideo:"https://vz-19725589-529.b-cdn.net/a4c98a2a-412b-4e2e-a2ce-4e9a64123464/playlist.m3u8",wrap:{productHandle:"olto-wrap"},bundles:{metaobjectType:"bundles"},variants:{44842879156380:{color:"Black",colorHex:"#000000",delivery:"July 2026",backgroundImage:"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/68ff73905e7daa5ef224c5d5_olto-eu-black.avif"},44842879123612:{color:"Silver",colorHex:"#D9D9D9",delivery:"August 2026",backgroundImage:"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/68ff7390e94ecc537b713a30_olto-eu-silver.avif"}},defaultVariantId:"44842879156380",wrapColorMap:{Sand:"#DECEAF",Blush:"#F6C6DC",Sky:"#707A8D",Forest:"#627063",Crimson:"#B44C47"},accessoryDependencies:{"olto-rear-rack":{requiredBy:["olto-rear-basket","olto-side-mounting-plate"]}},customImageRules:[{when:["olto-soft-bag","olto-rear-basket"],replace:{"olto-soft-bag":"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/69219c3d619077ba6f1689ed_Soft%20Bag%20in%20Rear%20Basket.avif"}},{when:["olto-charging-dock","olto-battery"],replace:{"olto-battery":"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/6921a4037d0eab061d3d7ca4_Battery%20Dock%20with%20Battery%20Plugged%20in.avif"},hide:["olto-charging-dock"]}]};var G="GraphQL Client";var Pe="An error occurred while fetching from the API. Review 'graphQLErrors' for details.",He="Response returned unexpected Content-Type:",De="An unknown error has occurred. The API did not return a data object or any errors in its response.",me={json:"application/json",multipart:"multipart/mixed"},qe="X-SDK-Variant",Be="X-SDK-Version",Dt="shopify-graphql-client",qt="1.4.2",he=1e3,Bt=[429,503],Fe=/@(defer)\b/i,Ht=`\r
`,Ft=/boundary="?([^=";]+)"?/i,Ve=Ht+Ht;function M(e,t=G){return e.startsWith(`${t}`)?e:`${t}: ${e}`}function H(e){return e instanceof Error?e.message:JSON.stringify(e)}function Ue(e){return e instanceof Error&&e.cause?e.cause:void 0}function ze(e){return e.flatMap(({errors:t})=>t!=null?t:[])}function ge({client:e,retries:t}){if(t!==void 0&&(typeof t!="number"||t<0||t>3))throw new Error(`${e}: The provided "retries" value (${t}) is invalid - it cannot be less than ${0} or greater than ${3}`)}function E(e,t){return t&&(typeof t!="object"||Array.isArray(t)||typeof t=="object"&&Object.keys(t).length>0)?{[e]:t}:{}}function je(e,t){if(e.length===0)return t;let o={[e.pop()]:t};return e.length===0?o:je(e,o)}function zt(e,t){return Object.keys(t||{}).reduce((a,o)=>(typeof t[o]=="object"||Array.isArray(t[o]))&&e[o]?(a[o]=zt(e[o],t[o]),a):(a[o]=t[o],a),Array.isArray(e)?[...e]:{...e})}function Ge([e,...t]){return t.reduce(zt,{...e})}function Ke({clientLogger:e,customFetchApi:t=fetch,client:a=G,defaultRetryWaitTime:o=he,retriableCodes:n=Bt}){let r=async(i,l,s)=>{let c=l+1,h=s+1,m;try{if(m=await t(...i),e({type:"HTTP-Response",content:{requestParams:i,response:m}}),!m.ok&&n.includes(m.status)&&c<=h)throw new Error;let y=(m==null?void 0:m.headers.get("X-Shopify-API-Deprecated-Reason"))||"";return y&&e({type:"HTTP-Response-GraphQL-Deprecation-Notice",content:{requestParams:i,deprecationNotice:y}}),m}catch(y){if(c<=h){let p=m==null?void 0:m.headers.get("Retry-After");return await Ya(p?parseInt(p,10):o),e({type:"HTTP-Retry",content:{requestParams:i,lastResponse:m,retryAttempt:l,maxRetries:s}}),r(i,c,s)}throw new Error(M(`${s>0?`Attempted maximum number of ${s} network retries. Last message - `:""}${H(y)}`,a))}};return r}async function Ya(e){return new Promise(t=>setTimeout(t,e))}function We({headers:e,url:t,customFetchApi:a=fetch,retries:o=0,logger:n}){ge({client:G,retries:o});let r={headers:e,url:t,retries:o},i=Qa(n),l=Ke({customFetchApi:a,clientLogger:i,defaultRetryWaitTime:he}),s=Za(l,r),c=Ja(s),h=ro(s);return{config:r,fetch:s,request:c,requestStream:h}}function Qa(e){return t=>{e&&e(t)}}async function jt(e){let{errors:t,data:a,extensions:o}=await e.json();return{...E("data",a),...E("extensions",o),headers:e.headers,...t||!a?{errors:{networkStatusCode:e.status,message:M(t?Pe:De),...E("graphQLErrors",t),response:e}}:{}}}function Za(e,{url:t,headers:a,retries:o}){return async(n,r={})=>{let{variables:i,headers:l,url:s,retries:c,keepalive:h,signal:m}=r,y=JSON.stringify({query:n,variables:i});ge({client:G,retries:c});let p=Object.entries({...a,...l}).reduce((v,[N,b])=>(v[N]=Array.isArray(b)?b.join(", "):b.toString(),v),{});!p[qe]&&!p[Be]&&(p[qe]=Dt,p[Be]=qt);let w=[s!=null?s:t,{method:"POST",headers:p,body:y,signal:m,keepalive:h}];return e(w,1,c!=null?c:o)}}function Ja(e){return async(...t)=>{if(Fe.test(t[0]))throw new Error(M("This operation will result in a streamable response - use requestStream() instead."));let a=null;try{a=await e(...t);let{status:o,statusText:n}=a,r=a.headers.get("content-type")||"";return a.ok?r.includes(me.json)?await jt(a):{errors:{networkStatusCode:o,message:M(`${He} ${r}`),response:a}}:{errors:{networkStatusCode:o,message:M(n),response:a}}}catch(o){return{errors:{message:H(o),...a==null?{}:{networkStatusCode:a.status,response:a}}}}}}async function*Xa(e){let t=new TextDecoder;if(e.body[Symbol.asyncIterator])for await(let a of e.body)yield t.decode(a);else{let a=e.body.getReader(),o;try{for(;!(o=await a.read()).done;)yield t.decode(o.value)}finally{a.cancel()}}}function eo(e,t){return{async*[Symbol.asyncIterator](){try{let a="";for await(let o of e)if(a+=o,a.indexOf(t)>-1){let n=a.lastIndexOf(t),i=a.slice(0,n).split(t).filter(l=>l.trim().length>0).map(l=>l.slice(l.indexOf(Ve)+Ve.length).trim());i.length>0&&(yield i),a=a.slice(n+t.length),a.trim()==="--"&&(a="")}}catch(a){throw new Error(`Error occured while processing stream payload - ${H(a)}`)}}}}function to(e){return{async*[Symbol.asyncIterator](){try{yield{...await jt(e),hasNext:!1}}catch(t){yield{errors:{message:M(H(t)),networkStatusCode:e.status,response:e},hasNext:!1}}}}}function ao(e){return e.map(t=>{try{return JSON.parse(t)}catch(a){throw new Error(`Error in parsing multipart response - ${H(a)}`)}}).map(t=>{let{data:a,incremental:o,hasNext:n,extensions:r,errors:i}=t;if(!o)return{data:a||{},...E("errors",i),...E("extensions",r),hasNext:n};let l=o.map(({data:s,path:c,errors:h})=>({data:s&&c?je(c,s):{},...E("errors",h)}));return{data:l.length===1?l[0].data:Ge([...l.map(({data:s})=>s)]),...E("errors",ze(l)),hasNext:n}})}function oo(e,t){if(e.length>0)throw new Error(Pe,{cause:{graphQLErrors:e}});if(Object.keys(t).length===0)throw new Error(De)}function no(e,t){var l,s;let a=(t!=null?t:"").match(Ft),o=`--${a?a[1]:"-"}`;if(!((l=e.body)!=null&&l.getReader)&&!((s=e.body)!=null&&s[Symbol.asyncIterator]))throw new Error("API multipart response did not return an iterable body",{cause:e});let n=Xa(e),r={},i;return{async*[Symbol.asyncIterator](){var c,h;try{let m=!0;for await(let y of eo(n,o)){let p=ao(y);i=(h=(c=p.find(v=>v.extensions))==null?void 0:c.extensions)!=null?h:i;let w=ze(p);r=Ge([r,...p.map(({data:v})=>v)]),m=p.slice(-1)[0].hasNext,oo(w,r),yield{...E("data",r),...E("extensions",i),hasNext:m}}if(m)throw new Error("Response stream terminated unexpectedly")}catch(m){let y=Ue(m);yield{...E("data",r),...E("extensions",i),errors:{message:M(H(m)),networkStatusCode:e.status,...E("graphQLErrors",y==null?void 0:y.graphQLErrors),response:e},hasNext:!1}}}}}function ro(e){return async(...t)=>{if(!Fe.test(t[0]))throw new Error(M("This operation does not result in a streamable response - use request() instead."));try{let a=await e(...t),{statusText:o}=a;if(!a.ok)throw new Error(o,{cause:a});let n=a.headers.get("content-type")||"";switch(!0){case n.includes(me.json):return to(a);case n.includes(me.multipart):return no(a,n);default:throw new Error(`${He} ${n}`,{cause:a})}}catch(a){return{async*[Symbol.asyncIterator](){let o=Ue(a);yield{errors:{message:M(H(a)),...E("networkStatusCode",o==null?void 0:o.status),...E("response",o)},hasNext:!1}}}}}}function Ye({client:e,storeDomain:t}){try{if(!t||typeof t!="string")throw new Error;let a=t.trim(),o=a.match(/^https?:/)?a:`https://${a}`,n=new URL(o);return n.protocol="https",n.origin}catch(a){throw new Error(`${e}: a valid store domain ("${t}") must be provided`,{cause:a})}}function ye({client:e,currentSupportedApiVersions:t,apiVersion:a,logger:o}){let n=`${e}: the provided apiVersion ("${a}")`,r=`Currently supported API versions: ${t.join(", ")}`;if(!a||typeof a!="string")throw new Error(`${n} is invalid. ${r}`);let i=a.trim();t.includes(i)||(o?o({type:"Unsupported_Api_Version",content:{apiVersion:a,supportedApiVersions:t}}):console.warn(`${n} is likely deprecated or not supported. ${r}`))}function we(e){let t=e*3-2;return t===10?t:`0${t}`}function Qe(e,t,a){let o=t-a;return o<=0?`${e-1}-${we(o+4)}`:`${e}-${we(o)}`}function Gt(){let e=new Date,t=e.getUTCMonth(),a=e.getUTCFullYear(),o=Math.floor(t/3+1);return{year:a,quarter:o,version:`${a}-${we(o)}`}}function Ze(){let{year:e,quarter:t,version:a}=Gt(),o=t===4?`${e+1}-01`:`${e}-${we(t+1)}`;return[Qe(e,t,3),Qe(e,t,2),Qe(e,t,1),a,o,"unstable"]}function Je(e){return t=>({...t!=null?t:{},...e.headers})}function Xe({getHeaders:e,getApiUrl:t}){return(a,o)=>{let n=[a];if(o&&Object.keys(o).length>0){let{variables:r,apiVersion:i,headers:l,retries:s,signal:c}=o;n.push({...r?{variables:r}:{},...l?{headers:e(l)}:{},...i?{url:t(i)}:{},...s?{retries:s}:{},...c?{signal:c}:{}})}return n}}var et="application/json",Kt="storefront-api-client",Wt="1.0.10",Yt="X-Shopify-Storefront-Access-Token",Qt="Shopify-Storefront-Private-Token",Zt="X-SDK-Variant",Jt="X-SDK-Version",Xt="X-SDK-Variant-Source",K="Storefront API Client";function ea(e){if(e&&typeof window!="undefined")throw new Error(`${K}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`)}function ta(e,t){if(!e&&!t)throw new Error(`${K}: a public or private access token must be provided`);if(e&&t)throw new Error(`${K}: only provide either a public or private access token`)}function tt({storeDomain:e,apiVersion:t,publicAccessToken:a,privateAccessToken:o,clientName:n,retries:r=0,customFetchApi:i,logger:l}){let s=Ze(),c=Ye({client:K,storeDomain:e}),h={client:K,currentSupportedApiVersions:s,logger:l};ye({...h,apiVersion:t}),ta(a,o),ea(o);let m=io(c,t,h),y={storeDomain:c,apiVersion:t,...a?{publicAccessToken:a}:{privateAccessToken:o},headers:{"Content-Type":et,Accept:et,[Zt]:Kt,[Jt]:Wt,...n?{[Xt]:n}:{},...a?{[Yt]:a}:{[Qt]:o}},apiUrl:m(),clientName:n},p=We({headers:y.headers,url:y.apiUrl,retries:r,customFetchApi:i,logger:l}),w=Je(y),v=so(y,m),N=Xe({getHeaders:w,getApiUrl:v});return Object.freeze({config:y,getHeaders:w,getApiUrl:v,fetch:(...$)=>p.fetch(...N(...$)),request:(...$)=>p.request(...N(...$)),requestStream:(...$)=>p.requestStream(...N(...$))})}function io(e,t,a){return o=>{o&&ye({...a,apiVersion:o});let n=(o!=null?o:t).trim();return`${e}/api/${n}/graphql.json`}}function so(e,t){return a=>a?t(a):e.apiUrl}var be={SHOPIFY_STORE_DOMAIN:"shop.infinitemachine.com",SHOPIFY_STOREFRONT_PUBLIC_TOKEN:"eefb42e32220791a7472aaa5d2cf2182",SHOPIFY_API_VERSION:"2026-04"};var V=tt({storeDomain:be.SHOPIFY_STORE_DOMAIN,apiVersion:be.SHOPIFY_API_VERSION,publicAccessToken:be.SHOPIFY_STOREFRONT_PUBLIC_TOKEN});var na="olto_cart_",lo="cfg_",ot="config",P=null,d=null,Q=null,rt=null,T=null,ve=[],co=[];function U(e){Q=e,d=e}var re=null;function ra(e){re=e}async function ia(e){var a;rt=e.id,T=aa()||ua();let t=ho();if(t)try{let o=await po(t);o&&(P=t,U(o))}catch(o){console.warn("[Cart] Failed to restore cart, will create new:",o)}if(!P){let o=await uo();U(o),P=o.id,go(P)}if(!aa()&&((a=d==null?void 0:d.lines)!=null&&a.length)){let o=fo(d);o&&(T=o)}return fa(T),R(),pa(),d}function sa(){return d}function it(){return d==null?void 0:d.checkoutUrl}function J(){return T}function st(){return T=ua(),fa(T),pa(),T}async function la(e){se();let t=Q,a=((t==null?void 0:t.lines)||[]).filter(o=>{var n;return((n=o.attributesByKey)==null?void 0:n._config_id)===e}).map(o=>o.id);a.length!==0&&(await xe(a),e===T&&st())}async function lt(e){se();let t=d,a=nt(T),o=e.map(r=>ma(r.variantId,r.quantity||a,{...r.attributes||{},_config_id:T})).filter(Boolean);o.length&&(d=ha(d,o),R());let n=e.map(r=>({merchandiseId:r.variantId,quantity:r.quantity||a,attributes:ie({...r.attributes||{},_config_id:T})}));try{return U(await Ce(()=>Z("cartLinesAdd",`
    ...
    `,{cartId:P,lines:n}))),R(),d}catch(r){throw d=t,R(),r}}async function xe(e){se();let t=d,a=new Set(e);d&&(d={...d,lines:d.lines.filter(o=>!a.has(o.id))},R());try{return U(await Ce(()=>Z("cartLinesRemove",`
    ...
    `,{cartId:P,lineIds:e}))),R(),d}catch(o){throw d=t,R(),o}}async function ca({lineId:e,variantId:t,quantity:a,attributes:o}){se();let n=d;d&&(d={...d,lines:d.lines.map(i=>{if(i.id!==e)return i;let l={...i};if(t!==void 0){let s=dt(t)||i.merchandise;l.merchandise=s}if(a!==void 0&&(l.quantity=a),o!==void 0){let s=ie(o);l.attributes=s,l.attributesByKey=Object.fromEntries(s.map(c=>[c.key,c.value]))}return l})},R());let r={id:e};t!==void 0&&(r.merchandiseId=t),a!==void 0&&(r.quantity=a),o!==void 0&&(r.attributes=ie(o));try{return U(await Ce(()=>Z("cartLinesUpdate",`
    ...
    `,{cartId:P,lines:[r]}))),R(),d}catch(i){throw d=n,R(),i}}function da(e){return ve.push(e),d&&e(d),()=>{ve=ve.filter(t=>t!==e)}}var z=`
  id
  checkoutUrl
  totalQuantity
...
`;async function uo(){var o;let{data:e,errors:t}=await V.request(`
    mutation CartCreate {
      cartCreate(input: {}) {
        cart { ${z} }
        userErrors { field message }
  ...
  `);if(t)throw new Error(`[Cart] createCart errors: ${JSON.stringify(t)}`);let a=(o=e==null?void 0:e.cartCreate)==null?void 0:o.userErrors;if(a!=null&&a.length)throw new Error(`[Cart] createCart userErrors: ${JSON.stringify(a)}`);return ct(e.cartCreate.cart)}async function po(e){let{data:t,errors:a}=await V.request(`
    query GetCart($id: ID!) {
      cart(id: $id) { ${z} }
    }
  `,{variables:{id:e}});if(a)throw new Error(`[Cart] queryCart errors: ${JSON.stringify(a)}`);return t!=null&&t.cart?ct(t.cart):null}async function Z(e,t,a){var i;let{data:o,errors:n}=await V.request(t,{variables:a});if(n)throw new Error(`[Cart] ${e} errors: ${JSON.stringify(n)}`);let r=o==null?void 0:o[e];if((i=r==null?void 0:r.userErrors)!=null&&i.length)throw new Error(`[Cart] ${e} userErrors: ${JSON.stringify(r.userErrors)}`);return ct(r.cart)}function ct(e){let t=e.attributes||[];return{id:e.id,checkoutUrl:e.checkoutUrl,totalQuantity:e.totalQuantity,cost:e.cost,attributes:t,attributesByKey:Object.fromEntries(t.map(a=>[a.key,a.value])),lines:e.lines.edges.map(({node:a})=>({id:a.id,quantity:a.quantity,attributes:a.attributes,attributesByKey:Object.fromEntries(a.attributes.map(o=>[o.key,o.value])),merchandise:a.merchandise}))}}function ie(e){return Object.entries(e).filter(([,t])=>t!=null&&t!=="").map(([t,a])=>({key:t,value:String(a)}))}function se(){if(!P)throw new Error("[Cart] Called before initCart(config)")}function R(){for(let e of ve)e(d)}function ua(){return`${lo}${Date.now()}_${Math.random().toString(36).slice(2,8)}`}function nt(e){var o;let t=Q||d;if(!((o=t==null?void 0:t.lines)!=null&&o.length))return 1;let a=t.lines.find(n=>{var r;return((r=n.attributesByKey)==null?void 0:r._config_id)===e});return(a==null?void 0:a.quantity)||1}function pa(){for(let e of co)e(T)}function aa(){return typeof window=="undefined"?null:new URLSearchParams(window.location.search).get(ot)}function fa(e){if(typeof window=="undefined")return;let t=new URLSearchParams(window.location.search);e?t.set(ot,e):t.delete(ot),window.history.replaceState({},"",`${window.location.pathname}?${t.toString()}`)}function fo(e){var a;if(!((a=e==null?void 0:e.lines)!=null&&a.length))return null;let t=e.lines.map(o=>{var n;return(n=o.attributesByKey)==null?void 0:n._config_id}).filter(Boolean).sort();return t[t.length-1]||null}var oa=Promise.resolve();async function Ce(e){let t=oa,a;oa=new Promise(o=>{a=o}),await t;try{return await e()}finally{a()}}var at=new Map;function mo(e,t){let a=at.get(e)||{inflight:null,latest:null};return a.latest=t,at.set(e,a),a.inflight||(a.inflight=(async()=>{for(;a.latest;){let o=a.latest;a.latest=null;try{await Ce(o)}catch(n){console.error(`[Cart] coalesce(${e}) error:`,n)}}a.inflight=null,at.delete(e)})()),a.inflight}async function _e(e,t){se();let a=T;if(d){let o=d.lines.findIndex(n=>{var r;return n.merchandise.product.handle===e&&((r=n.attributesByKey)==null?void 0:r._config_id)===a});if(o>=0&&t===null)d={...d,lines:d.lines.filter((n,r)=>r!==o)};else if(o>=0&&t){let n=dt(t);n&&(d={...d,lines:d.lines.map((r,i)=>i===o?{...r,merchandise:n}:r)})}else if(o<0&&t){let n=nt(a),r=ma(t,n,{_config_id:a});r&&(d=ha(d,[r]))}R()}return mo(`product:${e}:${a}`,async()=>{let o=Q==null?void 0:Q.lines.find(n=>{var r;return n.merchandise.product.handle===e&&((r=n.attributesByKey)==null?void 0:r._config_id)===a});if(t===null){o&&(U(await Z("cartLinesRemove",`
...
`;async function ga(e){var l;if(ut.has(e.id))return ut.get(e.id);let t=!!((l=e.wrap)!=null&&l.productHandle),a=`
...
`;var mt="nd875425",wa="https://api-iam.intercom.io",X="idle";async function ba(){if(X!=="idle"||typeof window=="undefined")return;if(X="checking",!await wo()){X="blocked",console.info(`[Infinite] Intercom messenger unavailable on ${window.location.host} \u2014 add the domain to the workspace\u2019s trusted domains; "Talk to a rep" falls back to the contact page until then.`);return}if(window.intercomSettings={api_base:wa,app_id:mt,hide_default_launcher:!0},typeof window.Intercom!="function"){let t=function(...a){t.c(a)};t.q=[],t.c=a=>t.q.push(a),window.Intercom=t}let e=document.createElement("script");e.async=!0,e.src=`https://widget.intercom.io/widget/${mt}`,e.onload=()=>{X="ready",window.Intercom("boot",window.intercomSettings)},e.onerror=()=>{X="blocked",console.warn("[Infinite] Intercom failed to load \u2014 rep link falls back to /contact")},document.head.appendChild(e)}async function wo(){try{return(await fetch(`${wa}/messenger/web/ping`,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({app_id:mt,referer:window.location.href})})).ok}catch{return!1}}function bo(){return X==="ready"&&typeof window.Intercom=="function"&&window.Intercom.booted}function va({message:e,lead:t}={}){if(!bo())return!1;try{return t!=null&&t.email&&window.Intercom("update",{name:[t.first,t.last].filter(Boolean).join(" ")||void 0,email:t.email,phone:t.phone||void 0}),window.Intercom("showNewMessage",e||""),!0}catch(a){return console.warn("[Infinite] Intercom refused to open:",a),!1}}var ht=null,gt=null,xa=[],Ne=[],x={ready:!1,region:"",baseNumericId:null,bikeLine:null,wrapLine:null,accessoryLines:[],activeBundle:null,bundleSavings:0,quantity:1,total:0,currency:"USD",payMode:"cash",cart:null};function ke(e){return String(e).split("/").pop()}function Ee(e){return`gid://shopify/ProductVariant/${e}`}function Ca(e){ht=e.config,gt=e.products,xa=e.bundles||[],x.baseNumericId=ht.defaultVariantId,da(vo)}function k(){return x}function _a(e){return Ne.push(e),()=>{Ne=Ne.filter(t=>t!==e)}}function yt(e){x.region=e,wt()}function Ie(e){x.payMode=e,wt()}function wt(){for(let e of Ne)e(x)}function vo(e){var m,y;let t=J(),a=((e==null?void 0:e.lines)||[]).filter(p=>{var w;return((w=p.attributesByKey)==null?void 0:w._config_id)===t}),o=gt.main.handle,n=(m=ht.wrap)==null?void 0:m.productHandle,r=new Set(gt.accessories.map(p=>p.handle));x.cart=e,x.bikeLine=a.find(p=>p.merchandise.product.handle===o)||null,x.wrapLine=a.find(p=>p.merchandise.product.handle===n)||null,x.accessoryLines=a.filter(p=>r.has(p.merchandise.product.handle)),x.bikeLine&&(x.baseNumericId=ke(x.bikeLine.merchandise.id)),x.quantity=((y=a[0])==null?void 0:y.quantity)||1;let i=0;for(let p of a)i+=parseFloat(p.merchandise.price.amount)*(p.quantity||1),p.merchandise.price.currencyCode&&(x.currency=p.merchandise.price.currencyCode);let l=new Set(x.accessoryLines.map(p=>p.merchandise.product.handle));x.activeBundle=null;let s=null;for(let p of xa){let w=(p.products||[]).map(v=>v.handle);if(w.length&&w.length===l.size&&w.every(v=>l.has(v))){x.activeBundle=p.handle,s=p;break}}let c=e==null?void 0:e.cost,h=c!=null&&c.subtotalAmount&&(c!=null&&c.totalAmount)?parseFloat(c.subtotalAmount.amount)-parseFloat(c.totalAmount.amount):0;x.bundleSavings=h>0?h:0,i-=x.bundleSavings,s&&typeof s.price=="number"&&x.bundleSavings===0&&console.warn(`[Olto] Bundle "${s.handle}" is in the cart but Shopify applied no discount. Checkout will bill the full component price.`),x.total=i,x.ready=!0,wt()}var Ae='<svg viewBox="0 0 922 201" fill="none" xmlns="http://www.w3.org/2000/svg" class="olto-wordmark" role="img" aria-label="Olto"> <path d="M246.995 19.4652C255.252 28.6186 259.698 41.3214 261.454 61.0855C262.35 70.239 262.649 80.8495 262.649 102.706C262.649 151.985 257.942 170.89 242.885 184.153C231.976 193.605 217.218 198.313 192.41 199.807C182.958 200.405 147.241 201.003 119.817 201.003C59.5913 201.003 43.3765 199.247 26.564 190.093C13.5623 182.995 5.00663 169.433 2.35399 149.968C0.598013 136.966 0.000235075 126.355 0.000235075 94.1874C-0.0371261 48.1211 4.37149 29.8142 18.5687 17.4103C29.1793 7.95792 43.0403 3.54931 68.4458 1.45708C78.496 0.560417 108.011 0 143.99 0C213.631 0 232.237 3.54931 246.995 19.4652ZM46.2907 100.651C46.2907 139.021 49.2422 151.425 60.1517 157.029C71.0611 162.932 80.5135 163.829 136.891 163.829C187.665 163.829 200.331 161.774 208.326 152.919C215.126 145.559 217.181 132.856 217.181 99.4927C217.181 37.8095 216.583 37.2117 131.586 37.2117C46.5896 37.2117 46.2907 38.1084 46.2907 100.651Z" fill="#E90022"/> <path d="M286.86 2.05334H332.328V162.034H476.057V198.909H286.86V2.05334Z" fill="#E90022"/> <path d="M507.328 38.9662H414.673V2.05334H645.154V38.9288H552.759V198.909H507.291V38.9662H507.328Z" fill="#E90022"/> <path d="M906.345 19.4644C914.602 28.6179 919.048 41.3207 920.804 61.0847C921.701 70.2382 922 80.8488 922 102.705C922 151.984 917.292 170.889 902.236 184.152C891.326 193.605 876.569 198.312 851.761 199.807C842.308 200.404 806.591 201.002 779.168 201.002C718.979 201.002 702.727 199.246 685.915 190.093C672.913 182.994 664.357 169.432 661.705 149.967C659.949 136.965 659.351 126.355 659.351 94.1867C659.351 48.1578 663.797 29.8508 677.957 17.4469C688.567 7.99454 702.466 3.58593 727.834 1.49371C737.884 0.597038 767.399 0.0366211 803.378 0.0366211C873.019 0.0366211 891.625 3.58593 906.383 19.5018L906.345 19.4644ZM705.679 100.65C705.679 139.02 708.63 151.424 719.54 157.028C730.449 162.931 739.901 163.828 796.279 163.828C847.053 163.828 859.719 161.773 867.714 152.918C874.514 145.558 876.569 132.855 876.569 99.492C876.569 37.8087 875.971 37.211 790.974 37.211C705.978 37.211 705.679 38.1076 705.679 100.65Z" fill="#E90022"/> </svg>',Sa='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 831.97 45.21" class="im-wordmark" fill="currentColor" role="img" aria-label="Infinite Machine"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M13.56.33V44.88H0V.33Z"/><path d="M44.93.33l27,33.86L71.58.33H84.4V44.88H62.63L36,11.35l.34,33.53h-13V.33Z"/><path d="M141.66.33V10.42H107.87V19.3h32.06V29.39H107.87V44.88H94.38V.33Z"/><path d="M163.09.33V44.88H149.54V.33Z"/><path d="M194.46.33l27,33.86L221.11.33h12.82V44.88H212.16L185.58,11.35l.33,33.53h-13V.33Z"/><path d="M257.44.33V44.88H243.89V.33Z"/><path d="M264.52,11.35V.33h53.23v11H297.91V44.88H284.35V11.35Z"/><path d="M374.26,10.42h-36V18.1h33.93v8.81H338.26V34.8h36.47V44.88H324.91V.33h49.35Z"/><path d="M423,.33l16.23,29.59L455.34.33h21.37V44.88H463.49l.67-34.39L444.39,44.88H433.57L414.13,10.49l.4,34.39H401.44V.33Z"/><path d="M526.62.33,551,44.88H536.17l-4.4-8H503.05l-4.28,8H483.41l25-44.55Zm-9.21,9.55-9.49,17.77H527Z"/><path d="M611.09,32.22c0,1.14-.11,2.11-.2,2.91a13.74,13.74,0,0,1-.36,2.07,11.1,11.1,0,0,1-.57,1.6,8.86,8.86,0,0,1-4.21,4.31,21.46,21.46,0,0,1-8.08,1.77q-2.07.19-6.18.27t-10.78.06c-3.21,0-5.91,0-8.12-.13a53.92,53.92,0,0,1-5.61-.47,20.34,20.34,0,0,1-3.9-.9,14.32,14.32,0,0,1-2.94-1.43,10.08,10.08,0,0,1-2.77-2.58,11.37,11.37,0,0,1-1.74-3.87,32.31,32.31,0,0,1-.9-5.84c-.18-2.32-.27-5.12-.27-8.42q0-4.41.27-7.48a23.36,23.36,0,0,1,1-5.24,10,10,0,0,1,1.87-3.54,10.88,10.88,0,0,1,2.9-2.37,16.6,16.6,0,0,1,3.17-1.44,23.22,23.22,0,0,1,4-.9Q570,.27,573.29.13c2.19-.09,4.83-.13,8-.13q6.21,0,10.22.07c2.67,0,4.88.15,6.61.33a27.49,27.49,0,0,1,4.21.7,18,18,0,0,1,3,1.1,8.12,8.12,0,0,1,4,4.35,20.63,20.63,0,0,1,1.27,7.94V16h-13a11.59,11.59,0,0,0-.5-2.87,2.69,2.69,0,0,0-1.7-1.6,12.6,12.6,0,0,0-3.87-.67c-1.7-.09-4-.13-6.95-.13q-4.14,0-6.74.06c-1.74.05-3.13.14-4.18.27a10.12,10.12,0,0,0-2.4.53,5.12,5.12,0,0,0-1.44.87,4.48,4.48,0,0,0-1,1.24,7.48,7.48,0,0,0-.6,1.87,20.61,20.61,0,0,0-.3,2.94c0,1.18-.07,2.66-.07,4.44a42.86,42.86,0,0,0,.37,6.31A5.34,5.34,0,0,0,570,32.66a8,8,0,0,0,4.21,1.43,75.75,75.75,0,0,0,7.68.31c2.54,0,4.57,0,6.11,0s2.77,0,3.71-.1a12.82,12.82,0,0,0,2.13-.23,7.73,7.73,0,0,0,1.47-.5,3.77,3.77,0,0,0,2.07-1.81,8.36,8.36,0,0,0,.6-3.6h13.16C611.16,29.72,611.14,31.09,611.09,32.22Z"/><path d="M633.44.33v16.5H664.3V.33h13.56V44.88H664.3v-17H633.44v17H619.88V.33Z"/><path d="M701.33.33V44.88H687.77V.33Z"/><path d="M732.7.33l27,33.86L759.35.33h12.82V44.88H750.4L723.82,11.35l.33,33.53h-13V.33Z"/><path d="M831.51,10.42h-36V18.1h33.93v8.81H795.51V34.8H832V44.88H782.15V.33h49.36Z"/></g></g></svg>',I="https://cdn.prod.website-files.com/66ea2a84659b76f5d91d481b",bt={"accessory-plate":`${I}/68d53a735e9c987a9499211a_accessory-plate.avif`,"charger-bag":`${I}/68d53a2cb165eb23a2527775_charger-bag.avif`,"olto-center-stand":`${I}/68d53974c880c4b20d23dec9_olto-center-stand.avif`,"olto-charging-dock":`${I}/68d5396153ba7acdd9978c0d_olto-charging-dock.avif`,"olto-kid-carrier":`${I}/6921a92ec4d3dc4a766d69bb_Kid%20Carrier.avif`,"olto-rear-basket":`${I}/68d53b6769ccc4ad6ad7d0b3_olto-rear-basket.avif`,"olto-rear-rack":`${I}/68d53b2e1153a3e349d34c1a_olto-rear-rack.avif`,"olto-side-mounting-plate":`${I}/68d53bea87ff421cf85c858e_olto-side-mounting-plate.avif`,"olto-water-bottle-holder":`${I}/68d53d46367f73dfd1b58a42_olto-water-bottle-holder.avif`,"olto-sidewalls":`${I}/68d53c3ccb4cfb15c59ac6cd_olto-sidewalls.avif`,"olto-super-charger":`${I}/6921a99cb5dd5b924cf4965d_Super%20Charger%20on%20the%20Ground.avif`,"olto-u-lock-mount":`${I}/68d53cf8bb965a6129e84ff4_olto-u-lock-mount.avif`,"open-face-helmet":`${I}/6921a8f20583ec71e2663dce_Black%20Open%20Face%20Helmet.avif`,"kryptonite-lock":`${I}/68d53fc0d2d8d2d151493b5f_kryptonite-lock.avif`,"olto-soft-bag":`${I}/692197c1914921de9b30217a_Soft%20Bag%20on%20the%20Ground.avif`},Na=!1,xo={finance:{months:24}};function vt(e,t,a){if(a==="finance"){let{months:o}=xo.finance,n=e/o;return{amount:n,suffix:"/mo",label:"As low as, with Shop Pay",sub:`As low as ${C(n,t)}/mo with Shop Pay Installments \u2014 ${o} monthly payments for eligible buyers (rates 0\u201336.99% APR). Exact plans and terms appear at checkout.`}}return{amount:e,suffix:"",label:"Est. purchase price",sub:"Taxes and shipping calculated at checkout."}}var le=[{key:"commuter",label:"Olto Commuter",tagline:"Everything you need to commute every day.",popular:!0,price:200,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","olto-water-bottle-holder","bottom-cover"]},{key:"cargo",label:"Olto Cargo",tagline:"Carry everything.",price:600,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","charger-bag","olto-rear-rack","olto-rear-basket","olto-soft-bag","olto-side-mounting-plate","accessory-plate","olto-center-stand"]},{key:"max",label:"Olto Max",tagline:"Fully loaded. Full power.",price:780,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","olto-water-bottle-holder","charger-bag","olto-rear-rack","olto-rear-basket","olto-soft-bag","olto-side-mounting-plate","accessory-plate","olto-center-stand","olto-super-charger"]}],Co=new Set(["bottom-cover"]),_o='<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M9 7.5v9l7.5-4.5z" fill="currentColor"/></svg>',So=new Map([["bottom-cover","Outdoor Cover"]]);function ee(e,t){return So.get(e)||t||e}function C(e,t="USD"){let a=Number(e)||0,o=a%1===0?0:2;return t==="USD"?`$${a.toLocaleString("en-US",{minimumFractionDigits:o,maximumFractionDigits:o})}`:`${t} ${a.toFixed(2)}`}function g(e){return String(e!=null?e:"").replace(/[&<>"']/g,t=>`&#${t.charCodeAt(0)};`)}function te(e,t){return e?`${e}${e.includes("?")?"&":"?"}width=${t}`:""}function ka({config:e,products:t,wrapVariantsByColor:a}){let o=Object.entries(e.variants),[n]=o.find(([i])=>i===e.defaultVariantId)||o[0],r=Math.min(...t.main.variants.map(i=>parseFloat(i.price.amount)));return`
    ...
    <main class="sheet">
      <section class="intro">
        ...
        <p class="intro_price">From ${C(r)}</p>
      </section>
      ...
      <section class="opt opt--acc" data-section="accessories">
        ...
        <div class="acc-list" data-acc-list>
          ${t.accessories.filter(i=>!Co.has(i.handle)).map(i=>Ao(i)).join("")}
        </div>
      </section>
  ...
  `}function No(e,t,a){var l,s;let o=(l=t.find(([,c])=>/silver/i.test(c.color)))==null?void 0:l[1],n=(s=t.find(([,c])=>/black/i.test(c.color)))==null?void 0:s[1],r={...e.wrapColorMap,Black:(n==null?void 0:n.colorHex)||"#1c1c1e"},i=["Black","Sand","Blush","Forest","Crimson"].filter(c=>a.has(c));return`
  ...
  `}function ko(e){return`
    <section class="opt" data-section="bundles">
      ...
      <div class="kit-list">
        ${le.map(t=>Eo(t,e)).join("")}
      </div>
    </section>
  `}function Eo(e,t){let a=e.items.reduce((l,s)=>{let c=W(t.accessories.find(h=>h.handle===s));return l+(c?parseFloat(c.price.amount):0)},0),o=a-e.price,n=e.items.map(l=>{let s=t.accessories.find(c=>c.handle===l);return ee(l,s==null?void 0:s.title).replace(/^Olto /,"")}),r=Na?e.price:a,i=e.items.length?`<div class="kit_price">+${C(r)}</div>
       ${Na&&o>0?`<div class="kit_save"><s>${C(a)}</s> Save ${C(o)}</div>`:""}`:"";return`
    <button type="button" class="kit" data-bundle="${g(e.key)}">
      ...
      ${n.length?`<p class="kit_items">${n.map(l=>g(l)).join(", ")}</p>`:""}
    </button>
  `}function Io(e){let t=new Map;for(let a of(e==null?void 0:e.variants)||[])for(let o of a.selectedOptions||[]){if(o.name==="Title"&&o.value==="Default Title")continue;t.has(o.name)||t.set(o.name,[]);let n=t.get(o.name);n.includes(o.value)||n.push(o.value)}return[...t.entries()]}function Ea(e,t){let a=((e==null?void 0:e.variants)||[]).filter(o=>(o.selectedOptions||[]).every(n=>t[n.name]==null||t[n.name]===n.value));return a.find(o=>o.availableForSale)||a[0]||null}function Ao(e){var n;let t=W(e);if(!t)return"";let a=e.variants.length>1?Io(e):[],o=new Map((t.selectedOptions||[]).map(r=>[r.name,r.value]));return`
    <div class="acc" data-acc="${g(e.handle)}">
      <div class="acc_media">
        <img class="acc_img" src="${g(te((n=e.featuredImage)==null?void 0:n.url,240))}" alt="${g(e.title)}" loading="lazy" />
  ...
  `}function W(e){return e&&(e.variants.find(t=>t.availableForSale)||e.variants[0])||null}function Ia(e,t){var n;let a=[];if(e.bikeLine){let r=((n=t.variants[e.baseNumericId])==null?void 0:n.color)||e.bikeLine.merchandise.title;a.push({label:`Olto &middot; ${g(r)}`,amount:parseFloat(e.bikeLine.merchandise.price.amount)})}e.wrapLine&&a.push({label:`Wrap &middot; ${g(e.wrapLine.merchandise.title)}`,amount:parseFloat(e.wrapLine.merchandise.price.amount)});for(let r of e.accessoryLines)a.push({label:g(ee(r.merchandise.product.handle,r.merchandise.product.title)),amount:parseFloat(r.merchandise.price.amount)});if(e.bundleSavings>0){let r=le.find(i=>i.key===e.activeBundle);a.push({label:`${g((r==null?void 0:r.label)||"Bundle")} discount`,amount:-e.bundleSavings/(e.quantity||1),isSaving:!0})}let o=e.quantity>1?`<div class="summary_qty">&times;${e.quantity} configurations</div>`:"";return a.map(r=>`
      <div class="summary_row${r.isSaving?" summary_row--save":""}">
        <span>${r.label}</span>
        <span>${r.isSaving?"&minus;":""}${C(Math.abs(r.amount),e.currency)}</span>
      </div>`).join("")+o}var O=window.gsap||null;O&&window.ScrollTrigger&&O.registerPlugin(window.ScrollTrigger);var S={...Pt},f=null,_=null,ae=new Map,ce="a",Le=null,Lo=new Set(["Sand"]),To="Ships now",Ro="Now",$e="",Aa=null,xt=0,Ct=null;async function Oa(e){var n,r,i;if(f=e,!f){console.error("[Olto] mount(): no root element \u2014 nothing rendered.");return}f.classList.add("olto-cfg"),Mo();let t=(n=Object.entries(S.variants).find(([,l])=>/silver/i.test(l.color)))==null?void 0:n[0];t&&(S.defaultVariantId=t);try{_=await ga(S)}catch(l){console.error("[Infinite] Failed to load products:",l),Po();return}await $o(),ae=Oo(_.wrap),ra(_),await ia(S),await Da("boot"),Ca({config:S,products:_,bundles:le.filter(l=>l.items.length).map(l=>({handle:l.key,price:l.price,label:l.label,products:l.items.map(s=>({handle:s}))}))}),new URLSearchParams(window.location.search).get("layout")==="rail"&&f.classList.add("is-rail"),f.innerHTML=ka({config:S,products:_,wrapVariantsByColor:ae}),Ho(),_a(ue),ue(k()),Yo(),Wo(),(window.requestIdleCallback||(l=>setTimeout(l,1500)))(()=>ba());let o=Bo();o?Fo(o):k().bikeLine||_e(_.main.handle,Ee(S.defaultVariantId)),en(),F("view_configurator"),on();for(let l of ae.values())(r=l.image)!=null&&r.url&&(new Image().src=l.image.url);for(let l of _.main.variants)(i=l.image)!=null&&i.url&&(new Image().src=te(l.image.url,1600))}async function $o(){try{let{data:e}=await V.request('query { product(handle: "bottom-cover") { id handle title availableForSale featuredImage { url altText } variants(first: 5) { edges { node { id title availableForSale price { amount currencyCode } selectedOptions { name value } image { url altText } } } } } }'),t=e==null?void 0:e.product;t&&_.accessories.push({...t,variants:t.variants.edges.map(a=>a.node)})}catch(e){console.warn("[Infinite] Kit-only product fetch failed:",e)}}function Oo(e){var a;let t=new Map;if(!e)return t;for(let o of e.variants){let n=(a=o.selectedOptions)==null?void 0:a.find(i=>/colou?rs?/i.test(i.name)),r=(n==null?void 0:n.value)||o.title;r&&t.set(r,o)}return t}function Mo(){if(document.getElementById("olto-cfg-css"))return;let e=document.createElement("style");e.id="olto-cfg-css",e.textContent=ya,document.head.appendChild(e)}function Po(){f.innerHTML=`
    <div class="boot">
  ...
  `}function Ho(){f.addEventListener("click",e=>{let t=e.target.closest("[data-color-swatch]");if(t)return qo(t.dataset.colorSwatch);let a=e.target.closest("[data-acc-scroll]");if(a)return Do("[data-acc-list]",Number(a.dataset.accScroll));let o=e.target.closest("[data-acc-toggle]");if(o)return Ta(o.dataset.accToggle);let n=e.target.closest("[data-acc-play]");if(n)return Ko(n.dataset.accPlay);if(e.target.closest("[data-video-close]"))return Lt();let r=e.target.closest("[data-acc]");if(r&&!e.target.closest("select, label"))return Ta(r.dataset.acc);let i=e.target.closest("[data-bundle]");if(i)return Ha(i.dataset.bundle);let l=e.target.closest("[data-pay-mode]");if(l)return Ie(l.dataset.payMode);if(e.target.closest("[data-qty-dec]"))return Ra(-1);if(e.target.closest("[data-qty-inc]"))return Ra(1);if(e.target.closest("[data-save]"))return Fa("save");if(e.target.closest("[data-rep-chat]")){va({message:Vo(),lead:za()})&&e.preventDefault();return}if(e.target.closest("[data-save-image]"))return Xo();if(e.target.closest("[data-save-close]"))return ja(!1);if(e.target.closest("[data-config-reset]"))return Uo();if(e.target.closest("[data-cta]"))return e.preventDefault(),zo()}),f.addEventListener("change",e=>{let t=e.target.closest("[data-country]");t&&Ga(t.value)}),f.addEventListener("submit",e=>{if(e.target.closest("[data-save-form]")){e.preventDefault(),Zo(e.target);return}e.target.closest("[data-wf-form-slot]")&&(Va(),F("form_submit",{form_name:"Olto Interest Form"}))}),f.addEventListener("change",e=>{let t=e.target.closest("[data-acc-option]");if(!t)return;let a=t.closest("[data-acc]");if(!a)return;let o=a.dataset.acc;if(!k().accessoryLines.some(i=>i.merchandise.product.handle===o))return;let r=Ma(o);r&&oe(o,r.id)})}function Ma(e){let t=_.accessories.find(r=>r.handle===e);if(!t)return null;let a=f.querySelector(`[data-acc="${e}"]`),o=a?[...a.querySelectorAll("[data-acc-option]")]:[];if(!o.length)return W(t);let n={};for(let r of o)n[r.dataset.accOption]=r.value;return Ea(t,n)||W(t)}var La=new Map;function Do(e,t){var r;let a=f.querySelector(e);if(!a)return;let o=a.scrollLeft,n=Math.max(0,Math.min(a.scrollWidth-a.clientWidth,o+t*320));if(O&&!document.hidden){(r=La.get(e))==null||r.kill();let i={v:o};La.set(e,O.to(i,{v:n,duration:.45,ease:"power2.out",onUpdate:()=>{a.scrollLeft=i.v}}))}else a.scrollLeft=n}var Pa=Promise.resolve();function oe(e,t){let a=_e(e,t);return Pa=a.catch(()=>null),a}function qo(e){F("select_color",{olto_selected_color:e||"Silver"});let t=S.wrap.productHandle;if(!e)return oe(t,null);let a=ae.get(e);a&&oe(t,a.id)}var Y=null;function Ta(e){var n,r;let t=k(),a=t.accessoryLines.some(i=>i.merchandise.product.handle===e);F(a?"remove_accessory":"add_accessory",{olto_accessory:e});let o=S.accessoryDependencies||{};if(a){oe(e,null);let i=((n=o[e])==null?void 0:n.requiredBy)||[],l=[];for(let s of i)t.accessoryLines.some(c=>c.merchandise.product.handle===s)&&(oe(s,null),l.push(s));Y=l.length?{trigger:e,removed:l}:null;return}if(_t(e),(Y==null?void 0:Y.trigger)===e){for(let i of Y.removed)_t(i);Y=null}for(let[i,l]of Object.entries(o))(r=l.requiredBy)!=null&&r.includes(e)&&(t.accessoryLines.some(c=>c.merchandise.product.handle===i)||_t(i))}function _t(e){let t=Ma(e);t&&oe(e,t.id)}var St=!1,Te=null,j=null;async function Ha(e){if(F("select_bundle",{olto_selected_bundle:e||"none"}),St){e!==(j==null?void 0:j.value)&&(Te=e,j={value:e},ue(k()));return}St=!0;let t=k().activeBundle===e?null:e;j={value:t},ue(k());try{await Pa;let a=k().accessoryLines.map(r=>r.id).filter(r=>!String(r).startsWith("tmp_"));a.length&&await xe(a);let o=le.find(r=>r.key===e);if(!t||!(o!=null&&o.items.length))return;let n=o.items.map(r=>{let i=W(_.accessories.find(l=>l.handle===r));return i?{variantId:i.id,attributes:{_bundle:e}}:null}).filter(Boolean);n.length&&await lt(n)}catch(a){console.error("[Infinite] Bundle select failed:",a)}finally{if(St=!1,Te){let a=Te;Te=null,Ha(a)}else j=null,ue(k())}}function Ra(e){F("change_quantity",{olto_quantity_delta:e});let t=k(),a=[t.bikeLine,t.wrapLine,...t.accessoryLines].filter(Boolean),o=Math.min(99,Math.max(1,t.quantity+e));if(o===t.quantity)return;let n=a.filter(r=>!String(r.id).startsWith("tmp_"));Promise.all(n.map(r=>ca({lineId:r.id,quantity:o})))}async function Da(e){var o;let t=J();if(!t)return 0;let a=(((o=sa())==null?void 0:o.lines)||[]).filter(n=>{var r;return!n.id||String(n.id).startsWith("tmp_")?!1:((r=n.attributesByKey)==null?void 0:r._config_id)!==t}).map(n=>n.id);if(!a.length)return 0;try{return await xe(a),console.warn(`[Olto] Dropped ${a.length} cart line(s) from a previous configuration (${e}). This cart shows one configuration at a time.`),a.length}catch(n){return console.error("[Olto] Failed to clear stale cart lines; checkout may overcharge:",n),0}}function Bo(){let e=new URLSearchParams(window.location.search).get("d");if(!e)return null;let[t,a,o,n,r]=e.split(".");return!t||!S.variants[t]?null:{base:t,wrap:a||null,qty:Math.min(99,Math.max(1,parseInt(o,10)||1)),pay:["cash","finance"].includes(n)?n:"cash",accs:(r||"").split("~").filter(Boolean)}}async function Fo(e){st(),await Da("shared design");let t=[{variantId:Ee(e.base),quantity:e.qty}],a=e.wrap?ae.get(e.wrap):null;a&&t.push({variantId:a.id,quantity:e.qty});for(let n of e.accs){let r=W(_.accessories.find(i=>i.handle===n));r&&t.push({variantId:r.id,quantity:e.qty})}Ie(e.pay);try{await lt(t)}catch(n){console.error("[Infinite] Failed to apply shared design:",n)}let o=new URLSearchParams(window.location.search);o.delete("d"),window.history.replaceState({},"",`${window.location.pathname}?${o.toString()}`)}function Tt(){let e=k(),t=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"",a=e.accessoryLines.map(r=>r.merchandise.product.handle).join("~"),o=[e.baseNumericId,t,e.quantity,e.payMode,a].join("."),n=new URL(window.location.href);return n.searchParams.set("d",o),n.toString()}function Vo(){var l;let e=k(),t=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"",a=((l=S.variants[e.baseNumericId])==null?void 0:l.color)||"Silver",o=[t?`${t} wrap`:`${a} finish`],n=e.accessoryLines.map(s=>ee(s.merchandise.product.handle,s.merchandise.product.title));n.length&&o.push(n.join(", ")),e.quantity>1&&o.push(`qty ${e.quantity}`);let r=C(e.total,e.currency),i=`Total ${r}`;if(e.payMode==="finance"){let{amount:s}=vt(e.total,e.currency,"finance");i=`${C(s,e.currency)}/mo with Shop Pay (${r} total)`}return["Hi \u2014 I\u2019m designing an Olto and have a question.","",`My build: ${o.join(" \xB7 ")}`,i,Tt(),""].join(`
`)}var de=null;function Nt(e,t){for(let a of f.querySelectorAll("[data-config-reset]"))a.textContent=e,a.classList.toggle("is-armed",t)}async function Uo(){if(!de){Nt("Tap again to clear",!0),de=setTimeout(()=>{de=null,Nt("Clear configuration",!1)},3e3);return}clearTimeout(de),de=null,Nt("Clear configuration",!1);try{await la(J())}catch(e){console.error("[Infinite] Clear failed:",e)}Y=null,Ie("cash"),_e(_.main.handle,Ee(S.defaultVariantId))}function zo(){let e=k();if(!e.ready)return;if(e.region==="row")return Fa("row");let t=it();t&&(F("begin_checkout",{checkout_url:t}),window.location.href=t)}var jo="https://cdn.jsdelivr.net/npm/hls.js@1.5.17/dist/hls.min.js",pe=null,Re=null,B=null,At=null;function Oe(){return f.querySelector("[data-video-el]")}function qa(){var e;return!!((e=Oe())!=null&&e.canPlayType("application/vnd.apple.mpegurl"))}function Ba(){return window.Hls?Promise.resolve(window.Hls):Re||(Re=new Promise(e=>{let t=document.createElement("script");t.async=!0,t.src=jo,t.onload=()=>{pe=window.Hls||null,e(pe)},t.onerror=()=>{console.warn("[Infinite] hls.js failed to load \u2014 videos disabled"),e(null)},document.head.appendChild(t)}),Re)}function Go(){var t;qa()||window.Hls||pe||!((t=_==null?void 0:_.accessories)!=null&&t.some(a=>a.instructionVideo))||Ba()}function Ko(e){var l,s;let t=(l=_==null?void 0:_.accessories)==null?void 0:l.find(c=>c.handle===e),a=t==null?void 0:t.instructionVideo,o=f.querySelector("[data-video-modal]"),n=Oe();if(!a||!o||!n)return;q("[data-video-title]",ee(e,t.title)),At=a;let r=window.Hls||pe;qa()?n.src=a:r!=null&&r.isSupported()?(B||(B=new r({maxBufferLength:30}),B.attachMedia(n)),B.loadSource(a)):n.src=a,o.hidden=!1,n.muted=!1;let i=(s=n.play)==null?void 0:s.call(n);i!=null&&i.catch&&i.catch(()=>{var c;n.muted=!0,(c=n.play)==null||c.call(n).catch(h=>console.warn("[Infinite] Video playback blocked:",h))})}function Lt(){var a;let e=f.querySelector("[data-video-modal]"),t=Oe();!e||e.hidden||((a=t==null?void 0:t.pause)==null||a.call(t),e.hidden=!0)}function Wo(){let e=Oe();e&&(e.addEventListener("ended",Lt),e.addEventListener("error",async()=>{var a;if(!At||B)return;console.warn("[Infinite] Native HLS failed \u2014 retrying through hls.js");let t=window.Hls||pe||await Ba();!(t!=null&&t.isSupported())||B||(B=new t({maxBufferLength:30}),B.attachMedia(e),B.loadSource(At),(a=e.play)==null||a.call(e).catch(o=>console.warn("[Infinite] hls.js retry failed:",o)))}),document.addEventListener("keydown",t=>{t.key==="Escape"&&Lt()}),Go())}function Yo(){let e=f.querySelector(".sheet");if(!e)return;let t=window.matchMedia("(min-width: 900px)");window.addEventListener("wheel",a=>{if(!t.matches)return;let o=a.target instanceof Element?a.target:null;if(o!=null&&o.closest(".sheet, .modal"))return;let n=a.deltaMode===1?16:a.deltaMode===2?e.clientHeight:1;e.scrollTop+=a.deltaY*n},{passive:!0})}function Fa(e){let t=f.querySelector("[data-save-modal]");if(!t)return;let a=e==="row",o=t.querySelector("[data-save-title]"),n=t.querySelector("[data-save-copy]");o&&(o.textContent=a?"Register your interest":"Save your design"),n&&(n.textContent=a?"Olto ships in the United States today. Leave your details and we\u2019ll tell you the moment it reaches you.":"We\u2019ll save this exact Olto so you can pick up where you left off on any device."),Va(),F(a?"interest_form_open":"save_configuration_open"),ja(!0)}function Qo(){var a,o;let e=k(),t=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"";return{location:$e,variant:((o=(a=S.variants)==null?void 0:a[e.baseNumericId])==null?void 0:o.color)||"",wrap:t,pack:e.activeBundle||"",quantity:String(e.quantity||1),accessories:e.accessoryLines.map(n=>n.merchandise.product.title).filter(Boolean).join(", "),design_url:Tt()}}function Va(){let e=f.querySelector("[data-wf-form-slot] form");if(!e)return;let t=Qo();for(let[a,o]of Object.entries(t)){let n=e.querySelector(`input[name="${a}"]`);n&&(n.value=o)}}function F(e,t){var a,o;try{let n=k();window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:e,configurator:"olto",olto_variant:((o=(a=S.variants)==null?void 0:a[n.baseNumericId])==null?void 0:o.color)||"",olto_wrap:n.wrapLine?fe(n.wrapLine.merchandise)||n.wrapLine.merchandise.title:"",olto_pack:n.activeBundle||"",olto_quantity:n.quantity||1,olto_accessory_count:n.accessoryLines.length,olto_value:Number(n.total||0),olto_savings:Number(n.bundleSavings||0),olto_currency:n.currency||"USD",olto_region:n.region||"unresolved",olto_config_id:J()||"",...t||{}})}catch(n){console.warn("[Olto] dataLayer push failed:",n)}}var Ua="olto_infinite_lead";function za(){try{let e=JSON.parse(localStorage.getItem(Ua));return e!=null&&e.email?e:null}catch{return null}}function ja(e){var a;let t=f.querySelector("[data-save-modal]");if(t&&(t.hidden=!e,e)){let o=t.querySelector("[data-save-form]"),n=t.querySelector("[data-save-done]");if(o){o.hidden=!1;let r=za(),[i,...l]=((r==null?void 0:r.name)||"").split(/\s+/),s={first_name:(r==null?void 0:r.first)||i||"",last_name:(r==null?void 0:r.last)||l.join(" ")||"",email:(r==null?void 0:r.email)||"",phone:(r==null?void 0:r.phone)||""};for(let[c,h]of Object.entries(s)){let m=o.querySelector(`input[name="${c}"]`);m&&!m.value&&(m.value=h)}}n&&(n.hidden=!0),(a=t.querySelector('input[name="first_name"]'))==null||a.focus()}}async function Zo(e){let t=e.first_name.value.trim(),a=e.last_name.value.trim(),o=e.email.value.trim(),n=e.phone.value.trim(),r=e.querySelector("[data-save-error]"),i=null;if(!t||!a?i="Please add your first and last name.":/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(o)?n.replace(/\D/g,"").length<7&&(i="That phone number looks too short."):i="That email doesn\u2019t look right.",i){r&&(r.textContent=i,r.hidden=!1);return}r&&(r.hidden=!0);try{localStorage.setItem(Ua,JSON.stringify({first:t,last:a,email:o,phone:n}))}catch{}let l=Tt(),s=!0;try{await navigator.clipboard.writeText(l)}catch{s=!1}e.hidden=!0;let c=f.querySelector("[data-save-done]");if(c){c.hidden=!1;let h=c.querySelector("[data-save-done-msg]");h&&(h.textContent=s?"Link copied to your clipboard \u2014 it rebuilds this exact Olto.":"Copy your link below \u2014 it rebuilds this exact Olto.");let m=c.querySelector("[data-save-link]");m&&(m.textContent=l)}}function kt(e,t){return new Promise((a,o)=>{let n=new Image;t&&(n.crossOrigin="anonymous"),n.onload=()=>a(n),n.onerror=()=>o(new Error(`image failed: ${e}`)),n.src=e})}function Et(e,t,a){let o=Math.min(a.w/t.naturalWidth,a.h/t.naturalHeight),n=t.naturalWidth*o,r=t.naturalHeight*o;e.drawImage(t,a.x+(a.w-n)/2,a.y+(a.h-r)/2,n,r)}var It='"Helvetica Now Text", "Helvetica Neue", Helvetica, Arial, sans-serif',Jo='"Helvetica Now Display", "Helvetica Neue", Helvetica, Arial, sans-serif';async function Xo(){var t,a,o;let e=f.querySelector("[data-save-image-note]");e&&(e.hidden=!0);try{let n=k(),r=1080,i=1350,l=document.createElement("canvas");l.width=r,l.height=i;let s=l.getContext("2d");s.fillStyle="#ffffff",s.fillRect(0,0,r,i);let c=Ae.replace("<svg ",'<svg width="922" height="201" '),h=URL.createObjectURL(new Blob([c],{type:"image/svg+xml"}));try{Et(s,await kt(h),{x:r/2-160,y:64,w:320,h:70})}finally{URL.revokeObjectURL(h)}let m={x:90,y:190,w:900,h:620},y=(t=f.querySelector(".hero_img.is-active"))==null?void 0:t.src;if(y&&Et(s,await kt(y,!0),m),!((a=f.querySelector("[data-layers]"))==null?void 0:a.classList.contains("is-suppressed")))for(let L of f.querySelectorAll(".hero_layer.is-on"))try{Et(s,await kt(L.src,!0),m)}catch{}let w=[];n.bikeLine&&w.push([`Olto - ${((o=S.variants[n.baseNumericId])==null?void 0:o.color)||n.bikeLine.merchandise.title}`,parseFloat(n.bikeLine.merchandise.price.amount)]),n.wrapLine&&w.push([`Wrap - ${n.wrapLine.merchandise.title}`,parseFloat(n.wrapLine.merchandise.price.amount)]);for(let L of n.accessoryLines)w.push([ee(L.merchandise.product.handle,L.merchandise.product.title),parseFloat(L.merchandise.price.amount)]);n.bundleSavings>0&&w.push(["Bundle discount",-n.bundleSavings/(n.quantity||1)]);let v=120,N=r-120,b=880,$=w.slice(0,7);s.font=`26px ${It}`;for(let[L,D]of $)s.textAlign="left",s.fillStyle="#6a6a6a",s.fillText(L,v,b),s.textAlign="right",s.fillStyle="#252525",s.fillText(C(D,n.currency),N,b),b+=44;w.length>$.length&&(s.textAlign="left",s.fillStyle="#6a6a6a",s.fillText(`+ ${w.length-$.length} more`,v,b),b+=44),b+=8,s.strokeStyle="#e5e5e5",s.beginPath(),s.moveTo(v,b),s.lineTo(N,b),s.stroke(),b+=56,s.font=`500 34px ${Jo}`,s.textAlign="left",s.fillStyle="#252525",s.fillText("Total",v,b),s.textAlign="right",s.fillText(C(n.total,n.currency),N,b),b+=40,n.quantity>1&&(s.font=`22px ${It}`,s.textAlign="right",s.fillStyle="#6a6a6a",s.fillText(`${n.quantity} configurations`,N,b)),s.font=`22px ${It}`,s.textAlign="left",s.fillStyle="#9a9a9a",s.fillText("Taxes and shipping calculated at checkout - infinitemachine.com",v,i-80),l.toBlob(L=>{if(!L){e&&(e.textContent="Couldn\u2019t generate the image in this browser \u2014 a screenshot works too.",e.hidden=!1);return}let D=document.createElement("a");D.href=URL.createObjectURL(L),D.download="my-olto.png",D.click(),setTimeout(()=>URL.revokeObjectURL(D.href),1e4)},"image/png")}catch(n){console.error("[Infinite] Image export failed:",n),e&&(e.textContent="Couldn\u2019t generate the image in this browser \u2014 a screenshot works too.",e.hidden=!1)}}function Ga(e,{silent:t}={}){let a=Se.find(n=>n.Code===e);$e=(a==null?void 0:a.Name)||"",yt(e==="US"?"us":"row");let o=f.querySelector("[data-country]");o&&a&&(o.value=e),q("[data-rail-country]",$e||"\u2014"),t||F("select_country",{olto_country:$e||e})}async function en(){let e=new AbortController,t=setTimeout(()=>e.abort(),8e3);try{let o=(await(await fetch("https://get.geojs.io/v1/ip/country",{signal:e.signal})).text()).trim().toUpperCase();Ga(o,{silent:!0})}catch{yt("")}finally{clearTimeout(t)}}function tn(e){if(!(!e||e===Aa)){Aa=e;try{let t=new URLSearchParams(window.location.search);if(t.get("variant")===String(e))return;t.set("variant",String(e)),window.history.replaceState({},"",`${window.location.pathname}?${t}${window.location.hash}`)}catch(t){console.warn("[Olto] variant param sync failed:",t)}}}function ue(e){var $,L,D,Rt,$t,Ot,Mt;if(!e.ready)return;tn(e.baseNumericId);let t=S.variants[e.baseNumericId]||{};q("[data-delivery]",To),q("[data-rail-delivery]",Ro);let a=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"";for(let u of f.querySelectorAll("[data-color-swatch]"))u.classList.toggle("is-selected",e.wrapLine?u.dataset.colorSwatch===a:u.dataset.colorSwatch==="");let o=new Set(e.accessoryLines.map(u=>u.merchandise.product.handle)),n={},r=new Set;for(let u of S.customImageRules||[])if(u.when.every(A=>o.has(A))){Object.assign(n,u.replace||{});for(let A of u.hide||[])r.add(A)}let i=!1;for(let u of f.querySelectorAll("[data-layer]")){let A=u.dataset.layer,ne=o.has(A)&&!r.has(A),Me=n[A]||bt[A];Me&&u.getAttribute("src")!==Me&&u.setAttribute("src",Me),u.classList.toggle("is-on",ne),ne&&(i=!0)}let l=(L=($=_.main.variants.find(u=>ke(u.id)===e.baseNumericId))==null?void 0:$.image)==null?void 0:L.url,s=e.region==="row"?"eu":"us",c=(s==="eu"?t.backgroundImage:te(l,1600))||te(l,1600)||t.backgroundImage,h=e.wrapLine?(Rt=(D=ae.get(a))==null?void 0:D.image)==null?void 0:Rt.url:null,m=h&&!Lo.has(a);if(e.wrapLine&&a==="Black"){let u=_.main.variants.find(A=>{var ne;return((ne=S.variants[ke(A.id)])==null?void 0:ne.color)==="Black"});($t=u==null?void 0:u.image)!=null&&$t.url&&(h=te(u.image.url,1600),m=!0)}a==="Custom"&&(h=null),(Ot=f.querySelector("[data-layers]"))==null||Ot.classList.toggle("is-suppressed",!!h&&!m&&i),h?$a(h,`wrap:${a}`):$a(c,`base:${e.baseNumericId}:${s}`);let y=j?j.value:e.activeBundle;for(let u of f.querySelectorAll("[data-bundle]"))u.classList.toggle("is-selected",u.dataset.bundle===y);let p=new Set(e.accessoryLines.map(u=>u.merchandise.product.handle));for(let u of f.querySelectorAll("[data-acc-toggle]")){let A=p.has(u.dataset.accToggle);u.textContent=A?"Added":"Add",u.classList.toggle("is-added",A),(Mt=u.closest("[data-acc]"))==null||Mt.classList.toggle("is-added",A)}q("[data-qty-value]",String(e.quantity));let w=Ia(e,S);for(let u of f.querySelectorAll("[data-summary]"))u.innerHTML!==w&&(u.innerHTML=w);q("[data-summary-total]",C(e.total,e.currency));let v=e.payMode==="finance"?"finance":"cash",N=vt(e.total,e.currency,v);for(let u of f.querySelectorAll("[data-pay-mode]"))u.classList.toggle("is-active",u.dataset.payMode===v);q("[data-pay-figure]",C(N.amount,e.currency)+N.suffix),q("[data-pay-sub]",N.sub),an(N.amount,N.suffix,e.currency),q("[data-total-label]",N.label);for(let u of f.querySelectorAll("[data-total-save]"))u.textContent=e.bundleSavings?`You save ${C(e.bundleSavings,e.currency)}`:"",u.hidden=!e.bundleSavings;let b=f.querySelector("[data-cta]");if(b){let u=e.region==="row"?"":it();b.setAttribute("href",u||"#")}b&&(b.textContent=e.region==="row"?"Register interest":"Order")}function fe(e){var a;let t=(a=e.selectedOptions)==null?void 0:a.find(o=>/colou?rs?/i.test(o.name));return(t==null?void 0:t.value)||null}function q(e,t){for(let a of f.querySelectorAll(e))a.textContent!==t&&(a.textContent=t)}function an(e,t,a){let o=f.querySelector("[data-total]");if(o){if(O&&!document.hidden&&xt!==e){Ct&&Ct.kill();let n={v:xt};Ct=O.to(n,{v:e,duration:.45,ease:"power2.out",onUpdate:()=>{o.textContent=C(n.v,a)+t},onComplete:()=>{o.textContent=C(e,a)+t}})}else o.textContent=C(e,a)+t;xt=e}}function $a(e,t){if(!e||t===Le)return;let a={a:f.querySelector('[data-hero-img="a"]'),b:f.querySelector('[data-hero-img="b"]')};if(!a.a||!a.b)return;if(Le===null){a[ce].src=e,Le=t;return}let o=a[ce],n=a[ce==="a"?"b":"a"];n.src=e,ce=ce==="a"?"b":"a",Le=t,O?(O.set(n,{opacity:0,scale:1.04,xPercent:0,yPercent:0}),n.classList.add("is-active"),O.to(n,{opacity:1,scale:1,duration:.45,ease:"power2.out"}),O.to(o,{opacity:0,duration:.45,ease:"power2.out",onComplete:()=>o.classList.remove("is-active")})):(n.classList.add("is-active"),n.style.opacity=1,o.classList.remove("is-active"),o.style.opacity=0)}function on(){if(!O||!window.ScrollTrigger||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let e=f.querySelector(".sheet");for(let t of f.querySelectorAll(".opt"))O.from(t,{y:24,opacity:0,duration:.45,ease:"power2.out",scrollTrigger:{trigger:t,scroller:e,start:"top 88%",once:!0}})}var Ka="[data-olto-configurator]",Wa=["#wf-form-Olto-Interest-Form",'[data-modal-name="interest"] form'];nn();async function nn(){let e=document.querySelector(Ka);if(!e){console.error(`[Olto] No ${Ka} on the page \u2014 configurator not mounted.`);return}rn(e),sn(),await Oa(e),ln(e)}function rn(e){let t=[];for(let a=e.parentElement;a&&a!==document.documentElement;a=a.parentElement){let o=getComputedStyle(a);(o.transform!=="none"||o.filter!=="none"||o.perspective!=="none"||o.contain!=="none"||o.willChange&&/transform|filter|perspective/.test(o.willChange))&&t.push(a)}t.length&&console.error("[Olto] Mount has ancestor(s) creating a containing block \u2014 every fixed region will collapse. Move the mount to a direct child of <body>.",t)}function sn(){if(document.querySelector("[sf-token][sf-domain]"))return;let e=0,t=setInterval(()=>{if(document.querySelector("[sf-token][sf-domain]"))return clearInterval(t);e+=1,!(e<40)&&(clearInterval(t),console.error("[Olto] No [sf-token][sf-domain] on this page. im-attribution cannot write im_* onto the Shopify cart, so orders will reach the CRM with no source. Restore the Shopyflow host element before shipping."))},250)}function ln(e){let t=e.querySelector("[data-wf-form-slot]"),a=Wa.reduce((n,r)=>n||document.querySelector(r),null);if(!t){console.error("[Olto] No [data-wf-form-slot] in the rendered UI \u2014 form not adopted.");return}if(!a){console.error("[Olto] No Webflow interest form found (tried: "+Wa.join(", ")+"). Rest-of-world interest and US save would both capture nothing \u2014 leaving the fallback form in place.");return}t.appendChild(a.closest(".w-form")||a),t.hidden=!1;let o=e.querySelector("[data-save-form]");o&&o.remove()}})();
