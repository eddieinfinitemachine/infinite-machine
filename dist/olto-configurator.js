...
`,Ft=/boundary="?([^=";]+)"?/i,Ve=Ht+Ht;function M(e,t=G){return e.startsWith(`${t}`)?e:`${t}: ${e}`}function H(e){return e instanceof Error?e.message:JSON.stringify(e)}function Ue(e){return e instanceof Error&&e.cause?e.cause:void 0}function ze(e){return e.flatMap(({errors:t})=>t!=null?t:[])}function ge({client:e,retries:t}){if(t!==void 0&&(typeof t!="number"||t<0||t>3))throw new Error(`${e}: The provided "retries" value (${t}) is invalid - it cannot be less than ${0} or greater than ${3}`)}function E(e,t){return t&&(typeof t!="object"||Array.isArray(t)||typeof t=="object"&&Object.keys(t).length>0)?{[e]:t}:{}}function je(e,t){if(e.length===0)return t;let o={[e.pop()]:t};return e.length===0?o:je(e,o)}function zt(e,t){return Object.keys(t||{}).reduce((a,o)=>(typeof t[o]=="object"||Array.isArray(t[o]))&&e[o]?(a[o]=zt(e[o],t[o]),a):(a[o]=t[o],a),Array.isArray(e)?[...e]:{...e})}function Ge([e,...t]){return t.reduce(zt,{...e})}function Ke({clientLogger:e,customFetchApi:t=fetch,client:a=G,defaultRetryWaitTime:o=he,retriableCodes:n=Bt}){let r=async(i,l,s)=>{let c=l+1,m=s+1,d;try{if(d=await t(...i),e({type:"HTTP-Response",content:{requestParams:i,response:d}}),!d.ok&&n.includes(d.status)&&c<=m)throw new Error;let h=(d==null?void 0:d.headers.get("X-Shopify-API-Deprecated-Reason"))||"";return h&&e({type:"HTTP-Response-GraphQL-Deprecation-Notice",content:{requestParams:i,deprecationNotice:h}}),d}catch(h){if(c<=m){let y=d==null?void 0:d.headers.get("Retry-After");return await Wa(y?parseInt(y,10):o),e({type:"HTTP-Retry",content:{requestParams:i,lastResponse:d,retryAttempt:l,maxRetries:s}}),r(i,c,s)}throw new Error(M(`${s>0?`Attempted maximum number of ${s} network retries. Last message - `:""}${H(h)}`,a))}};return r}async function Wa(e){return new Promise(t=>setTimeout(t,e))}function We({headers:e,url:t,customFetchApi:a=fetch,retries:o=0,logger:n}){ge({client:G,retries:o});let r={headers:e,url:t,retries:o},i=Ya(n),l=Ke({customFetchApi:a,clientLogger:i,defaultRetryWaitTime:he}),s=Qa(l,r),c=Za(s),m=no(s);return{config:r,fetch:s,request:c,requestStream:m}}function Ya(e){return t=>{e&&e(t)}}async function jt(e){let{errors:t,data:a,extensions:o}=await e.json();return{...E("data",a),...E("extensions",o),headers:e.headers,...t||!a?{errors:{networkStatusCode:e.status,message:M(t?Pe:De),...E("graphQLErrors",t),response:e}}:{}}}function Qa(e,{url:t,headers:a,retries:o}){return async(n,r={})=>{let{variables:i,headers:l,url:s,retries:c,keepalive:m,signal:d}=r,h=JSON.stringify({query:n,variables:i});ge({client:G,retries:c});let y=Object.entries({...a,...l}).reduce((S,[N,b])=>(S[N]=Array.isArray(b)?b.join(", "):b.toString(),S),{});!y[qe]&&!y[Be]&&(y[qe]=Dt,y[Be]=qt);let C=[s!=null?s:t,{method:"POST",headers:y,body:h,signal:d,keepalive:m}];return e(C,1,c!=null?c:o)}}function Za(e){return async(...t)=>{if(Fe.test(t[0]))throw new Error(M("This operation will result in a streamable response - use requestStream() instead."));let a=null;try{a=await e(...t);let{status:o,statusText:n}=a,r=a.headers.get("content-type")||"";return a.ok?r.includes(me.json)?await jt(a):{errors:{networkStatusCode:o,message:M(`${He} ${r}`),response:a}}:{errors:{networkStatusCode:o,message:M(n),response:a}}}catch(o){return{errors:{message:H(o),...a==null?{}:{networkStatusCode:a.status,response:a}}}}}}async function*Ja(e){let t=new TextDecoder;if(e.body[Symbol.asyncIterator])for await(let a of e.body)yield t.decode(a);else{let a=e.body.getReader(),o;try{for(;!(o=await a.read()).done;)yield t.decode(o.value)}finally{a.cancel()}}}function Xa(e,t){return{async*[Symbol.asyncIterator](){try{let a="";for await(let o of e)if(a+=o,a.indexOf(t)>-1){let n=a.lastIndexOf(t),i=a.slice(0,n).split(t).filter(l=>l.trim().length>0).map(l=>l.slice(l.indexOf(Ve)+Ve.length).trim());i.length>0&&(yield i),a=a.slice(n+t.length),a.trim()==="--"&&(a="")}}catch(a){throw new Error(`Error occured while processing stream payload - ${H(a)}`)}}}}function eo(e){return{async*[Symbol.asyncIterator](){try{yield{...await jt(e),hasNext:!1}}catch(t){yield{errors:{message:M(H(t)),networkStatusCode:e.status,response:e},hasNext:!1}}}}}function to(e){return e.map(t=>{try{return JSON.parse(t)}catch(a){throw new Error(`Error in parsing multipart response - ${H(a)}`)}}).map(t=>{let{data:a,incremental:o,hasNext:n,extensions:r,errors:i}=t;if(!o)return{data:a||{},...E("errors",i),...E("extensions",r),hasNext:n};let l=o.map(({data:s,path:c,errors:m})=>({data:s&&c?je(c,s):{},...E("errors",m)}));return{data:l.length===1?l[0].data:Ge([...l.map(({data:s})=>s)]),...E("errors",ze(l)),hasNext:n}})}function ao(e,t){if(e.length>0)throw new Error(Pe,{cause:{graphQLErrors:e}});if(Object.keys(t).length===0)throw new Error(De)}function oo(e,t){var l,s;let a=(t!=null?t:"").match(Ft),o=`--${a?a[1]:"-"}`;if(!((l=e.body)!=null&&l.getReader)&&!((s=e.body)!=null&&s[Symbol.asyncIterator]))throw new Error("API multipart response did not return an iterable body",{cause:e});let n=Ja(e),r={},i;return{async*[Symbol.asyncIterator](){var c,m;try{let d=!0;for await(let h of Xa(n,o)){let y=to(h);i=(m=(c=y.find(S=>S.extensions))==null?void 0:c.extensions)!=null?m:i;let C=ze(y);r=Ge([r,...y.map(({data:S})=>S)]),d=y.slice(-1)[0].hasNext,ao(C,r),yield{...E("data",r),...E("extensions",i),hasNext:d}}if(d)throw new Error("Response stream terminated unexpectedly")}catch(d){let h=Ue(d);yield{...E("data",r),...E("extensions",i),errors:{message:M(H(d)),networkStatusCode:e.status,...E("graphQLErrors",h==null?void 0:h.graphQLErrors),response:e},hasNext:!1}}}}}function no(e){return async(...t)=>{if(!Fe.test(t[0]))throw new Error(M("This operation does not result in a streamable response - use request() instead."));try{let a=await e(...t),{statusText:o}=a;if(!a.ok)throw new Error(o,{cause:a});let n=a.headers.get("content-type")||"";switch(!0){case n.includes(me.json):return eo(a);case n.includes(me.multipart):return oo(a,n);default:throw new Error(`${He} ${n}`,{cause:a})}}catch(a){return{async*[Symbol.asyncIterator](){let o=Ue(a);yield{errors:{message:M(H(a)),...E("networkStatusCode",o==null?void 0:o.status),...E("response",o)},hasNext:!1}}}}}}function Ye({client:e,storeDomain:t}){try{if(!t||typeof t!="string")throw new Error;let a=t.trim(),o=a.match(/^https?:/)?a:`https://${a}`,n=new URL(o);return n.protocol="https",n.origin}catch(a){throw new Error(`${e}: a valid store domain ("${t}") must be provided`,{cause:a})}}function ye({client:e,currentSupportedApiVersions:t,apiVersion:a,logger:o}){let n=`${e}: the provided apiVersion ("${a}")`,r=`Currently supported API versions: ${t.join(", ")}`;if(!a||typeof a!="string")throw new Error(`${n} is invalid. ${r}`);let i=a.trim();t.includes(i)||(o?o({type:"Unsupported_Api_Version",content:{apiVersion:a,supportedApiVersions:t}}):console.warn(`${n} is likely deprecated or not supported. ${r}`))}function we(e){let t=e*3-2;return t===10?t:`0${t}`}function Qe(e,t,a){let o=t-a;return o<=0?`${e-1}-${we(o+4)}`:`${e}-${we(o)}`}function Gt(){let e=new Date,t=e.getUTCMonth(),a=e.getUTCFullYear(),o=Math.floor(t/3+1);return{year:a,quarter:o,version:`${a}-${we(o)}`}}function Ze(){let{year:e,quarter:t,version:a}=Gt(),o=t===4?`${e+1}-01`:`${e}-${we(t+1)}`;return[Qe(e,t,3),Qe(e,t,2),Qe(e,t,1),a,o,"unstable"]}function Je(e){return t=>({...t!=null?t:{},...e.headers})}function Xe({getHeaders:e,getApiUrl:t}){return(a,o)=>{let n=[a];if(o&&Object.keys(o).length>0){let{variables:r,apiVersion:i,headers:l,retries:s,signal:c}=o;n.push({...r?{variables:r}:{},...l?{headers:e(l)}:{},...i?{url:t(i)}:{},...s?{retries:s}:{},...c?{signal:c}:{}})}return n}}var et="application/json",Kt="storefront-api-client",Wt="1.0.10",Yt="X-Shopify-Storefront-Access-Token",Qt="Shopify-Storefront-Private-Token",Zt="X-SDK-Variant",Jt="X-SDK-Version",Xt="X-SDK-Variant-Source",K="Storefront API Client";function ea(e){if(e&&typeof window!="undefined")throw new Error(`${K}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`)}function ta(e,t){if(!e&&!t)throw new Error(`${K}: a public or private access token must be provided`);if(e&&t)throw new Error(`${K}: only provide either a public or private access token`)}function tt({storeDomain:e,apiVersion:t,publicAccessToken:a,privateAccessToken:o,clientName:n,retries:r=0,customFetchApi:i,logger:l}){let s=Ze(),c=Ye({client:K,storeDomain:e}),m={client:K,currentSupportedApiVersions:s,logger:l};ye({...m,apiVersion:t}),ta(a,o),ea(o);let d=ro(c,t,m),h={storeDomain:c,apiVersion:t,...a?{publicAccessToken:a}:{privateAccessToken:o},headers:{"Content-Type":et,Accept:et,[Zt]:Kt,[Jt]:Wt,...n?{[Xt]:n}:{},...a?{[Yt]:a}:{[Qt]:o}},apiUrl:d(),clientName:n},y=We({headers:h.headers,url:h.apiUrl,retries:r,customFetchApi:i,logger:l}),C=Je(h),S=io(h,d),N=Xe({getHeaders:C,getApiUrl:S});return Object.freeze({config:h,getHeaders:C,getApiUrl:S,fetch:(...$)=>y.fetch(...N(...$)),request:(...$)=>y.request(...N(...$)),requestStream:(...$)=>y.requestStream(...N(...$))})}function ro(e,t,a){return o=>{o&&ye({...a,apiVersion:o});let n=(o!=null?o:t).trim();return`${e}/api/${n}/graphql.json`}}function io(e,t){return a=>a?t(a):e.apiUrl}var be={SHOPIFY_STORE_DOMAIN:"shop.infinitemachine.com",SHOPIFY_STOREFRONT_PUBLIC_TOKEN:"eefb42e32220791a7472aaa5d2cf2182",SHOPIFY_API_VERSION:"2026-04"};var V=tt({storeDomain:be.SHOPIFY_STORE_DOMAIN,apiVersion:be.SHOPIFY_API_VERSION,publicAccessToken:be.SHOPIFY_STOREFRONT_PUBLIC_TOKEN});var na="olto_cart_",so="cfg_",ot="config",P=null,u=null,Q=null,rt=null,T=null,ve=[],lo=[];function U(e){Q=e,u=e}var re=null;function ra(e){re=e}async function ia(e){var a;rt=e.id,T=aa()||ua();let t=mo();if(t)try{let o=await uo(t);o&&(P=t,U(o))}catch(o){console.warn("[Cart] Failed to restore cart, will create new:",o)}if(!P){let o=await co();U(o),P=o.id,ho(P)}if(!aa()&&((a=u==null?void 0:u.lines)!=null&&a.length)){let o=po(u);o&&(T=o)}return fa(T),R(),pa(),u}function sa(){return u}function it(){return u==null?void 0:u.checkoutUrl}function J(){return T}function st(){return T=ua(),fa(T),pa(),T}async function la(e){se();let t=Q,a=((t==null?void 0:t.lines)||[]).filter(o=>{var n;return((n=o.attributesByKey)==null?void 0:n._config_id)===e}).map(o=>o.id);a.length!==0&&(await xe(a),e===T&&st())}async function lt(e){se();let t=u,a=nt(T),o=e.map(r=>ma(r.variantId,r.quantity||a,{...r.attributes||{},_config_id:T})).filter(Boolean);o.length&&(u=ha(u,o),R());let n=e.map(r=>({merchandiseId:r.variantId,quantity:r.quantity||a,attributes:ie({...r.attributes||{},_config_id:T})}));try{return U(await Ce(()=>Z("cartLinesAdd",`
    ...
    `,{cartId:P,lines:n}))),R(),u}catch(r){throw u=t,R(),r}}async function xe(e){se();let t=u,a=new Set(e);u&&(u={...u,lines:u.lines.filter(o=>!a.has(o.id))},R());try{return U(await Ce(()=>Z("cartLinesRemove",`
    ...
    `,{cartId:P,lines:[r]}))),R(),u}catch(i){throw u=n,R(),i}}function da(e){return ve.push(e),u&&e(u),()=>{ve=ve.filter(t=>t!==e)}}var z=`
  id
  checkoutUrl
  totalQuantity
...
`;async function co(){var o;let{data:e,errors:t}=await V.request(`
    mutation CartCreate {
      cartCreate(input: {}) {
        cart { ${z} }
        userErrors { field message }
...
`;var mt="nd875425",wa="https://api-iam.intercom.io",X="idle";async function ba(){if(X!=="idle"||typeof window=="undefined")return;if(X="checking",!await yo()){X="blocked",console.info(`[Infinite] Intercom messenger unavailable on ${window.location.host} \u2014 add the domain to the workspace\u2019s trusted domains; "Talk to a rep" falls back to the contact page until then.`);return}if(window.intercomSettings={api_base:wa,app_id:mt,hide_default_launcher:!0},typeof window.Intercom!="function"){let t=function(...a){t.c(a)};t.q=[],t.c=a=>t.q.push(a),window.Intercom=t}let e=document.createElement("script");e.async=!0,e.src=`https://widget.intercom.io/widget/${mt}`,e.onload=()=>{X="ready",window.Intercom("boot",window.intercomSettings)},e.onerror=()=>{X="blocked",console.warn("[Infinite] Intercom failed to load \u2014 rep link falls back to /contact")},document.head.appendChild(e)}async function yo(){try{return(await fetch(`${wa}/messenger/web/ping`,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({app_id:mt,referer:window.location.href})})).ok}catch{return!1}}function wo(){return X==="ready"&&typeof window.Intercom=="function"&&window.Intercom.booted}function va({message:e,lead:t}={}){if(!wo())return!1;try{return t!=null&&t.email&&window.Intercom("update",{name:[t.first,t.last].filter(Boolean).join(" ")||void 0,email:t.email,phone:t.phone||void 0}),window.Intercom("showNewMessage",e||""),!0}catch(a){return console.warn("[Infinite] Intercom refused to open:",a),!1}}var ht=null,gt=null,xa=[],Ne=[],w={ready:!1,region:"",baseNumericId:null,bikeLine:null,wrapLine:null,accessoryLines:[],activeBundle:null,bundleSavings:0,quantity:1,total:0,currency:"USD",payMode:"cash",cart:null};function ke(e){return String(e).split("/").pop()}function Ee(e){return`gid://shopify/ProductVariant/${e}`}function Ca(e){ht=e.config,gt=e.products,xa=e.bundles||[],w.baseNumericId=ht.defaultVariantId,da(bo)}function k(){return w}function _a(e){return Ne.push(e),()=>{Ne=Ne.filter(t=>t!==e)}}function yt(e){w.region=e,wt()}function Ie(e){w.payMode=e,wt()}function wt(){for(let e of Ne)e(w)}function bo(e){var c,m;let t=J(),a=((e==null?void 0:e.lines)||[]).filter(d=>{var h;return((h=d.attributesByKey)==null?void 0:h._config_id)===t}),o=gt.main.handle,n=(c=ht.wrap)==null?void 0:c.productHandle,r=new Set(gt.accessories.map(d=>d.handle));w.cart=e,w.bikeLine=a.find(d=>d.merchandise.product.handle===o)||null,w.wrapLine=a.find(d=>d.merchandise.product.handle===n)||null,w.accessoryLines=a.filter(d=>r.has(d.merchandise.product.handle)),w.bikeLine&&(w.baseNumericId=ke(w.bikeLine.merchandise.id)),w.quantity=((m=a[0])==null?void 0:m.quantity)||1;let i=0;for(let d of a)i+=parseFloat(d.merchandise.price.amount)*(d.quantity||1),d.merchandise.price.currencyCode&&(w.currency=d.merchandise.price.currencyCode);let l=new Set(w.accessoryLines.map(d=>d.merchandise.product.handle));w.activeBundle=null;let s=null;for(let d of xa){let h=(d.products||[]).map(y=>y.handle);if(h.length&&h.length===l.size&&h.every(y=>l.has(y))){w.activeBundle=d.handle,s=d;break}}if(w.bundleSavings=0,s&&typeof s.price=="number"){let h=w.accessoryLines.reduce((y,C)=>y+parseFloat(C.merchandise.price.amount),0)-s.price;h>0&&(w.bundleSavings=h*w.quantity,i-=w.bundleSavings)}w.total=i,w.ready=!0,wt()}var Ae='<svg viewBox="0 0 922 201" fill="none" xmlns="http://www.w3.org/2000/svg" class="olto-wordmark" role="img" aria-label="Olto"> <path d="M246.995 19.4652C255.252 28.6186 259.698 41.3214 261.454 61.0855C262.35 70.239 262.649 80.8495 262.649 102.706C262.649 151.985 257.942 170.89 242.885 184.153C231.976 193.605 217.218 198.313 192.41 199.807C182.958 200.405 147.241 201.003 119.817 201.003C59.5913 201.003 43.3765 199.247 26.564 190.093C13.5623 182.995 5.00663 169.433 2.35399 149.968C0.598013 136.966 0.000235075 126.355 0.000235075 94.1874C-0.0371261 48.1211 4.37149 29.8142 18.5687 17.4103C29.1793 7.95792 43.0403 3.54931 68.4458 1.45708C78.496 0.560417 108.011 0 143.99 0C213.631 0 232.237 3.54931 246.995 19.4652ZM46.2907 100.651C46.2907 139.021 49.2422 151.425 60.1517 157.029C71.0611 162.932 80.5135 163.829 136.891 163.829C187.665 163.829 200.331 161.774 208.326 152.919C215.126 145.559 217.181 132.856 217.181 99.4927C217.181 37.8095 216.583 37.2117 131.586 37.2117C46.5896 37.2117 46.2907 38.1084 46.2907 100.651Z" fill="#E90022"/> <path d="M286.86 2.05334H332.328V162.034H476.057V198.909H286.86V2.05334Z" fill="#E90022"/> <path d="M507.328 38.9662H414.673V2.05334H645.154V38.9288H552.759V198.909H507.291V38.9662H507.328Z" fill="#E90022"/> <path d="M906.345 19.4644C914.602 28.6179 919.048 41.3207 920.804 61.0847C921.701 70.2382 922 80.8488 922 102.705C922 151.984 917.292 170.889 902.236 184.152C891.326 193.605 876.569 198.312 851.761 199.807C842.308 200.404 806.591 201.002 779.168 201.002C718.979 201.002 702.727 199.246 685.915 190.093C672.913 182.994 664.357 169.432 661.705 149.967C659.949 136.965 659.351 126.355 659.351 94.1867C659.351 48.1578 663.797 29.8508 677.957 17.4469C688.567 7.99454 702.466 3.58593 727.834 1.49371C737.884 0.597038 767.399 0.0366211 803.378 0.0366211C873.019 0.0366211 891.625 3.58593 906.383 19.5018L906.345 19.4644ZM705.679 100.65C705.679 139.02 708.63 151.424 719.54 157.028C730.449 162.931 739.901 163.828 796.279 163.828C847.053 163.828 859.719 161.773 867.714 152.918C874.514 145.558 876.569 132.855 876.569 99.492C876.569 37.8087 875.971 37.211 790.974 37.211C705.978 37.211 705.679 38.1076 705.679 100.65Z" fill="#E90022"/> </svg>',Sa='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 831.97 45.21" class="im-wordmark" fill="currentColor" role="img" aria-label="Infinite Machine"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M13.56.33V44.88H0V.33Z"/><path d="M44.93.33l27,33.86L71.58.33H84.4V44.88H62.63L36,11.35l.34,33.53h-13V.33Z"/><path d="M141.66.33V10.42H107.87V19.3h32.06V29.39H107.87V44.88H94.38V.33Z"/><path d="M163.09.33V44.88H149.54V.33Z"/><path d="M194.46.33l27,33.86L221.11.33h12.82V44.88H212.16L185.58,11.35l.33,33.53h-13V.33Z"/><path d="M257.44.33V44.88H243.89V.33Z"/><path d="M264.52,11.35V.33h53.23v11H297.91V44.88H284.35V11.35Z"/><path d="M374.26,10.42h-36V18.1h33.93v8.81H338.26V34.8h36.47V44.88H324.91V.33h49.35Z"/><path d="M423,.33l16.23,29.59L455.34.33h21.37V44.88H463.49l.67-34.39L444.39,44.88H433.57L414.13,10.49l.4,34.39H401.44V.33Z"/><path d="M526.62.33,551,44.88H536.17l-4.4-8H503.05l-4.28,8H483.41l25-44.55Zm-9.21,9.55-9.49,17.77H527Z"/><path d="M611.09,32.22c0,1.14-.11,2.11-.2,2.91a13.74,13.74,0,0,1-.36,2.07,11.1,11.1,0,0,1-.57,1.6,8.86,8.86,0,0,1-4.21,4.31,21.46,21.46,0,0,1-8.08,1.77q-2.07.19-6.18.27t-10.78.06c-3.21,0-5.91,0-8.12-.13a53.92,53.92,0,0,1-5.61-.47,20.34,20.34,0,0,1-3.9-.9,14.32,14.32,0,0,1-2.94-1.43,10.08,10.08,0,0,1-2.77-2.58,11.37,11.37,0,0,1-1.74-3.87,32.31,32.31,0,0,1-.9-5.84c-.18-2.32-.27-5.12-.27-8.42q0-4.41.27-7.48a23.36,23.36,0,0,1,1-5.24,10,10,0,0,1,1.87-3.54,10.88,10.88,0,0,1,2.9-2.37,16.6,16.6,0,0,1,3.17-1.44,23.22,23.22,0,0,1,4-.9Q570,.27,573.29.13c2.19-.09,4.83-.13,8-.13q6.21,0,10.22.07c2.67,0,4.88.15,6.61.33a27.49,27.49,0,0,1,4.21.7,18,18,0,0,1,3,1.1,8.12,8.12,0,0,1,4,4.35,20.63,20.63,0,0,1,1.27,7.94V16h-13a11.59,11.59,0,0,0-.5-2.87,2.69,2.69,0,0,0-1.7-1.6,12.6,12.6,0,0,0-3.87-.67c-1.7-.09-4-.13-6.95-.13q-4.14,0-6.74.06c-1.74.05-3.13.14-4.18.27a10.12,10.12,0,0,0-2.4.53,5.12,5.12,0,0,0-1.44.87,4.48,4.48,0,0,0-1,1.24,7.48,7.48,0,0,0-.6,1.87,20.61,20.61,0,0,0-.3,2.94c0,1.18-.07,2.66-.07,4.44a42.86,42.86,0,0,0,.37,6.31A5.34,5.34,0,0,0,570,32.66a8,8,0,0,0,4.21,1.43,75.75,75.75,0,0,0,7.68.31c2.54,0,4.57,0,6.11,0s2.77,0,3.71-.1a12.82,12.82,0,0,0,2.13-.23,7.73,7.73,0,0,0,1.47-.5,3.77,3.77,0,0,0,2.07-1.81,8.36,8.36,0,0,0,.6-3.6h13.16C611.16,29.72,611.14,31.09,611.09,32.22Z"/><path d="M633.44.33v16.5H664.3V.33h13.56V44.88H664.3v-17H633.44v17H619.88V.33Z"/><path d="M701.33.33V44.88H687.77V.33Z"/><path d="M732.7.33l27,33.86L759.35.33h12.82V44.88H750.4L723.82,11.35l.33,33.53h-13V.33Z"/><path d="M831.51,10.42h-36V18.1h33.93v8.81H795.51V34.8H832V44.88H782.15V.33h49.36Z"/></g></g></svg>',I="https://cdn.prod.website-files.com/66ea2a84659b76f5d91d481b",bt={"accessory-plate":`${I}/68d53a735e9c987a9499211a_accessory-plate.avif`,"charger-bag":`${I}/68d53a2cb165eb23a2527775_charger-bag.avif`,"olto-center-stand":`${I}/68d53974c880c4b20d23dec9_olto-center-stand.avif`,"olto-charging-dock":`${I}/68d5396153ba7acdd9978c0d_olto-charging-dock.avif`,"olto-kid-carrier":`${I}/6921a92ec4d3dc4a766d69bb_Kid%20Carrier.avif`,"olto-rear-basket":`${I}/68d53b6769ccc4ad6ad7d0b3_olto-rear-basket.avif`,"olto-rear-rack":`${I}/68d53b2e1153a3e349d34c1a_olto-rear-rack.avif`,"olto-side-mounting-plate":`${I}/68d53bea87ff421cf85c858e_olto-side-mounting-plate.avif`,"olto-water-bottle-holder":`${I}/68d53d46367f73dfd1b58a42_olto-water-bottle-holder.avif`,"olto-sidewalls":`${I}/68d53c3ccb4cfb15c59ac6cd_olto-sidewalls.avif`,"olto-super-charger":`${I}/6921a99cb5dd5b924cf4965d_Super%20Charger%20on%20the%20Ground.avif`,"olto-u-lock-mount":`${I}/68d53cf8bb965a6129e84ff4_olto-u-lock-mount.avif`,"open-face-helmet":`${I}/6921a8f20583ec71e2663dce_Black%20Open%20Face%20Helmet.avif`,"kryptonite-lock":`${I}/68d53fc0d2d8d2d151493b5f_kryptonite-lock.avif`,"olto-soft-bag":`${I}/692197c1914921de9b30217a_Soft%20Bag%20on%20the%20Ground.avif`},vo={finance:{months:24}};function vt(e,t,a){if(a==="finance"){let{months:o}=vo.finance,n=e/o;return{amount:n,suffix:"/mo",label:"As low as, with Shop Pay",sub:`As low as ${v(n,t)}/mo with Shop Pay Installments \u2014 ${o} monthly payments for eligible buyers (rates 0\u201336.99% APR). Exact plans and terms appear at checkout.`}}return{amount:e,suffix:"",label:"Est. purchase price",sub:"Taxes and shipping calculated at checkout."}}var le=[{key:"commuter",label:"Olto Commuter",tagline:"Everything you need to commute every day.",popular:!0,price:200,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","olto-water-bottle-holder","bottom-cover"]},{key:"cargo",label:"Olto Cargo",tagline:"Carry everything.",price:600,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","charger-bag","olto-rear-rack","olto-rear-basket","olto-soft-bag","olto-side-mounting-plate","accessory-plate","olto-center-stand"]},{key:"max",label:"Olto Max",tagline:"Fully loaded. Full power.",price:780,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","olto-water-bottle-holder","charger-bag","olto-rear-rack","olto-rear-basket","olto-soft-bag","olto-side-mounting-plate","accessory-plate","olto-center-stand","olto-super-charger"]}],xo=new Set(["bottom-cover"]),Co='<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M9 7.5v9l7.5-4.5z" fill="currentColor"/></svg>',_o=new Map([["bottom-cover","Outdoor Cover"]]);function ee(e,t){return _o.get(e)||t||e}function v(e,t="USD"){let a=Number(e)||0,o=a%1===0?0:2;return t==="USD"?`$${a.toLocaleString("en-US",{minimumFractionDigits:o,maximumFractionDigits:o})}`:`${t} ${a.toFixed(2)}`}function g(e){return String(e!=null?e:"").replace(/[&<>"']/g,t=>`&#${t.charCodeAt(0)};`)}function te(e,t){return e?`${e}${e.includes("?")?"&":"?"}width=${t}`:""}function Na({config:e,products:t,wrapVariantsByColor:a}){let o=Object.entries(e.variants),[n]=o.find(([i])=>i===e.defaultVariantId)||o[0],r=Math.min(...t.main.variants.map(i=>parseFloat(i.price.amount)));return`
    ...
    <main class="sheet">
      ...
      <section class="opt opt--acc" data-section="accessories">
        ...
        <div class="acc-list" data-acc-list>
          ${t.accessories.filter(i=>!xo.has(i.handle)).map(i=>Io(i)).join("")}
        </div>
      </section>
  ...
  `}function So(e,t,a){var l,s;let o=(l=t.find(([,c])=>/silver/i.test(c.color)))==null?void 0:l[1],n=(s=t.find(([,c])=>/black/i.test(c.color)))==null?void 0:s[1],r={...e.wrapColorMap,Black:(n==null?void 0:n.colorHex)||"#1c1c1e"},i=["Black","Sand","Blush","Forest","Crimson"].filter(c=>a.has(c));return`
  ...
  `}function No(e){return`
    <section class="opt" data-section="bundles">
      ...
      <div class="kit-list">
        ${le.map(t=>ko(t,e)).join("")}
      </div>
    </section>
  `}function ko(e,t){let a=e.items.reduce((i,l)=>{let s=W(t.accessories.find(c=>c.handle===l));return i+(s?parseFloat(s.price.amount):0)},0),o=a-e.price,n=e.items.map(i=>{let l=t.accessories.find(s=>s.handle===i);return ee(i,l==null?void 0:l.title).replace(/^Olto /,"")}),r=e.items.length?`<div class="kit_price">+${v(e.price)}</div>
  ...
  `}function Eo(e){let t=new Map;for(let a of(e==null?void 0:e.variants)||[])for(let o of a.selectedOptions||[]){if(o.name==="Title"&&o.value==="Default Title")continue;t.has(o.name)||t.set(o.name,[]);let n=t.get(o.name);n.includes(o.value)||n.push(o.value)}return[...t.entries()]}function ka(e,t){let a=((e==null?void 0:e.variants)||[]).filter(o=>(o.selectedOptions||[]).every(n=>t[n.name]==null||t[n.name]===n.value));return a.find(o=>o.availableForSale)||a[0]||null}function Io(e){var n;let t=W(e);if(!t)return"";let a=e.variants.length>1?Eo(e):[],o=new Map((t.selectedOptions||[]).map(r=>[r.name,r.value]));return`
  ...
  `}function W(e){return e&&(e.variants.find(t=>t.availableForSale)||e.variants[0])||null}function Ea(e,t){var n;let a=[];if(e.bikeLine){let r=((n=t.variants[e.baseNumericId])==null?void 0:n.color)||e.bikeLine.merchandise.title;a.push({label:`Olto &middot; ${g(r)}`,amount:parseFloat(e.bikeLine.merchandise.price.amount)})}e.wrapLine&&a.push({label:`Wrap &middot; ${g(e.wrapLine.merchandise.title)}`,amount:parseFloat(e.wrapLine.merchandise.price.amount)});for(let r of e.accessoryLines)a.push({label:g(ee(r.merchandise.product.handle,r.merchandise.product.title)),amount:parseFloat(r.merchandise.price.amount)});if(e.bundleSavings>0){let r=le.find(i=>i.key===e.activeBundle);a.push({label:`${g((r==null?void 0:r.label)||"Bundle")} discount`,amount:-e.bundleSavings/(e.quantity||1),isSaving:!0})}let o=e.quantity>1?`<div class="summary_qty">&times;${e.quantity} configurations</div>`:"";return a.map(r=>`
      <div class="summary_row${r.isSaving?" summary_row--save":""}">
        <span>${r.label}</span>
        <span>${r.isSaving?"&minus;":""}${v(Math.abs(r.amount),e.currency)}</span>
      </div>`).join("")+o}var O=window.gsap||null;O&&window.ScrollTrigger&&O.registerPlugin(window.ScrollTrigger);var _={...Pt},f=null,x=null,ae=new Map,ce="a",Le=null,Ao=new Set(["Sand"]),Lo="Ships now",To="Now",$e="",Ia=null,xt=0,Ct=null;async function $a(e){var n,r,i;if(f=e,!f){console.error("[Olto] mount(): no root element \u2014 nothing rendered.");return}f.classList.add("olto-cfg"),Oo();let t=(n=Object.entries(_.variants).find(([,l])=>/silver/i.test(l.color)))==null?void 0:n[0];t&&(_.defaultVariantId=t);try{x=await ga(_)}catch(l){console.error("[Infinite] Failed to load products:",l),Mo();return}await Ro(),ae=$o(x.wrap),ra(x),await ia(_),await Ha("boot"),Ca({config:_,products:x,bundles:le.filter(l=>l.items.length).map(l=>({handle:l.key,price:l.price,label:l.label,products:l.items.map(s=>({handle:s}))}))}),new URLSearchParams(window.location.search).get("layout")==="rail"&&f.classList.add("is-rail"),f.innerHTML=Na({config:_,products:x,wrapVariantsByColor:ae}),Po(),_a(ue),ue(k()),Wo(),Ko(),(window.requestIdleCallback||(l=>setTimeout(l,1500)))(()=>ba());let o=qo();o?Bo(o):k().bikeLine||_e(x.main.handle,Ee(_.defaultVariantId)),Xo(),F("view_configurator"),an();for(let l of ae.values())(r=l.image)!=null&&r.url&&(new Image().src=l.image.url);for(let l of x.main.variants)(i=l.image)!=null&&i.url&&(new Image().src=te(l.image.url,1600))}async function Ro(){try{let{data:e}=await V.request('query { product(handle: "bottom-cover") { id handle title availableForSale featuredImage { url altText } variants(first: 5) { edges { node { id title availableForSale price { amount currencyCode } selectedOptions { name value } image { url altText } } } } } }'),t=e==null?void 0:e.product;t&&x.accessories.push({...t,variants:t.variants.edges.map(a=>a.node)})}catch(e){console.warn("[Infinite] Kit-only product fetch failed:",e)}}function $o(e){var a;let t=new Map;if(!e)return t;for(let o of e.variants){let n=(a=o.selectedOptions)==null?void 0:a.find(i=>/colou?rs?/i.test(i.name)),r=(n==null?void 0:n.value)||o.title;r&&t.set(r,o)}return t}function Oo(){if(document.getElementById("olto-cfg-css"))return;let e=document.createElement("style");e.id="olto-cfg-css",e.textContent=ya,document.head.appendChild(e)}function Mo(){f.innerHTML=`
    <div class="boot">
  ...
  `}function Po(){f.addEventListener("click",e=>{let t=e.target.closest("[data-color-swatch]");if(t)return Do(t.dataset.colorSwatch);let a=e.target.closest("[data-acc-scroll]");if(a)return Ho("[data-acc-list]",Number(a.dataset.accScroll));let o=e.target.closest("[data-acc-toggle]");if(o)return La(o.dataset.accToggle);let n=e.target.closest("[data-acc-play]");if(n)return Go(n.dataset.accPlay);if(e.target.closest("[data-video-close]"))return Lt();let r=e.target.closest("[data-acc]");if(r&&!e.target.closest("select, label"))return La(r.dataset.acc);let i=e.target.closest("[data-bundle]");if(i)return Pa(i.dataset.bundle);let l=e.target.closest("[data-pay-mode]");if(l)return Ie(l.dataset.payMode);if(e.target.closest("[data-qty-dec]"))return Ta(-1);if(e.target.closest("[data-qty-inc]"))return Ta(1);if(e.target.closest("[data-save]"))return Ba("save");if(e.target.closest("[data-rep-chat]")){va({message:Fo(),lead:Ua()})&&e.preventDefault();return}if(e.target.closest("[data-save-image]"))return Jo();if(e.target.closest("[data-save-close]"))return za(!1);if(e.target.closest("[data-config-reset]"))return Vo();if(e.target.closest("[data-cta]"))return e.preventDefault(),Uo()}),f.addEventListener("change",e=>{let t=e.target.closest("[data-country]");t&&ja(t.value)}),f.addEventListener("submit",e=>{if(e.target.closest("[data-save-form]")){e.preventDefault(),Qo(e.target);return}e.target.closest("[data-wf-form-slot]")&&(Fa(),F("form_submit",{form_name:"Olto Interest Form"}))}),f.addEventListener("change",e=>{let t=e.target.closest("[data-acc-option]");if(!t)return;let a=t.closest("[data-acc]");if(!a)return;let o=a.dataset.acc;if(!k().accessoryLines.some(i=>i.merchandise.product.handle===o))return;let r=Oa(o);r&&oe(o,r.id)})}function Oa(e){let t=x.accessories.find(r=>r.handle===e);if(!t)return null;let a=f.querySelector(`[data-acc="${e}"]`),o=a?[...a.querySelectorAll("[data-acc-option]")]:[];if(!o.length)return W(t);let n={};for(let r of o)n[r.dataset.accOption]=r.value;return ka(t,n)||W(t)}var Aa=new Map;function Ho(e,t){var r;let a=f.querySelector(e);if(!a)return;let o=a.scrollLeft,n=Math.max(0,Math.min(a.scrollWidth-a.clientWidth,o+t*320));if(O&&!document.hidden){(r=Aa.get(e))==null||r.kill();let i={v:o};Aa.set(e,O.to(i,{v:n,duration:.45,ease:"power2.out",onUpdate:()=>{a.scrollLeft=i.v}}))}else a.scrollLeft=n}var Ma=Promise.resolve();function oe(e,t){let a=_e(e,t);return Ma=a.catch(()=>null),a}function Do(e){F("select_color",{olto_selected_color:e||"Silver"});let t=_.wrap.productHandle;if(!e)return oe(t,null);let a=ae.get(e);a&&oe(t,a.id)}var Y=null;function La(e){var n,r;let t=k(),a=t.accessoryLines.some(i=>i.merchandise.product.handle===e);F(a?"remove_accessory":"add_accessory",{olto_accessory:e});let o=_.accessoryDependencies||{};if(a){oe(e,null);let i=((n=o[e])==null?void 0:n.requiredBy)||[],l=[];for(let s of i)t.accessoryLines.some(c=>c.merchandise.product.handle===s)&&(oe(s,null),l.push(s));Y=l.length?{trigger:e,removed:l}:null;return}if(_t(e),(Y==null?void 0:Y.trigger)===e){for(let i of Y.removed)_t(i);Y=null}for(let[i,l]of Object.entries(o))(r=l.requiredBy)!=null&&r.includes(e)&&(t.accessoryLines.some(c=>c.merchandise.product.handle===i)||_t(i))}function _t(e){let t=Oa(e);t&&oe(e,t.id)}var St=!1,Te=null,j=null;async function Pa(e){if(F("select_bundle",{olto_selected_bundle:e||"none"}),St){e!==(j==null?void 0:j.value)&&(Te=e,j={value:e},ue(k()));return}St=!0;let t=k().activeBundle===e?null:e;j={value:t},ue(k());try{await Ma;let a=k().accessoryLines.map(r=>r.id).filter(r=>!String(r).startsWith("tmp_"));a.length&&await xe(a);let o=le.find(r=>r.key===e);if(!t||!(o!=null&&o.items.length))return;let n=o.items.map(r=>{let i=W(x.accessories.find(l=>l.handle===r));return i?{variantId:i.id,attributes:{_bundle:e}}:null}).filter(Boolean);n.length&&await lt(n)}catch(a){console.error("[Infinite] Bundle select failed:",a)}finally{if(St=!1,Te){let a=Te;Te=null,Pa(a)}else j=null,ue(k())}}function Ta(e){F("change_quantity",{olto_quantity_delta:e});let t=k(),a=[t.bikeLine,t.wrapLine,...t.accessoryLines].filter(Boolean),o=Math.min(99,Math.max(1,t.quantity+e));if(o===t.quantity)return;let n=a.filter(r=>!String(r.id).startsWith("tmp_"));Promise.all(n.map(r=>ca({lineId:r.id,quantity:o})))}async function Ha(e){var o;let t=J();if(!t)return 0;let a=(((o=sa())==null?void 0:o.lines)||[]).filter(n=>{var r;return!n.id||String(n.id).startsWith("tmp_")?!1:((r=n.attributesByKey)==null?void 0:r._config_id)!==t}).map(n=>n.id);if(!a.length)return 0;try{return await xe(a),console.warn(`[Olto] Dropped ${a.length} cart line(s) from a previous configuration (${e}). This cart shows one configuration at a time.`),a.length}catch(n){return console.error("[Olto] Failed to clear stale cart lines; checkout may overcharge:",n),0}}function qo(){let e=new URLSearchParams(window.location.search).get("d");if(!e)return null;let[t,a,o,n,r]=e.split(".");return!t||!_.variants[t]?null:{base:t,wrap:a||null,qty:Math.min(99,Math.max(1,parseInt(o,10)||1)),pay:["cash","finance"].includes(n)?n:"cash",accs:(r||"").split("~").filter(Boolean)}}async function Bo(e){st(),await Ha("shared design");let t=[{variantId:Ee(e.base),quantity:e.qty}],a=e.wrap?ae.get(e.wrap):null;a&&t.push({variantId:a.id,quantity:e.qty});for(let n of e.accs){let r=W(x.accessories.find(i=>i.handle===n));r&&t.push({variantId:r.id,quantity:e.qty})}Ie(e.pay);try{await lt(t)}catch(n){console.error("[Infinite] Failed to apply shared design:",n)}let o=new URLSearchParams(window.location.search);o.delete("d"),window.history.replaceState({},"",`${window.location.pathname}?${o.toString()}`)}function Tt(){let e=k(),t=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"",a=e.accessoryLines.map(r=>r.merchandise.product.handle).join("~"),o=[e.baseNumericId,t,e.quantity,e.payMode,a].join("."),n=new URL(window.location.href);return n.searchParams.set("d",o),n.toString()}function Fo(){var l;let e=k(),t=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"",a=((l=_.variants[e.baseNumericId])==null?void 0:l.color)||"Silver",o=[t?`${t} wrap`:`${a} finish`],n=e.accessoryLines.map(s=>ee(s.merchandise.product.handle,s.merchandise.product.title));n.length&&o.push(n.join(", ")),e.quantity>1&&o.push(`qty ${e.quantity}`);let r=v(e.total,e.currency),i=`Total ${r}`;if(e.payMode==="finance"){let{amount:s}=vt(e.total,e.currency,"finance");i=`${v(s,e.currency)}/mo with Shop Pay (${r} total)`}return["Hi \u2014 I\u2019m designing an Olto and have a question.","",`My build: ${o.join(" \xB7 ")}`,i,Tt(),""].join(`
`)}var de=null;function Nt(e,t){for(let a of f.querySelectorAll("[data-config-reset]"))a.textContent=e,a.classList.toggle("is-armed",t)}async function Vo(){if(!de){Nt("Tap again to clear",!0),de=setTimeout(()=>{de=null,Nt("Clear configuration",!1)},3e3);return}clearTimeout(de),de=null,Nt("Clear configuration",!1);try{await la(J())}catch(e){console.error("[Infinite] Clear failed:",e)}Y=null,Ie("cash"),_e(x.main.handle,Ee(_.defaultVariantId))}function Uo(){let e=k();if(!e.ready)return;if(e.region==="row")return Ba("row");let t=it();t&&(F("begin_checkout",{checkout_url:t}),window.location.href=t)}var zo="https://cdn.jsdelivr.net/npm/hls.js@1.5.17/dist/hls.min.js",pe=null,Re=null,B=null,At=null;function Oe(){return f.querySelector("[data-video-el]")}function Da(){var e;return!!((e=Oe())!=null&&e.canPlayType("application/vnd.apple.mpegurl"))}function qa(){return window.Hls?Promise.resolve(window.Hls):Re||(Re=new Promise(e=>{let t=document.createElement("script");t.async=!0,t.src=zo,t.onload=()=>{pe=window.Hls||null,e(pe)},t.onerror=()=>{console.warn("[Infinite] hls.js failed to load \u2014 videos disabled"),e(null)},document.head.appendChild(t)}),Re)}function jo(){var t;Da()||window.Hls||pe||!((t=x==null?void 0:x.accessories)!=null&&t.some(a=>a.instructionVideo))||qa()}function Go(e){var l,s;let t=(l=x==null?void 0:x.accessories)==null?void 0:l.find(c=>c.handle===e),a=t==null?void 0:t.instructionVideo,o=f.querySelector("[data-video-modal]"),n=Oe();if(!a||!o||!n)return;q("[data-video-title]",ee(e,t.title)),At=a;let r=window.Hls||pe;Da()?n.src=a:r!=null&&r.isSupported()?(B||(B=new r({maxBufferLength:30}),B.attachMedia(n)),B.loadSource(a)):n.src=a,o.hidden=!1,n.muted=!1;let i=(s=n.play)==null?void 0:s.call(n);i!=null&&i.catch&&i.catch(()=>{var c;n.muted=!0,(c=n.play)==null||c.call(n).catch(m=>console.warn("[Infinite] Video playback blocked:",m))})}function Lt(){var a;let e=f.querySelector("[data-video-modal]"),t=Oe();!e||e.hidden||((a=t==null?void 0:t.pause)==null||a.call(t),e.hidden=!0)}function Ko(){let e=Oe();e&&(e.addEventListener("ended",Lt),e.addEventListener("error",async()=>{var a;if(!At||B)return;console.warn("[Infinite] Native HLS failed \u2014 retrying through hls.js");let t=window.Hls||pe||await qa();!(t!=null&&t.isSupported())||B||(B=new t({maxBufferLength:30}),B.attachMedia(e),B.loadSource(At),(a=e.play)==null||a.call(e).catch(o=>console.warn("[Infinite] hls.js retry failed:",o)))}),document.addEventListener("keydown",t=>{t.key==="Escape"&&Lt()}),jo())}function Wo(){let e=f.querySelector(".sheet");if(!e)return;let t=window.matchMedia("(min-width: 900px)");window.addEventListener("wheel",a=>{if(!t.matches)return;let o=a.target instanceof Element?a.target:null;if(o!=null&&o.closest(".sheet, .modal"))return;let n=a.deltaMode===1?16:a.deltaMode===2?e.clientHeight:1;e.scrollTop+=a.deltaY*n},{passive:!0})}function Ba(e){let t=f.querySelector("[data-save-modal]");if(!t)return;let a=e==="row",o=t.querySelector("[data-save-title]"),n=t.querySelector("[data-save-copy]");o&&(o.textContent=a?"Register your interest":"Save your design"),n&&(n.textContent=a?"Olto ships in the United States today. Leave your details and we\u2019ll tell you the moment it reaches you.":"We\u2019ll save this exact Olto so you can pick up where you left off on any device."),Fa(),F(a?"interest_form_open":"save_configuration_open"),za(!0)}function Yo(){var a,o;let e=k(),t=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"";return{location:$e,variant:((o=(a=_.variants)==null?void 0:a[e.baseNumericId])==null?void 0:o.color)||"",wrap:t,pack:e.activeBundle||"",quantity:String(e.quantity||1),accessories:e.accessoryLines.map(n=>n.merchandise.product.title).filter(Boolean).join(", "),design_url:Tt()}}function Fa(){let e=f.querySelector("[data-wf-form-slot] form");if(!e)return;let t=Yo();for(let[a,o]of Object.entries(t)){let n=e.querySelector(`input[name="${a}"]`);n&&(n.value=o)}}function F(e,t){var a,o;try{let n=k();window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:e,configurator:"olto",olto_variant:((o=(a=_.variants)==null?void 0:a[n.baseNumericId])==null?void 0:o.color)||"",olto_wrap:n.wrapLine?fe(n.wrapLine.merchandise)||n.wrapLine.merchandise.title:"",olto_pack:n.activeBundle||"",olto_quantity:n.quantity||1,olto_accessory_count:n.accessoryLines.length,olto_value:Number(n.total||0),olto_savings:Number(n.bundleSavings||0),olto_currency:n.currency||"USD",olto_region:n.region||"unresolved",olto_config_id:J()||"",...t||{}})}catch(n){console.warn("[Olto] dataLayer push failed:",n)}}var Va="olto_infinite_lead";function Ua(){try{let e=JSON.parse(localStorage.getItem(Va));return e!=null&&e.email?e:null}catch{return null}}function za(e){var a;let t=f.querySelector("[data-save-modal]");if(t&&(t.hidden=!e,e)){let o=t.querySelector("[data-save-form]"),n=t.querySelector("[data-save-done]");if(o){o.hidden=!1;let r=Ua(),[i,...l]=((r==null?void 0:r.name)||"").split(/\s+/),s={first_name:(r==null?void 0:r.first)||i||"",last_name:(r==null?void 0:r.last)||l.join(" ")||"",email:(r==null?void 0:r.email)||"",phone:(r==null?void 0:r.phone)||""};for(let[c,m]of Object.entries(s)){let d=o.querySelector(`input[name="${c}"]`);d&&!d.value&&(d.value=m)}}n&&(n.hidden=!0),(a=t.querySelector('input[name="first_name"]'))==null||a.focus()}}async function Qo(e){let t=e.first_name.value.trim(),a=e.last_name.value.trim(),o=e.email.value.trim(),n=e.phone.value.trim(),r=e.querySelector("[data-save-error]"),i=null;if(!t||!a?i="Please add your first and last name.":/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(o)?n.replace(/\D/g,"").length<7&&(i="That phone number looks too short."):i="That email doesn\u2019t look right.",i){r&&(r.textContent=i,r.hidden=!1);return}r&&(r.hidden=!0);try{localStorage.setItem(Va,JSON.stringify({first:t,last:a,email:o,phone:n}))}catch{}let l=Tt(),s=!0;try{await navigator.clipboard.writeText(l)}catch{s=!1}e.hidden=!0;let c=f.querySelector("[data-save-done]");if(c){c.hidden=!1;let m=c.querySelector("[data-save-done-msg]");m&&(m.textContent=s?"Link copied to your clipboard \u2014 it rebuilds this exact Olto.":"Copy your link below \u2014 it rebuilds this exact Olto.");let d=c.querySelector("[data-save-link]");d&&(d.textContent=l)}}function kt(e,t){return new Promise((a,o)=>{let n=new Image;t&&(n.crossOrigin="anonymous"),n.onload=()=>a(n),n.onerror=()=>o(new Error(`image failed: ${e}`)),n.src=e})}function Et(e,t,a){let o=Math.min(a.w/t.naturalWidth,a.h/t.naturalHeight),n=t.naturalWidth*o,r=t.naturalHeight*o;e.drawImage(t,a.x+(a.w-n)/2,a.y+(a.h-r)/2,n,r)}var It='"Helvetica Now Text", "Helvetica Neue", Helvetica, Arial, sans-serif',Zo='"Helvetica Now Display", "Helvetica Neue", Helvetica, Arial, sans-serif';async function Jo(){var t,a,o;let e=f.querySelector("[data-save-image-note]");e&&(e.hidden=!0);try{let n=k(),r=1080,i=1350,l=document.createElement("canvas");l.width=r,l.height=i;let s=l.getContext("2d");s.fillStyle="#ffffff",s.fillRect(0,0,r,i);let c=Ae.replace("<svg ",'<svg width="922" height="201" '),m=URL.createObjectURL(new Blob([c],{type:"image/svg+xml"}));try{Et(s,await kt(m),{x:r/2-160,y:64,w:320,h:70})}finally{URL.revokeObjectURL(m)}let d={x:90,y:190,w:900,h:620},h=(t=f.querySelector(".hero_img.is-active"))==null?void 0:t.src;if(h&&Et(s,await kt(h,!0),d),!((a=f.querySelector("[data-layers]"))==null?void 0:a.classList.contains("is-suppressed")))for(let L of f.querySelectorAll(".hero_layer.is-on"))try{Et(s,await kt(L.src,!0),d)}catch{}let C=[];n.bikeLine&&C.push([`Olto - ${((o=_.variants[n.baseNumericId])==null?void 0:o.color)||n.bikeLine.merchandise.title}`,parseFloat(n.bikeLine.merchandise.price.amount)]),n.wrapLine&&C.push([`Wrap - ${n.wrapLine.merchandise.title}`,parseFloat(n.wrapLine.merchandise.price.amount)]);for(let L of n.accessoryLines)C.push([ee(L.merchandise.product.handle,L.merchandise.product.title),parseFloat(L.merchandise.price.amount)]);n.bundleSavings>0&&C.push(["Bundle discount",-n.bundleSavings/(n.quantity||1)]);let S=120,N=r-120,b=880,$=C.slice(0,7);s.font=`26px ${It}`;for(let[L,D]of $)s.textAlign="left",s.fillStyle="#6a6a6a",s.fillText(L,S,b),s.textAlign="right",s.fillStyle="#252525",s.fillText(v(D,n.currency),N,b),b+=44;C.length>$.length&&(s.textAlign="left",s.fillStyle="#6a6a6a",s.fillText(`+ ${C.length-$.length} more`,S,b),b+=44),b+=8,s.strokeStyle="#e5e5e5",s.beginPath(),s.moveTo(S,b),s.lineTo(N,b),s.stroke(),b+=56,s.font=`500 34px ${Zo}`,s.textAlign="left",s.fillStyle="#252525",s.fillText("Total",S,b),s.textAlign="right",s.fillText(v(n.total,n.currency),N,b),b+=40,n.quantity>1&&(s.font=`22px ${It}`,s.textAlign="right",s.fillStyle="#6a6a6a",s.fillText(`${n.quantity} configurations`,N,b)),s.font=`22px ${It}`,s.textAlign="left",s.fillStyle="#9a9a9a",s.fillText("Taxes and shipping calculated at checkout - infinitemachine.com",S,i-80),l.toBlob(L=>{if(!L){e&&(e.textContent="Couldn\u2019t generate the image in this browser \u2014 a screenshot works too.",e.hidden=!1);return}let D=document.createElement("a");D.href=URL.createObjectURL(L),D.download="my-olto.png",D.click(),setTimeout(()=>URL.revokeObjectURL(D.href),1e4)},"image/png")}catch(n){console.error("[Infinite] Image export failed:",n),e&&(e.textContent="Couldn\u2019t generate the image in this browser \u2014 a screenshot works too.",e.hidden=!1)}}function ja(e,{silent:t}={}){let a=Se.find(n=>n.Code===e);$e=(a==null?void 0:a.Name)||"",yt(e==="US"?"us":"row");let o=f.querySelector("[data-country]");o&&a&&(o.value=e),q("[data-rail-country]",$e||"\u2014"),t||F("select_country",{olto_country:$e||e})}async function Xo(){let e=new AbortController,t=setTimeout(()=>e.abort(),8e3);try{let o=(await(await fetch("https://get.geojs.io/v1/ip/country",{signal:e.signal})).text()).trim().toUpperCase();ja(o,{silent:!0})}catch{yt("")}finally{clearTimeout(t)}}function en(e){if(!(!e||e===Ia)){Ia=e;try{let t=new URLSearchParams(window.location.search);if(t.get("variant")===String(e))return;t.set("variant",String(e)),window.history.replaceState({},"",`${window.location.pathname}?${t}${window.location.hash}`)}catch(t){console.warn("[Olto] variant param sync failed:",t)}}}function ue(e){var $,L,D,Rt,$t,Ot,Mt;if(!e.ready)return;en(e.baseNumericId);let t=_.variants[e.baseNumericId]||{};q("[data-delivery]",Lo),q("[data-rail-delivery]",To);let a=e.wrapLine?fe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"";for(let p of f.querySelectorAll("[data-color-swatch]"))p.classList.toggle("is-selected",e.wrapLine?p.dataset.colorSwatch===a:p.dataset.colorSwatch==="");let o=new Set(e.accessoryLines.map(p=>p.merchandise.product.handle)),n={},r=new Set;for(let p of _.customImageRules||[])if(p.when.every(A=>o.has(A))){Object.assign(n,p.replace||{});for(let A of p.hide||[])r.add(A)}let i=!1;for(let p of f.querySelectorAll("[data-layer]")){let A=p.dataset.layer,ne=o.has(A)&&!r.has(A),Me=n[A]||bt[A];Me&&p.getAttribute("src")!==Me&&p.setAttribute("src",Me),p.classList.toggle("is-on",ne),ne&&(i=!0)}let l=(L=($=x.main.variants.find(p=>ke(p.id)===e.baseNumericId))==null?void 0:$.image)==null?void 0:L.url,s=e.region==="row"?"eu":"us",c=(s==="eu"?t.backgroundImage:te(l,1600))||te(l,1600)||t.backgroundImage,m=e.wrapLine?(Rt=(D=ae.get(a))==null?void 0:D.image)==null?void 0:Rt.url:null,d=m&&!Ao.has(a);if(e.wrapLine&&a==="Black"){let p=x.main.variants.find(A=>{var ne;return((ne=_.variants[ke(A.id)])==null?void 0:ne.color)==="Black"});($t=p==null?void 0:p.image)!=null&&$t.url&&(m=te(p.image.url,1600),d=!0)}a==="Custom"&&(m=null),(Ot=f.querySelector("[data-layers]"))==null||Ot.classList.toggle("is-suppressed",!!m&&!d&&i),m?Ra(m,`wrap:${a}`):Ra(c,`base:${e.baseNumericId}:${s}`);let h=j?j.value:e.activeBundle;for(let p of f.querySelectorAll("[data-bundle]"))p.classList.toggle("is-selected",p.dataset.bundle===h);let y=new Set(e.accessoryLines.map(p=>p.merchandise.product.handle));for(let p of f.querySelectorAll("[data-acc-toggle]")){let A=y.has(p.dataset.accToggle);p.textContent=A?"Added":"Add",p.classList.toggle("is-added",A),(Mt=p.closest("[data-acc]"))==null||Mt.classList.toggle("is-added",A)}q("[data-qty-value]",String(e.quantity));let C=Ea(e,_);for(let p of f.querySelectorAll("[data-summary]"))p.innerHTML!==C&&(p.innerHTML=C);q("[data-summary-total]",v(e.total,e.currency));let S=e.payMode==="finance"?"finance":"cash",N=vt(e.total,e.currency,S);for(let p of f.querySelectorAll("[data-pay-mode]"))p.classList.toggle("is-active",p.dataset.payMode===S);q("[data-pay-figure]",v(N.amount,e.currency)+N.suffix),q("[data-pay-sub]",N.sub),tn(N.amount,N.suffix,e.currency),q("[data-total-label]",N.label);for(let p of f.querySelectorAll("[data-total-save]"))p.textContent=e.bundleSavings?`You save ${v(e.bundleSavings,e.currency)}`:"",p.hidden=!e.bundleSavings;let b=f.querySelector("[data-cta]");if(b){let p=e.region==="row"?"":it();b.setAttribute("href",p||"#")}b&&(b.textContent=e.region==="row"?"Register interest":"Order")}function fe(e){var a;let t=(a=e.selectedOptions)==null?void 0:a.find(o=>/colou?rs?/i.test(o.name));return(t==null?void 0:t.value)||null}function q(e,t){for(let a of f.querySelectorAll(e))a.textContent!==t&&(a.textContent=t)}function tn(e,t,a){let o=f.querySelector("[data-total]");if(o){if(O&&!document.hidden&&xt!==e){Ct&&Ct.kill();let n={v:xt};Ct=O.to(n,{v:e,duration:.45,ease:"power2.out",onUpdate:()=>{o.textContent=v(n.v,a)+t},onComplete:()=>{o.textContent=v(e,a)+t}})}else o.textContent=v(e,a)+t;xt=e}}function Ra(e,t){if(!e||t===Le)return;let a={a:f.querySelector('[data-hero-img="a"]'),b:f.querySelector('[data-hero-img="b"]')};if(!a.a||!a.b)return;if(Le===null){a[ce].src=e,Le=t;return}let o=a[ce],n=a[ce==="a"?"b":"a"];n.src=e,ce=ce==="a"?"b":"a",Le=t,O?(O.set(n,{opacity:0,scale:1.04,xPercent:0,yPercent:0}),n.classList.add("is-active"),O.to(n,{opacity:1,scale:1,duration:.45,ease:"power2.out"}),O.to(o,{opacity:0,duration:.45,ease:"power2.out",onComplete:()=>o.classList.remove("is-active")})):(n.classList.add("is-active"),n.style.opacity=1,o.classList.remove("is-active"),o.style.opacity=0)}function an(){if(!O||!window.ScrollTrigger||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let e=f.querySelector(".sheet");for(let t of f.querySelectorAll(".opt"))O.from(t,{y:24,opacity:0,duration:.45,ease:"power2.out",scrollTrigger:{trigger:t,scroller:e,start:"top 88%",once:!0}})}var Ga="[data-olto-configurator]",Ka=["#wf-form-Olto-Interest-Form",'[data-modal-name="interest"] form'];on();async function on(){let e=document.querySelector(Ga);if(!e){console.error(`[Olto] No ${Ga} on the page \u2014 configurator not mounted.`);return}nn(e),rn(),await $a(e),sn(e)}function nn(e){let t=[];for(let a=e.parentElement;a&&a!==document.documentElement;a=a.parentElement){let o=getComputedStyle(a);(o.transform!=="none"||o.filter!=="none"||o.perspective!=="none"||o.contain!=="none"||o.willChange&&/transform|filter|perspective/.test(o.willChange))&&t.push(a)}t.length&&console.error("[Olto] Mount has ancestor(s) creating a containing block \u2014 every fixed region will collapse. Move the mount to a direct child of <body>.",t)}function rn(){if(document.querySelector("[sf-token][sf-domain]"))return;let e=0,t=setInterval(()=>{if(document.querySelector("[sf-token][sf-domain]"))return clearInterval(t);e+=1,!(e<40)&&(clearInterval(t),console.error("[Olto] No [sf-token][sf-domain] on this page. im-attribution cannot write im_* onto the Shopify cart, so orders will reach the CRM with no source. Restore the Shopyflow host element before shipping."))},250)}function sn(e){let t=e.querySelector("[data-wf-form-slot]"),a=Ka.reduce((n,r)=>n||document.querySelector(r),null);if(!t){console.error("[Olto] No [data-wf-form-slot] in the rendered UI \u2014 form not adopted.");return}if(!a){console.error("[Olto] No Webflow interest form found (tried: "+Ka.join(", ")+"). Rest-of-world interest and US save would both capture nothing \u2014 leaving the fallback form in place.");return}t.appendChild(a.closest(".w-form")||a),t.hidden=!1;let o=e.querySelector("[data-save-form]");o&&o.remove()}})();
