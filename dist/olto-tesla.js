...
`,Nt=/boundary="?([^=";]+)"?/i,Ae=wt+wt;function T(e,t=z){return e.startsWith(`${t}`)?e:`${t}: ${e}`}function O(e){return e instanceof Error?e.message:JSON.stringify(e)}function Le(e){return e instanceof Error&&e.cause?e.cause:void 0}function Te(e){return e.flatMap(({errors:t})=>t!=null?t:[])}function le({client:e,retries:t}){if(t!==void 0&&(typeof t!="number"||t<0||t>3))throw new Error(`${e}: The provided "retries" value (${t}) is invalid - it cannot be less than ${0} or greater than ${3}`)}function _(e,t){return t&&(typeof t!="object"||Array.isArray(t)||typeof t=="object"&&Object.keys(t).length>0)?{[e]:t}:{}}function Re(e,t){if(e.length===0)return t;let o={[e.pop()]:t};return e.length===0?o:Re(e,o)}function Et(e,t){return Object.keys(t||{}).reduce((a,o)=>(typeof t[o]=="object"||Array.isArray(t[o]))&&e[o]?(a[o]=Et(e[o],t[o]),a):(a[o]=t[o],a),Array.isArray(e)?[...e]:{...e})}function $e([e,...t]){return t.reduce(Et,{...e})}function Oe({clientLogger:e,customFetchApi:t=fetch,client:a=z,defaultRetryWaitTime:o=se,retriableCodes:r=_t}){let n=async(i,s,l)=>{let c=s+1,d=l+1,f;try{if(f=await t(...i),e({type:"HTTP-Response",content:{requestParams:i,response:f}}),!f.ok&&r.includes(f.status)&&c<=d)throw new Error;let h=(f==null?void 0:f.headers.get("X-Shopify-API-Deprecated-Reason"))||"";return h&&e({type:"HTTP-Response-GraphQL-Deprecation-Notice",content:{requestParams:i,deprecationNotice:h}}),f}catch(h){if(c<=d){let y=f==null?void 0:f.headers.get("Retry-After");return await Na(y?parseInt(y,10):o),e({type:"HTTP-Retry",content:{requestParams:i,lastResponse:f,retryAttempt:s,maxRetries:l}}),n(i,c,l)}throw new Error(T(`${l>0?`Attempted maximum number of ${l} network retries. Last message - `:""}${O(h)}`,a))}};return n}async function Na(e){return new Promise(t=>setTimeout(t,e))}function Me({headers:e,url:t,customFetchApi:a=fetch,retries:o=0,logger:r}){le({client:z,retries:o});let n={headers:e,url:t,retries:o},i=Sa(r),s=Oe({customFetchApi:a,clientLogger:i,defaultRetryWaitTime:se}),l=ka(s,n),c=Ea(l),d=Oa(l);return{config:n,fetch:l,request:c,requestStream:d}}function Sa(e){return t=>{e&&e(t)}}async function It(e){let{errors:t,data:a,extensions:o}=await e.json();return{..._("data",a),..._("extensions",o),headers:e.headers,...t||!a?{errors:{networkStatusCode:e.status,message:T(t?_e:Se),..._("graphQLErrors",t),response:e}}:{}}}function ka(e,{url:t,headers:a,retries:o}){return async(r,n={})=>{let{variables:i,headers:s,url:l,retries:c,keepalive:d,signal:f}=n,h=JSON.stringify({query:r,variables:i});le({client:z,retries:c});let y=Object.entries({...a,...s}).reduce((w,[$,F])=>(w[$]=Array.isArray(F)?F.join(", "):F.toString(),w),{});!y[ke]&&!y[Ee]&&(y[ke]=Ct,y[Ee]=xt);let M=[l!=null?l:t,{method:"POST",headers:y,body:h,signal:f,keepalive:d}];return e(M,1,c!=null?c:o)}}function Ea(e){return async(...t)=>{if(Ie.test(t[0]))throw new Error(T("This operation will result in a streamable response - use requestStream() instead."));let a=null;try{a=await e(...t);let{status:o,statusText:r}=a,n=a.headers.get("content-type")||"";return a.ok?n.includes(ie.json)?await It(a):{errors:{networkStatusCode:o,message:T(`${Ne} ${n}`),response:a}}:{errors:{networkStatusCode:o,message:T(r),response:a}}}catch(o){return{errors:{message:O(o),...a==null?{}:{networkStatusCode:a.status,response:a}}}}}}async function*Ia(e){let t=new TextDecoder;if(e.body[Symbol.asyncIterator])for await(let a of e.body)yield t.decode(a);else{let a=e.body.getReader(),o;try{for(;!(o=await a.read()).done;)yield t.decode(o.value)}finally{a.cancel()}}}function Aa(e,t){return{async*[Symbol.asyncIterator](){try{let a="";for await(let o of e)if(a+=o,a.indexOf(t)>-1){let r=a.lastIndexOf(t),i=a.slice(0,r).split(t).filter(s=>s.trim().length>0).map(s=>s.slice(s.indexOf(Ae)+Ae.length).trim());i.length>0&&(yield i),a=a.slice(r+t.length),a.trim()==="--"&&(a="")}}catch(a){throw new Error(`Error occured while processing stream payload - ${O(a)}`)}}}}function La(e){return{async*[Symbol.asyncIterator](){try{yield{...await It(e),hasNext:!1}}catch(t){yield{errors:{message:T(O(t)),networkStatusCode:e.status,response:e},hasNext:!1}}}}}function Ta(e){return e.map(t=>{try{return JSON.parse(t)}catch(a){throw new Error(`Error in parsing multipart response - ${O(a)}`)}}).map(t=>{let{data:a,incremental:o,hasNext:r,extensions:n,errors:i}=t;if(!o)return{data:a||{},..._("errors",i),..._("extensions",n),hasNext:r};let s=o.map(({data:l,path:c,errors:d})=>({data:l&&c?Re(c,l):{},..._("errors",d)}));return{data:s.length===1?s[0].data:$e([...s.map(({data:l})=>l)]),..._("errors",Te(s)),hasNext:r}})}function Ra(e,t){if(e.length>0)throw new Error(_e,{cause:{graphQLErrors:e}});if(Object.keys(t).length===0)throw new Error(Se)}function $a(e,t){var s,l;let a=(t!=null?t:"").match(Nt),o=`--${a?a[1]:"-"}`;if(!((s=e.body)!=null&&s.getReader)&&!((l=e.body)!=null&&l[Symbol.asyncIterator]))throw new Error("API multipart response did not return an iterable body",{cause:e});let r=Ia(e),n={},i;return{async*[Symbol.asyncIterator](){var c,d;try{let f=!0;for await(let h of Aa(r,o)){let y=Ta(h);i=(d=(c=y.find(w=>w.extensions))==null?void 0:c.extensions)!=null?d:i;let M=Te(y);n=$e([n,...y.map(({data:w})=>w)]),f=y.slice(-1)[0].hasNext,Ra(M,n),yield{..._("data",n),..._("extensions",i),hasNext:f}}if(f)throw new Error("Response stream terminated unexpectedly")}catch(f){let h=Le(f);yield{..._("data",n),..._("extensions",i),errors:{message:T(O(f)),networkStatusCode:e.status,..._("graphQLErrors",h==null?void 0:h.graphQLErrors),response:e},hasNext:!1}}}}}function Oa(e){return async(...t)=>{if(!Ie.test(t[0]))throw new Error(T("This operation does not result in a streamable response - use request() instead."));try{let a=await e(...t),{statusText:o}=a;if(!a.ok)throw new Error(o,{cause:a});let r=a.headers.get("content-type")||"";switch(!0){case r.includes(ie.json):return La(a);case r.includes(ie.multipart):return $a(a,r);default:throw new Error(`${Ne} ${r}`,{cause:a})}}catch(a){return{async*[Symbol.asyncIterator](){let o=Le(a);yield{errors:{message:T(O(a)),..._("networkStatusCode",o==null?void 0:o.status),..._("response",o)},hasNext:!1}}}}}}function De({client:e,storeDomain:t}){try{if(!t||typeof t!="string")throw new Error;let a=t.trim(),o=a.match(/^https?:/)?a:`https://${a}`,r=new URL(o);return r.protocol="https",r.origin}catch(a){throw new Error(`${e}: a valid store domain ("${t}") must be provided`,{cause:a})}}function ce({client:e,currentSupportedApiVersions:t,apiVersion:a,logger:o}){let r=`${e}: the provided apiVersion ("${a}")`,n=`Currently supported API versions: ${t.join(", ")}`;if(!a||typeof a!="string")throw new Error(`${r} is invalid. ${n}`);let i=a.trim();t.includes(i)||(o?o({type:"Unsupported_Api_Version",content:{apiVersion:a,supportedApiVersions:t}}):console.warn(`${r} is likely deprecated or not supported. ${n}`))}function de(e){let t=e*3-2;return t===10?t:`0${t}`}function Pe(e,t,a){let o=t-a;return o<=0?`${e-1}-${de(o+4)}`:`${e}-${de(o)}`}function At(){let e=new Date,t=e.getUTCMonth(),a=e.getUTCFullYear(),o=Math.floor(t/3+1);return{year:a,quarter:o,version:`${a}-${de(o)}`}}function He(){let{year:e,quarter:t,version:a}=At(),o=t===4?`${e+1}-01`:`${e}-${de(t+1)}`;return[Pe(e,t,3),Pe(e,t,2),Pe(e,t,1),a,o,"unstable"]}function qe(e){return t=>({...t!=null?t:{},...e.headers})}function Be({getHeaders:e,getApiUrl:t}){return(a,o)=>{let r=[a];if(o&&Object.keys(o).length>0){let{variables:n,apiVersion:i,headers:s,retries:l,signal:c}=o;r.push({...n?{variables:n}:{},...s?{headers:e(s)}:{},...i?{url:t(i)}:{},...l?{retries:l}:{},...c?{signal:c}:{}})}return r}}var Ve="application/json",Lt="storefront-api-client",Tt="1.0.10",Rt="X-Shopify-Storefront-Access-Token",$t="Shopify-Storefront-Private-Token",Ot="X-SDK-Variant",Mt="X-SDK-Version",Dt="X-SDK-Variant-Source",G="Storefront API Client";function Pt(e){if(e&&typeof window!="undefined")throw new Error(`${G}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`)}function Ht(e,t){if(!e&&!t)throw new Error(`${G}: a public or private access token must be provided`);if(e&&t)throw new Error(`${G}: only provide either a public or private access token`)}function Fe({storeDomain:e,apiVersion:t,publicAccessToken:a,privateAccessToken:o,clientName:r,retries:n=0,customFetchApi:i,logger:s}){let l=He(),c=De({client:G,storeDomain:e}),d={client:G,currentSupportedApiVersions:l,logger:s};ce({...d,apiVersion:t}),Ht(a,o),Pt(o);let f=Ma(c,t,d),h={storeDomain:c,apiVersion:t,...a?{publicAccessToken:a}:{privateAccessToken:o},headers:{"Content-Type":Ve,Accept:Ve,[Ot]:Lt,[Mt]:Tt,...r?{[Dt]:r}:{},...a?{[Rt]:a}:{[$t]:o}},apiUrl:f(),clientName:r},y=Me({headers:h.headers,url:h.apiUrl,retries:n,customFetchApi:i,logger:s}),M=qe(h),w=Da(h,f),$=Be({getHeaders:M,getApiUrl:w});return Object.freeze({config:h,getHeaders:M,getApiUrl:w,fetch:(...D)=>y.fetch(...$(...D)),request:(...D)=>y.request(...$(...D)),requestStream:(...D)=>y.requestStream(...$(...D))})}function Ma(e,t,a){return o=>{o&&ce({...a,apiVersion:o});let r=(o!=null?o:t).trim();return`${e}/api/${r}/graphql.json`}}function Da(e,t){return a=>a?t(a):e.apiUrl}var ue={SHOPIFY_STORE_DOMAIN:"shop.infinitemachine.com",SHOPIFY_STOREFRONT_PUBLIC_TOKEN:"eefb42e32220791a7472aaa5d2cf2182",SHOPIFY_API_VERSION:"2026-04"};var P=Fe({storeDomain:ue.SHOPIFY_STORE_DOMAIN,apiVersion:ue.SHOPIFY_API_VERSION,publicAccessToken:ue.SHOPIFY_STOREFRONT_PUBLIC_TOKEN});var Vt="olto_cart_",Pa="cfg_",ze="config",R=null,p=null,j=null,Ke=null,E=null,pe=[],Ha=[];function H(e){j=e,p=e}var J=null;function Ft(e){J=e}async function Ut(e){var a;Ke=e.id,E=qt()||jt();let t=Ua();if(t)try{let o=await Ba(t);o&&(R=t,H(o))}catch(o){console.warn("[Cart] Failed to restore cart, will create new:",o)}if(!R){let o=await qa();H(o),R=o.id,za(R)}if(!qt()&&((a=p==null?void 0:p.lines)!=null&&a.length)){let o=Va(p);o&&(E=o)}return Wt(E),I(),Yt(),p}function je(){return p==null?void 0:p.checkoutUrl}function ee(){return E}function Ye(){return E=jt(),Wt(E),Yt(),E}async function zt(e){te();let t=j,a=((t==null?void 0:t.lines)||[]).filter(o=>{var r;return((r=o.attributesByKey)==null?void 0:r._config_id)===e}).map(o=>o.id);a.length!==0&&(await Qe(a),e===E&&Ye())}async function We(e){te();let t=p,a=Ge(E),o=e.map(n=>Qt(n.variantId,n.quantity||a,{...n.attributes||{},_config_id:E})).filter(Boolean);o.length&&(p=Zt(p,o),I());let r=e.map(n=>({merchandiseId:n.variantId,quantity:n.quantity||a,attributes:X({...n.attributes||{},_config_id:E})}));try{return H(await fe(()=>Y("cartLinesAdd",`
    ...
    `,{cartId:R,lines:r}))),I(),p}catch(n){throw p=t,I(),n}}async function Qe(e){te();let t=p,a=new Set(e);p&&(p={...p,lines:p.lines.filter(o=>!a.has(o.id))},I());try{return H(await fe(()=>Y("cartLinesRemove",`
    ...
    `,{cartId:R,lineIds:e}))),I(),p}catch(o){throw p=t,I(),o}}async function Gt({lineId:e,variantId:t,quantity:a,attributes:o}){te();let r=p;p&&(p={...p,lines:p.lines.map(i=>{if(i.id!==e)return i;let s={...i};if(t!==void 0){let l=Je(t)||i.merchandise;s.merchandise=l}if(a!==void 0&&(s.quantity=a),o!==void 0){let l=X(o);s.attributes=l,s.attributesByKey=Object.fromEntries(l.map(c=>[c.key,c.value]))}return s})},I());let n={id:e};t!==void 0&&(n.merchandiseId=t),a!==void 0&&(n.quantity=a),o!==void 0&&(n.attributes=X(o));try{return H(await fe(()=>Y("cartLinesUpdate",`
...
`;async function qa(){var o;let{data:e,errors:t}=await P.request(`
    mutation CartCreate {
      cartCreate(input: {}) {
        cart { ${q} }
        userErrors { field message }
  ...
  `);if(t)throw new Error(`[Cart] createCart errors: ${JSON.stringify(t)}`);let a=(o=e==null?void 0:e.cartCreate)==null?void 0:o.userErrors;if(a!=null&&a.length)throw new Error(`[Cart] createCart userErrors: ${JSON.stringify(a)}`);return Ze(e.cartCreate.cart)}async function Ba(e){let{data:t,errors:a}=await P.request(`
    query GetCart($id: ID!) {
      cart(id: $id) { ${q} }
    }
  `,{variables:{id:e}});if(a)throw new Error(`[Cart] queryCart errors: ${JSON.stringify(a)}`);return t!=null&&t.cart?Ze(t.cart):null}async function Y(e,t,a){var i;let{data:o,errors:r}=await P.request(t,{variables:a});if(r)throw new Error(`[Cart] ${e} errors: ${JSON.stringify(r)}`);let n=o==null?void 0:o[e];if((i=n==null?void 0:n.userErrors)!=null&&i.length)throw new Error(`[Cart] ${e} userErrors: ${JSON.stringify(n.userErrors)}`);return Ze(n.cart)}function Ze(e){let t=e.attributes||[];return{id:e.id,checkoutUrl:e.checkoutUrl,totalQuantity:e.totalQuantity,cost:e.cost,attributes:t,attributesByKey:Object.fromEntries(t.map(a=>[a.key,a.value])),lines:e.lines.edges.map(({node:a})=>({id:a.id,quantity:a.quantity,attributes:a.attributes,attributesByKey:Object.fromEntries(a.attributes.map(o=>[o.key,o.value])),merchandise:a.merchandise}))}}function X(e){return Object.entries(e).filter(([,t])=>t!=null&&t!=="").map(([t,a])=>({key:t,value:String(a)}))}function te(){if(!R)throw new Error("[Cart] Called before initCart(config)")}function I(){for(let e of pe)e(p)}function jt(){return`${Pa}${Date.now()}_${Math.random().toString(36).slice(2,8)}`}function Ge(e){var o;let t=j||p;if(!((o=t==null?void 0:t.lines)!=null&&o.length))return 1;let a=t.lines.find(r=>{var n;return((n=r.attributesByKey)==null?void 0:n._config_id)===e});return(a==null?void 0:a.quantity)||1}function Yt(){for(let e of Ha)e(E)}function qt(){return typeof window=="undefined"?null:new URLSearchParams(window.location.search).get(ze)}function Wt(e){if(typeof window=="undefined")return;let t=new URLSearchParams(window.location.search);e?t.set(ze,e):t.delete(ze),window.history.replaceState({},"",`${window.location.pathname}?${t.toString()}`)}function Va(e){var a;if(!((a=e==null?void 0:e.lines)!=null&&a.length))return null;let t=e.lines.map(o=>{var r;return(r=o.attributesByKey)==null?void 0:r._config_id}).filter(Boolean).sort();return t[t.length-1]||null}var Bt=Promise.resolve();async function fe(e){let t=Bt,a;Bt=new Promise(o=>{a=o}),await t;try{return await e()}finally{a()}}var Ue=new Map;function Fa(e,t){let a=Ue.get(e)||{inflight:null,latest:null};return a.latest=t,Ue.set(e,a),a.inflight||(a.inflight=(async()=>{for(;a.latest;){let o=a.latest;a.latest=null;try{await fe(o)}catch(r){console.error(`[Cart] coalesce(${e}) error:`,r)}}a.inflight=null,Ue.delete(e)})()),a.inflight}async function me(e,t){te();let a=E;if(p){let o=p.lines.findIndex(r=>{var n;return r.merchandise.product.handle===e&&((n=r.attributesByKey)==null?void 0:n._config_id)===a});if(o>=0&&t===null)p={...p,lines:p.lines.filter((r,n)=>n!==o)};else if(o>=0&&t){let r=Je(t);r&&(p={...p,lines:p.lines.map((n,i)=>i===o?{...n,merchandise:r}:n)})}else if(o<0&&t){let r=Ge(a),n=Qt(t,r,{_config_id:a});n&&(p=Zt(p,[n]))}I()}return Fa(`product:${e}:${a}`,async()=>{let o=j==null?void 0:j.lines.find(r=>{var n;return r.merchandise.product.handle===e&&((n=r.attributesByKey)==null?void 0:n._config_id)===a});if(t===null){o&&(H(await Y("cartLinesRemove",`
...
`;var ra='<svg viewBox="0 0 922 201" fill="none" xmlns="http://www.w3.org/2000/svg" class="olto-wordmark" role="img" aria-label="Olto"> <path d="M246.995 19.4652C255.252 28.6186 259.698 41.3214 261.454 61.0855C262.35 70.239 262.649 80.8495 262.649 102.706C262.649 151.985 257.942 170.89 242.885 184.153C231.976 193.605 217.218 198.313 192.41 199.807C182.958 200.405 147.241 201.003 119.817 201.003C59.5913 201.003 43.3765 199.247 26.564 190.093C13.5623 182.995 5.00663 169.433 2.35399 149.968C0.598013 136.966 0.000235075 126.355 0.000235075 94.1874C-0.0371261 48.1211 4.37149 29.8142 18.5687 17.4103C29.1793 7.95792 43.0403 3.54931 68.4458 1.45708C78.496 0.560417 108.011 0 143.99 0C213.631 0 232.237 3.54931 246.995 19.4652ZM46.2907 100.651C46.2907 139.021 49.2422 151.425 60.1517 157.029C71.0611 162.932 80.5135 163.829 136.891 163.829C187.665 163.829 200.331 161.774 208.326 152.919C215.126 145.559 217.181 132.856 217.181 99.4927C217.181 37.8095 216.583 37.2117 131.586 37.2117C46.5896 37.2117 46.2907 38.1084 46.2907 100.651Z" fill="#E90022"/> <path d="M286.86 2.05334H332.328V162.034H476.057V198.909H286.86V2.05334Z" fill="#E90022"/> <path d="M507.328 38.9662H414.673V2.05334H645.154V38.9288H552.759V198.909H507.291V38.9662H507.328Z" fill="#E90022"/> <path d="M906.345 19.4644C914.602 28.6179 919.048 41.3207 920.804 61.0847C921.701 70.2382 922 80.8488 922 102.705C922 151.984 917.292 170.889 902.236 184.152C891.326 193.605 876.569 198.312 851.761 199.807C842.308 200.404 806.591 201.002 779.168 201.002C718.979 201.002 702.727 199.246 685.915 190.093C672.913 182.994 664.357 169.432 661.705 149.967C659.949 136.965 659.351 126.355 659.351 94.1867C659.351 48.1578 663.797 29.8508 677.957 17.4469C688.567 7.99454 702.466 3.58593 727.834 1.49371C737.884 0.597038 767.399 0.0366211 803.378 0.0366211C873.019 0.0366211 891.625 3.58593 906.383 19.5018L906.345 19.4644ZM705.679 100.65C705.679 139.02 708.63 151.424 719.54 157.028C730.449 162.931 739.901 163.828 796.279 163.828C847.053 163.828 859.719 161.773 867.714 152.918C874.514 145.558 876.569 132.855 876.569 99.492C876.569 37.8087 875.971 37.211 790.974 37.211C705.978 37.211 705.679 38.1076 705.679 100.65Z" fill="#E90022"/> </svg>',na='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 831.97 45.21" class="im-wordmark" fill="currentColor" role="img" aria-label="Infinite Machine"><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M13.56.33V44.88H0V.33Z"/><path d="M44.93.33l27,33.86L71.58.33H84.4V44.88H62.63L36,11.35l.34,33.53h-13V.33Z"/><path d="M141.66.33V10.42H107.87V19.3h32.06V29.39H107.87V44.88H94.38V.33Z"/><path d="M163.09.33V44.88H149.54V.33Z"/><path d="M194.46.33l27,33.86L221.11.33h12.82V44.88H212.16L185.58,11.35l.33,33.53h-13V.33Z"/><path d="M257.44.33V44.88H243.89V.33Z"/><path d="M264.52,11.35V.33h53.23v11H297.91V44.88H284.35V11.35Z"/><path d="M374.26,10.42h-36V18.1h33.93v8.81H338.26V34.8h36.47V44.88H324.91V.33h49.35Z"/><path d="M423,.33l16.23,29.59L455.34.33h21.37V44.88H463.49l.67-34.39L444.39,44.88H433.57L414.13,10.49l.4,34.39H401.44V.33Z"/><path d="M526.62.33,551,44.88H536.17l-4.4-8H503.05l-4.28,8H483.41l25-44.55Zm-9.21,9.55-9.49,17.77H527Z"/><path d="M611.09,32.22c0,1.14-.11,2.11-.2,2.91a13.74,13.74,0,0,1-.36,2.07,11.1,11.1,0,0,1-.57,1.6,8.86,8.86,0,0,1-4.21,4.31,21.46,21.46,0,0,1-8.08,1.77q-2.07.19-6.18.27t-10.78.06c-3.21,0-5.91,0-8.12-.13a53.92,53.92,0,0,1-5.61-.47,20.34,20.34,0,0,1-3.9-.9,14.32,14.32,0,0,1-2.94-1.43,10.08,10.08,0,0,1-2.77-2.58,11.37,11.37,0,0,1-1.74-3.87,32.31,32.31,0,0,1-.9-5.84c-.18-2.32-.27-5.12-.27-8.42q0-4.41.27-7.48a23.36,23.36,0,0,1,1-5.24,10,10,0,0,1,1.87-3.54,10.88,10.88,0,0,1,2.9-2.37,16.6,16.6,0,0,1,3.17-1.44,23.22,23.22,0,0,1,4-.9Q570,.27,573.29.13c2.19-.09,4.83-.13,8-.13q6.21,0,10.22.07c2.67,0,4.88.15,6.61.33a27.49,27.49,0,0,1,4.21.7,18,18,0,0,1,3,1.1,8.12,8.12,0,0,1,4,4.35,20.63,20.63,0,0,1,1.27,7.94V16h-13a11.59,11.59,0,0,0-.5-2.87,2.69,2.69,0,0,0-1.7-1.6,12.6,12.6,0,0,0-3.87-.67c-1.7-.09-4-.13-6.95-.13q-4.14,0-6.74.06c-1.74.05-3.13.14-4.18.27a10.12,10.12,0,0,0-2.4.53,5.12,5.12,0,0,0-1.44.87,4.48,4.48,0,0,0-1,1.24,7.48,7.48,0,0,0-.6,1.87,20.61,20.61,0,0,0-.3,2.94c0,1.18-.07,2.66-.07,4.44a42.86,42.86,0,0,0,.37,6.31A5.34,5.34,0,0,0,570,32.66a8,8,0,0,0,4.21,1.43,75.75,75.75,0,0,0,7.68.31c2.54,0,4.57,0,6.11,0s2.77,0,3.71-.1a12.82,12.82,0,0,0,2.13-.23,7.73,7.73,0,0,0,1.47-.5,3.77,3.77,0,0,0,2.07-1.81,8.36,8.36,0,0,0,.6-3.6h13.16C611.16,29.72,611.14,31.09,611.09,32.22Z"/><path d="M633.44.33v16.5H664.3V.33h13.56V44.88H664.3v-17H633.44v17H619.88V.33Z"/><path d="M701.33.33V44.88H687.77V.33Z"/><path d="M732.7.33l27,33.86L759.35.33h12.82V44.88H750.4L723.82,11.35l.33,33.53h-13V.33Z"/><path d="M831.51,10.42h-36V18.1h33.93v8.81H795.51V34.8H832V44.88H782.15V.33h49.36Z"/></g></g></svg>',N="https://cdn.prod.website-files.com/66ea2a84659b76f5d91d481b",st={"accessory-plate":`${N}/68d53a735e9c987a9499211a_accessory-plate.avif`,"charger-bag":`${N}/68d53a2cb165eb23a2527775_charger-bag.avif`,"olto-center-stand":`${N}/68d53974c880c4b20d23dec9_olto-center-stand.avif`,"olto-charging-dock":`${N}/68d5396153ba7acdd9978c0d_olto-charging-dock.avif`,"olto-kid-carrier":`${N}/6921a92ec4d3dc4a766d69bb_Kid%20Carrier.avif`,"olto-rear-basket":`${N}/68d53b6769ccc4ad6ad7d0b3_olto-rear-basket.avif`,"olto-rear-rack":`${N}/68d53b2e1153a3e349d34c1a_olto-rear-rack.avif`,"olto-side-mounting-plate":`${N}/68d53bea87ff421cf85c858e_olto-side-mounting-plate.avif`,"olto-water-bottle-holder":`${N}/68d53d46367f73dfd1b58a42_olto-water-bottle-holder.avif`,"olto-sidewalls":`${N}/68d53c3ccb4cfb15c59ac6cd_olto-sidewalls.avif`,"olto-super-charger":`${N}/6921a99cb5dd5b924cf4965d_Super%20Charger%20on%20the%20Ground.avif`,"olto-u-lock-mount":`${N}/68d53cf8bb965a6129e84ff4_olto-u-lock-mount.avif`,"open-face-helmet":`${N}/6921a8f20583ec71e2663dce_Black%20Open%20Face%20Helmet.avif`,"kryptonite-lock":`${N}/68d53fc0d2d8d2d151493b5f_kryptonite-lock.avif`,"olto-soft-bag":`${N}/692197c1914921de9b30217a_Soft%20Bag%20on%20the%20Ground.avif`},it={finance:{months:48,apr:.1599},lease:{months:24,residualPct:.35}};function ia(e,t,a){if(a==="finance"){let{months:o,apr:r}=it.finance,n=r/12,i=n>0?e*n/(1-(1+n)**-o):e/o;return{amount:i,suffix:"/mo",label:"Est. finance payment",sub:`${o} monthly payments of ${C(i,t)} at ${(r*100).toFixed(2)}% APR. Estimate for illustration \u2014 payment options appear at checkout.`}}if(a==="lease"){let{months:o,residualPct:r}=it.lease;return{amount:e*(1-r)/o,suffix:"/mo",label:"Est. lease payment",sub:`${o}-month term, ${Math.round(r*100)}% residual. Estimate for illustration.`}}return{amount:e,suffix:"",label:"Est. purchase price",sub:"Taxes and shipping calculated at checkout."}}var ve=[{key:"commuter",label:"Olto Commuter",tagline:"Everything you need to commute every day.",popular:!0,price:200,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","olto-water-bottle-holder","open-face-helmet","bottom-cover"]},{key:"cargo",label:"Olto Cargo",tagline:"Carry everything.",price:700,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","charger-bag","olto-rear-rack","olto-rear-basket","olto-soft-bag","olto-side-mounting-plate","accessory-plate","olto-center-stand"]},{key:"max",label:"Olto Max",tagline:"Fully loaded. Full power.",price:950,items:["olto-sidewalls","olto-charging-dock","olto-phone-mount","olto-water-bottle-holder","charger-bag","olto-rear-rack","olto-rear-basket","olto-soft-bag","olto-side-mounting-plate","accessory-plate","olto-center-stand","olto-super-charger"]}],ja=new Set(["bottom-cover"]),Ya=[{value:"40 mi",label:"Range (est.)"},{value:"20 mph",label:"Top Speed"},{value:"Class 2",label:"E-bike"}];function C(e,t="USD"){let a=Number(e)||0,o=a%1===0?0:2;return t==="USD"?`$${a.toLocaleString("en-US",{minimumFractionDigits:o,maximumFractionDigits:o})}`:`${t} ${a.toFixed(2)}`}function g(e){return String(e!=null?e:"").replace(/[&<>"']/g,t=>`&#${t.charCodeAt(0)};`)}function W(e,t){return e?`${e}${e.includes("?")?"&":"?"}width=${t}`:""}function sa({config:e,products:t,wrapVariantsByColor:a}){let o=Object.entries(e.variants),[r]=o.find(([d])=>d===e.defaultVariantId)||o[0],n=Math.min(...t.main.variants.map(d=>parseFloat(d.price.amount))),{months:i,apr:s}=it.finance,l=s/12,c=Math.round(n*l/(1-(1+l)**-i));return`
    ...
    <section class="hero" aria-label="Olto">
      ...
      <div class="hero_layers" data-layers>
        ${Object.entries(st).map(([d,f])=>`<img class="hero_layer" data-layer="${g(d)}" src="${g(f)}" alt="" aria-hidden="true" />`).join("")}
      </div>
    </section>
    ...
    <main class="sheet">
      ...
      <section class="opt opt--acc" data-section="accessories">
        ...
        <div class="acc-list" data-acc-list>
          ${t.accessories.filter(d=>!ja.has(d.handle)).map(d=>Ja(d)).join("")}
        </div>
      </section>
  ...
  `}function Wa(e,t,a){var s,l;let o=(s=t.find(([,c])=>/silver/i.test(c.color)))==null?void 0:s[1],r=(l=t.find(([,c])=>/black/i.test(c.color)))==null?void 0:l[1],n={...e.wrapColorMap,Black:(r==null?void 0:r.colorHex)||"#1c1c1e"},i=["Black","Sand","Blush","Forest","Crimson"].filter(c=>a.has(c));return`
  ...
  `}function Qa(e){return`
    <section class="opt" data-section="bundles">
      ...
      <div class="kit-list">
        ${ve.map(t=>Za(t,e)).join("")}
      </div>
    </section>
  `}function Za(e,t){let a=e.items.reduce((i,s)=>{let l=Q(t.accessories.find(c=>c.handle===s));return i+(l?parseFloat(l.price.amount):0)},0),o=a-e.price,r=e.items.map(i=>{let s=t.accessories.find(l=>l.handle===i);return((s==null?void 0:s.title)||i).replace(/^Olto /,"")}),n=e.items.length?`<div class="kit_price">+${C(e.price)}</div>
  ...
  `}function Ja(e){var a;let t=Q(e);return t?`
  ...
  `:""}function Q(e){return e&&(e.variants.find(t=>t.availableForSale)||e.variants[0])||null}function la(e,t){var r;let a=[];if(e.bikeLine){let n=((r=t.variants[e.baseNumericId])==null?void 0:r.color)||e.bikeLine.merchandise.title;a.push({label:`Olto &middot; ${g(n)}`,amount:parseFloat(e.bikeLine.merchandise.price.amount)})}e.wrapLine&&a.push({label:`Wrap &middot; ${g(e.wrapLine.merchandise.title)}`,amount:parseFloat(e.wrapLine.merchandise.price.amount)});for(let n of e.accessoryLines)a.push({label:g(n.merchandise.product.title),amount:parseFloat(n.merchandise.price.amount)});let o=e.quantity>1?`<div class="summary_qty">&times;${e.quantity} configurations</div>`:"";return a.map(n=>`
      ...
      </div>`).join("")+o}var A=window.gsap||null;A&&window.ScrollTrigger&&A.registerPlugin(window.ScrollTrigger);var x={...vt},m=null,k=null,Z=new Map,ae="a",we=null,Xa=new Set(["Sand"]),eo="Ships now",to="Now",ft="",ca=null,lt=0,ct=null;async function ma(e){var o,r,n;if(m=e,!m){console.error("[Olto] mount(): no root element \u2014 nothing rendered.");return}m.classList.add("olto-cfg"),ro();let t=(o=Object.entries(x.variants).find(([,i])=>/silver/i.test(i.color)))==null?void 0:o[0];t&&(x.defaultVariantId=t);try{k=await Xt(x)}catch(i){console.error("[Tesla] Failed to load products:",i),no();return}await ao(),Z=oo(k.wrap),Ft(k),await Ut(x),ta({config:x,products:k,bundles:ve.filter(i=>i.items.length).map(i=>({handle:i.key,products:i.items.map(s=>({handle:s}))}))}),m.innerHTML=sa({config:x,products:k,wrapVariantsByColor:Z}),io(),aa(re),re(S()),ho();let a=uo();a?po(a):S().bikeLine||me(k.main.handle,ye(x.defaultVariantId)),vo(),xo(),V("view_configurator");for(let i of Z.values())(r=i.image)!=null&&r.url&&(new Image().src=i.image.url);for(let i of k.main.variants)(n=i.image)!=null&&n.url&&(new Image().src=W(i.image.url,1600))}async function ao(){try{let{data:e}=await P.request('query { product(handle: "bottom-cover") { id handle title availableForSale featuredImage { url altText } variants(first: 5) { edges { node { id title availableForSale price { amount currencyCode } selectedOptions { name value } image { url altText } } } } } }'),t=e==null?void 0:e.product;t&&k.accessories.push({...t,variants:t.variants.edges.map(a=>a.node)})}catch(e){console.warn("[Tesla] Kit-only product fetch failed:",e)}}function oo(e){var a;let t=new Map;if(!e)return t;for(let o of e.variants){let r=(a=o.selectedOptions)==null?void 0:a.find(i=>/colou?rs?/i.test(i.name)),n=(r==null?void 0:r.value)||o.title;n&&t.set(n,o)}return t}function ro(){if(document.getElementById("olto-tesla-css"))return;let e=document.createElement("style");e.id="olto-tesla-css",e.textContent=oa,document.head.appendChild(e)}function no(){m.innerHTML=`
    <div class="boot">
  ...
  `}function io(){m.addEventListener("click",e=>{let t=e.target.closest("[data-color-swatch]");if(t)return lo(t.dataset.colorSwatch);let a=e.target.closest("[data-acc-scroll]");if(a)return so(Number(a.dataset.accScroll));let o=e.target.closest("[data-acc-toggle]");if(o)return co(o.dataset.accToggle);let r=e.target.closest("[data-bundle]");if(r)return ga(r.dataset.bundle);let n=e.target.closest("[data-pay-mode]");if(n)return be(n.dataset.payMode);if(e.target.closest("[data-qty-dec]"))return ua(-1);if(e.target.closest("[data-qty-inc]"))return ua(1);if(e.target.closest("[data-save]"))return e.target.closest("[data-nudge]")&&pa(),ba("save");if(e.target.closest("[data-save-close]"))return Ca(!1);if(e.target.closest("[data-nudge-close]"))return pa();if(e.target.closest("[data-config-reset]"))return fo();if(e.target.closest("[data-cta]"))return e.preventDefault(),mo()}),m.addEventListener("submit",e=>{if(e.target.closest("[data-save-form]")){e.preventDefault(),bo(e.target);return}e.target.closest("[data-wf-form-slot]")&&(va(),V("form_submit",{form_name:"Olto Interest Form"}))})}var dt=null;function so(e){let t=m.querySelector("[data-acc-list]");if(!t)return;let a=t.scrollLeft,o=Math.max(0,Math.min(t.scrollWidth-t.clientWidth,a+e*320));if(A&&!document.hidden){dt&&dt.kill();let r={v:a};dt=A.to(r,{v:o,duration:.45,ease:"power2.out",onUpdate:()=>{t.scrollLeft=r.v}})}else t.scrollLeft=o}var ha=Promise.resolve();function ne(e,t){let a=me(e,t);return ha=a.catch(()=>null),a}function lo(e){V("select_color",{olto_selected_color:e||"Silver"});let t=x.wrap.productHandle;if(!e)return ne(t,null);let a=Z.get(e);a&&ne(t,a.id)}function co(e){var r,n;let t=S(),a=t.accessoryLines.some(i=>i.merchandise.product.handle===e);V(a?"remove_accessory":"add_accessory",{olto_accessory:e});let o=x.accessoryDependencies||{};if(a){ne(e,null);let i=((r=o[e])==null?void 0:r.requiredBy)||[];for(let s of i)t.accessoryLines.some(l=>l.merchandise.product.handle===s)&&ne(s,null);return}da(e);for(let[i,s]of Object.entries(o))(n=s.requiredBy)!=null&&n.includes(e)&&(t.accessoryLines.some(c=>c.merchandise.product.handle===i)||da(i))}function da(e){let t=k.accessories.find(o=>o.handle===e),a=Q(t);a&&ne(e,a.id)}var ut=!1,Ce=null,B=null;async function ga(e){if(V("select_bundle",{olto_selected_bundle:e||"none"}),ut){e!==(B==null?void 0:B.value)&&(Ce=e,B={value:e},re(S()));return}ut=!0;let t=S().activeBundle===e?null:e;B={value:t},re(S());try{await ha;let a=S().accessoryLines.map(n=>n.id).filter(n=>!String(n).startsWith("tmp_"));a.length&&await Qe(a);let o=ve.find(n=>n.key===e);if(!t||!(o!=null&&o.items.length))return;let r=o.items.map(n=>{let i=Q(k.accessories.find(s=>s.handle===n));return i?{variantId:i.id,attributes:{_bundle:e}}:null}).filter(Boolean);r.length&&await We(r)}catch(a){console.error("[Tesla] Bundle select failed:",a)}finally{if(ut=!1,Ce){let a=Ce;Ce=null,ga(a)}else B=null,re(S())}}function ua(e){V("change_quantity",{olto_quantity_delta:e});let t=S(),a=[t.bikeLine,t.wrapLine,...t.accessoryLines].filter(Boolean),o=Math.min(99,Math.max(1,t.quantity+e));if(o===t.quantity)return;let r=a.filter(n=>!String(n.id).startsWith("tmp_"));Promise.all(r.map(n=>Gt({lineId:n.id,quantity:o})))}function uo(){let e=new URLSearchParams(window.location.search).get("d");if(!e)return null;let[t,a,o,r,n]=e.split(".");return!t||!x.variants[t]?null:{base:t,wrap:a||null,qty:Math.min(99,Math.max(1,parseInt(o,10)||1)),pay:["cash","lease","finance"].includes(r)?r:"finance",accs:(n||"").split("~").filter(Boolean)}}async function po(e){Ye();let t=[{variantId:ye(e.base),quantity:e.qty}],a=e.wrap?Z.get(e.wrap):null;a&&t.push({variantId:a.id,quantity:e.qty});for(let r of e.accs){let n=Q(k.accessories.find(i=>i.handle===r));n&&t.push({variantId:n.id,quantity:e.qty})}be(e.pay);try{await We(t)}catch(r){console.error("[Tesla] Failed to apply shared design:",r)}let o=new URLSearchParams(window.location.search);o.delete("d"),window.history.replaceState({},"",`${window.location.pathname}?${o.toString()}`)}function ya(){let e=S(),t=e.wrapLine?xe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"",a=e.accessoryLines.map(n=>n.merchandise.product.handle).join("~"),o=[e.baseNumericId,t,e.quantity,e.payMode,a].join("."),r=new URL(window.location.href);return r.searchParams.set("d",o),r.toString()}var oe=null;function pt(e,t){for(let a of m.querySelectorAll("[data-config-reset]"))a.textContent=e,a.classList.toggle("is-armed",t)}async function fo(){if(!oe){pt("Tap again to clear",!0),oe=setTimeout(()=>{oe=null,pt("Clear configuration",!1)},3e3);return}clearTimeout(oe),oe=null,pt("Clear configuration",!1);try{await zt(ee())}catch(e){console.error("[Tesla] Clear failed:",e)}be("finance"),me(k.main.handle,ye(x.defaultVariantId))}function mo(){let e=S();if(!e.ready)return;if(e.region==="row")return ba("row");let t=je();t&&(V("begin_checkout",{checkout_url:t}),window.location.href=t)}function ho(){let e=m.querySelector("[data-nudge]"),t=m.querySelector('[data-section="payment"]');if(!e||!t)return;let a=new IntersectionObserver(o=>{o.some(r=>r.isIntersecting)&&(a.disconnect(),e.hidden=!1,requestAnimationFrame(()=>e.classList.add("is-in")))},{threshold:.3});a.observe(t)}function pa(){let e=m.querySelector("[data-nudge]");!e||e.hidden||(e.classList.remove("is-in"),setTimeout(()=>{e.hidden=!0},450))}function ba(e){let t=m.querySelector("[data-save-modal]");if(!t)return;let a=e==="row",o=t.querySelector("[data-save-title]"),r=t.querySelector("[data-save-copy]");o&&(o.textContent=a?"Register your interest":"Save your design"),r&&(r.textContent=a?"Olto ships in the United States and Canada today. Leave your details and we\u2019ll tell you the moment it reaches you.":"We\u2019ll save this exact Olto so you can pick up where you left off on any device."),va(),V(a?"interest_form_open":"save_configuration_open"),Ca(!0)}function go(){var a,o;let e=S(),t=e.wrapLine?xe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"";return{location:ft,variant:((o=(a=x.variants)==null?void 0:a[e.baseNumericId])==null?void 0:o.color)||"",wrap:t,pack:e.activeBundle||"",quantity:String(e.quantity||1),accessories:e.accessoryLines.map(r=>r.merchandise.product.title).filter(Boolean).join(", "),design_url:ya()}}function va(){let e=m.querySelector("[data-wf-form-slot] form");if(!e)return;let t=go();for(let[a,o]of Object.entries(t)){let r=e.querySelector(`input[name="${a}"]`);r&&(r.value=o)}}function V(e,t){var a,o;try{let r=S();window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:e,configurator:"olto",olto_variant:((o=(a=x.variants)==null?void 0:a[r.baseNumericId])==null?void 0:o.color)||"",olto_wrap:r.wrapLine?xe(r.wrapLine.merchandise)||r.wrapLine.merchandise.title:"",olto_pack:r.activeBundle||"",olto_quantity:r.quantity||1,olto_accessory_count:r.accessoryLines.length,olto_value:Number(r.total||0),olto_currency:r.currency||"USD",olto_region:r.region||"unresolved",olto_config_id:ee()||"",...t||{}})}catch(r){console.warn("[Olto] dataLayer push failed:",r)}}var wa="olto_tesla_lead";function yo(){try{let e=JSON.parse(localStorage.getItem(wa));return e!=null&&e.email?e:null}catch{return null}}function Ca(e){var a;let t=m.querySelector("[data-save-modal]");if(t&&(t.hidden=!e,e)){let o=t.querySelector("[data-save-form]"),r=t.querySelector("[data-save-done]");if(o){o.hidden=!1;let n=yo();for(let i of["name","email","phone"]){let s=o.querySelector(`input[name="${i}"]`);s&&!s.value&&(s.value=(n==null?void 0:n[i])||"")}}r&&(r.hidden=!0),(a=t.querySelector('input[name="name"]'))==null||a.focus()}}async function bo(e){let t=e.name.value.trim(),a=e.email.value.trim(),o=e.phone.value.trim(),r=e.querySelector("[data-save-error]"),n=null;if(t?/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a)?o.replace(/\D/g,"").length<7&&(n="That phone number looks too short."):n="That email doesn\u2019t look right.":n="Please add your name.",n){r&&(r.textContent=n,r.hidden=!1);return}r&&(r.hidden=!0);try{localStorage.setItem(wa,JSON.stringify({name:t,email:a,phone:o}))}catch{}let i=ya(),s=!0;try{await navigator.clipboard.writeText(i)}catch{s=!1}e.hidden=!0;let l=m.querySelector("[data-save-done]");if(l){l.hidden=!1;let c=l.querySelector("[data-save-done-msg]");c&&(c.textContent=s?"Link copied to your clipboard \u2014 it rebuilds this exact Olto.":"Copy your link below \u2014 it rebuilds this exact Olto.");let d=l.querySelector("[data-save-link]");d&&(d.textContent=i)}}async function vo(){var a;let e=new AbortController,t=setTimeout(()=>e.abort(),8e3);try{let r=(await(await fetch("https://get.geojs.io/v1/ip/country",{signal:e.signal})).text()).trim().toUpperCase();ft=((a=Jt.find(n=>n.Code===r))==null?void 0:a.Name)||"",rt(["US","CA"].includes(r)?"us":"row")}catch{ft="",rt("")}finally{clearTimeout(t)}}function wo(e){if(!(!e||e===ca)){ca=e;try{let t=new URLSearchParams(window.location.search);if(t.get("variant")===String(e))return;t.set("variant",String(e)),window.history.replaceState({},"",`${window.location.pathname}?${t}${window.location.hash}`)}catch(t){console.warn("[Olto] variant param sync failed:",t)}}}function re(e){var F,D,mt,ht,gt,yt,bt;if(!e.ready)return;wo(e.baseNumericId),K("[data-delivery]",eo),K("[data-rail-delivery]",to);let t=e.wrapLine?xe(e.wrapLine.merchandise)||e.wrapLine.merchandise.title:"";for(let u of m.querySelectorAll("[data-color-swatch]"))u.classList.toggle("is-selected",e.wrapLine?u.dataset.colorSwatch===t:u.dataset.colorSwatch==="");let a=new Set(e.accessoryLines.map(u=>u.merchandise.product.handle)),o={},r=new Set;for(let u of x.customImageRules||[])if(u.when.every(v=>a.has(v))){Object.assign(o,u.replace||{});for(let v of u.hide||[])r.add(v)}let n=!1;for(let u of m.querySelectorAll("[data-layer]")){let v=u.dataset.layer,L=a.has(v)&&!r.has(v),U=o[v]||st[v];U&&u.getAttribute("src")!==U&&u.setAttribute("src",U),u.classList.toggle("is-on",L),L&&(n=!0)}let i=(D=(F=k.main.variants.find(u=>ge(u.id)===e.baseNumericId))==null?void 0:F.image)==null?void 0:D.url,s=e.region==="row"?"eu":"us",l=(s==="eu"?meta.backgroundImage:W(i,1600))||W(i,1600)||meta.backgroundImage,c=e.wrapLine?(ht=(mt=Z.get(t))==null?void 0:mt.image)==null?void 0:ht.url:null,d=c&&!Xa.has(t);if(e.wrapLine&&t==="Black"){let u=k.main.variants.find(v=>{var L;return((L=x.variants[ge(v.id)])==null?void 0:L.color)==="Black"});(gt=u==null?void 0:u.image)!=null&&gt.url&&(c=W(u.image.url,1600),d=!0)}t==="Custom"&&(c=null),(yt=m.querySelector("[data-layers]"))==null||yt.classList.toggle("is-suppressed",!!c&&!d&&n),c?fa(c,`wrap:${t}`):fa(l,`base:${e.baseNumericId}:${s}`);let f=B?B.value:e.activeBundle;for(let u of m.querySelectorAll("[data-bundle]"))u.classList.toggle("is-selected",u.dataset.bundle===f);let h=new Set(e.accessoryLines.map(u=>u.merchandise.product.handle));for(let u of m.querySelectorAll("[data-acc-toggle]")){let v=h.has(u.dataset.accToggle);u.textContent=v?"Added":"Add",u.classList.toggle("is-added",v),(bt=u.closest("[data-acc]"))==null||bt.classList.toggle("is-added",v)}let y=m.querySelector("[data-acc-list]");if(y){let u=[...y.querySelectorAll(".acc")],v=[...u].sort((L,U)=>(h.has(L.dataset.acc)?1:0)-(h.has(U.dataset.acc)?1:0));if(u.some((L,U)=>L!==v[U]))for(let L of v)y.appendChild(L)}K("[data-qty-value]",String(e.quantity));let M=la(e,x);for(let u of m.querySelectorAll("[data-summary]"))u.innerHTML!==M&&(u.innerHTML=M);K("[data-summary-total]",C(e.total,e.currency));let w=ia(e.total,e.currency,e.payMode);for(let u of m.querySelectorAll("[data-pay-mode]"))u.classList.toggle("is-active",u.dataset.payMode===e.payMode);K("[data-pay-figure]",C(w.amount,e.currency)+w.suffix),K("[data-pay-sub]",w.sub),Co(w.amount,w.suffix,e.currency),K("[data-total-label]",w.label);let $=m.querySelector("[data-cta]");if($){let u=e.region==="row"?"":je();$.setAttribute("href",u||"#")}$&&($.textContent=e.region==="row"?"Register interest":"Order")}function xe(e){var a;let t=(a=e.selectedOptions)==null?void 0:a.find(o=>/colou?rs?/i.test(o.name));return(t==null?void 0:t.value)||null}function K(e,t){for(let a of m.querySelectorAll(e))a.textContent!==t&&(a.textContent=t)}function Co(e,t,a){let o=m.querySelector("[data-total]");if(o){if(A&&!document.hidden&&lt!==e){ct&&ct.kill();let r={v:lt};ct=A.to(r,{v:e,duration:.45,ease:"power2.out",onUpdate:()=>{o.textContent=C(r.v,a)+t},onComplete:()=>{o.textContent=C(e,a)+t}})}else o.textContent=C(e,a)+t;lt=e}}function fa(e,t){if(!e||t===we)return;let a={a:m.querySelector('[data-hero-img="a"]'),b:m.querySelector('[data-hero-img="b"]')};if(!a.a||!a.b)return;if(we===null){a[ae].src=e,we=t;return}let o=a[ae],r=a[ae==="a"?"b":"a"];r.src=e,ae=ae==="a"?"b":"a",we=t,A?(A.set(r,{opacity:0,scale:1.04,xPercent:0,yPercent:0}),r.classList.add("is-active"),A.to(r,{opacity:1,scale:1,duration:.45,ease:"power2.out"}),A.to(o,{opacity:0,duration:.45,ease:"power2.out",onComplete:()=>o.classList.remove("is-active")})):(r.classList.add("is-active"),r.style.opacity=1,o.classList.remove("is-active"),o.style.opacity=0)}function xo(){if(!A||!window.ScrollTrigger||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let e=m.querySelector(".sheet");for(let t of m.querySelectorAll(".opt"))A.from(t,{y:24,opacity:0,duration:.45,ease:"power2.out",scrollTrigger:{trigger:t,scroller:e,start:"top 88%",once:!0}})}var xa="[data-tesla-app]",_a="wf-form-Olto-Interest-Form";_o();async function _o(){let e=document.querySelector(xa);if(!e){console.error(`[Olto] No ${xa} on the page \u2014 configurator not mounted.`);return}No(e),So(),await ma(e),ko(e)}function No(e){let t=[];for(let a=e.parentElement;a&&a!==document.documentElement;a=a.parentElement){let o=getComputedStyle(a);(o.transform!=="none"||o.filter!=="none"||o.perspective!=="none"||o.contain!=="none"||o.willChange&&/transform|filter|perspective/.test(o.willChange))&&t.push(a)}t.length&&console.error("[Olto] Mount has ancestor(s) creating a containing block \u2014 every fixed region will collapse. Move the mount to a direct child of <body>.",t)}function So(){if(document.querySelector("[sf-token][sf-domain]"))return;let e=0,t=setInterval(()=>{if(document.querySelector("[sf-token][sf-domain]"))return clearInterval(t);e+=1,!(e<40)&&(clearInterval(t),console.error("[Olto] No [sf-token][sf-domain] on this page. im-attribution cannot write im_* onto the Shopify cart, so orders will reach the CRM with no source. Restore the Shopyflow host element before shipping."))},250)}function ko(e){let t=e.querySelector("[data-wf-form-slot]"),a=document.getElementById(_a);if(!t){console.error("[Olto] No [data-wf-form-slot] in the rendered UI \u2014 form not adopted.");return}if(!a){console.error(`[Olto] #${_a} not found on the page. Rest-of-world interest and US save would both capture nothing \u2014 leaving the fallback form in place.`);return}t.appendChild(a.closest(".w-form")||a),t.hidden=!1;let o=e.querySelector("[data-save-form]");o&&o.remove()}})();
