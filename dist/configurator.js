"use strict";(()=>{var ve={id:"olto",product:{handle:"olto-1"},accessoriesCollection:"olto-accessories",wrap:{productHandle:"olto-wrap"},bundles:{metaobjectType:"bundles"},variants:{"44842879156380":{color:"Black",colorHex:"#000000",delivery:"June 2026",backgroundImage:"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/68ff73905e7daa5ef224c5d5_olto-eu-black.avif"},"44842879123612":{color:"Silver",colorHex:"#D9D9D9",delivery:"July 2026",backgroundImage:"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/68ff7390e94ecc537b713a30_olto-eu-silver.avif"}},defaultVariantId:"44842879156380",wrapColorMap:{Sand:"#DECEAF",Blush:"#F6C6DC",Sky:"#707A8D",Forest:"#627063",Crimson:"#B44C47"},accessoryDependencies:{"olto-rear-rack":{requiredBy:["olto-rear-basket","olto-side-mounting-plate"]}},customImageRules:[{when:["olto-soft-bag","olto-rear-basket"],replace:{"olto-soft-bag":"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/69219c3d619077ba6f1689ed_Soft%20Bag%20in%20Rear%20Basket.avif"}},{when:["olto-charging-dock","olto-battery"],replace:{"olto-battery":"https://cdn.prod.website-files.com/66856cd71d6df6db1cada051/6921a4037d0eab061d3d7ca4_Battery%20Dock%20with%20Battery%20Plugged%20in.avif"},hide:["olto-charging-dock"]}]};var qr={olto:ve},Et=qr;function St(t,{startOpen:e=!0}={}){let r=document.querySelector(`[data-step-${t}="head"]`),n=document.querySelector(`[data-step-${t}="content"]`),o=document.querySelector(`[data-step-${t}="meta"]`);if(!r||!n||!o)return null;n.style.overflow="hidden",n.style.transition="height 0.3s ease-out",o.style.transition="opacity 0.3s ease-in-out, visibility 0.3s ease-in-out";let i=e;i?(o.style.opacity="0",o.style.visibility="hidden"):(n.style.height="0px",o.style.opacity="1",o.style.visibility="visible");function s(){n.style.height="auto";let d=n.scrollHeight;n.style.height="0px",requestAnimationFrame(()=>{n.style.height=d+"px"}),o.style.opacity="0",o.style.visibility="hidden",i=!0}function a(){i&&(n.style.height="0px",o.style.opacity="1",o.style.visibility="visible",i=!1)}function c(){i?a():s()}return r.addEventListener("click",c),{open:s,collapse:a,toggle:c}}var xe=window.jQuery;xe||console.error("[Configurator] jQuery not found on window. The configurator requires jQuery.");var l=xe;function _(t){l(t).css({display:"flex",opacity:"1"})}function E(t){l(t).hide().css("opacity","0")}var Ee="is-error",Ce="is-disabled",Se="field-validation",Ie="input:visible[data-required], select:visible[data-required], textarea:visible[data-required]",Hr="[buy-button], [deposit-button], [form-button]";function Ae(){l(document).on("change",Ie,$e),$e()}function $e(){let t=!0;l(Ie).each(function(){let e=l(this),r=e.closest("[step-block]").find("[option-head]");if(!e.val()||e.val().trim()===""){Fr(r),t=!1;return}Ur(r)}),Vr(t)}function Fr(t){t.addClass(Ee),_(t.find(`[${Se}]`))}function Ur(t){t.removeClass(Ee),E(t.find(`[${Se}]`))}function Vr(t){let e=l(Hr);t?e.removeClass(Ce):e.addClass(Ce)}var jr=["United States","Canada"],Mr={us:{reveal:'[data-delivery-date="us"],[data-meta-side],[data-eu-price]',hide:'[data-delivery-date="eu"]',active:'[data-img-local="us"]',inactive:'[data-img-local="eu"]'},eu:{reveal:'[data-delivery-date="eu"],[data-meta-side],[data-eu-price]',hide:'[data-delivery-date="us"]',active:'[data-img-local="eu"]',inactive:'[data-img-local="us"]'}},At="",It=null,it=[];function _e(){return At}function Re(t){return it.push(t),()=>{let e=it.indexOf(t);e>=0&&it.splice(e,1)}}function Te(){let t=l("#country");t.length&&(Kr(t),Qr(t),Gr(t))}function Kr(t){let e=window.countries;if(!Array.isArray(e)){console.warn("[Configurator] window.countries not found \u2014 skipping country list population");return}for(let r of e){let n=document.createElement("option");n.value=r.Name,n.textContent=r.Name,n.setAttribute("data-code",r.Code),t.append(n)}}function Qr(t){t.on("change",()=>Oe(t))}function Gr(t){let e=r=>{let n=(r==null?void 0:r.country_code)||"US";zr(t,n)};if(window.__geoipData){e(window.__geoipData);return}window.geoip=e}function zr(t,e){let r=t.find("option");for(let n=0;n<r.length;n++)if(l(r[n]).attr("data-code")===e){t.prop("selectedIndex",n),Oe(t);return}}function Oe(t){It=t.val();let e=jr.includes(It)?"us":"eu",r=Mr[e];At=e,_(l(r.reveal)),E(l(r.hide)),l(r.active).addClass("active"),l(r.inactive).removeClass("active"),Yr(e),it.forEach(n=>n({region:At,country:It}))}function Yr(t){let e=l("[payment-block]"),r=l("[form-block]"),n=l("[buy-button]"),o=l("[form-button]"),i=l("[deposit-button]"),s=l("[data-deposit-email]"),a=l("[data-total-block]");t==="us"?(_(e),_(n),_(a),E(r),E(o),E(i),E(s)):(E(e),E(n),E(i),E(a),E(s),_(r),_(o))}var K=null,Le=null,Wr=null,at=[];function ke(t){Le=t.defaultVariantId||null,st(),Wr=setInterval(st,100),window.addEventListener("popstate",st)}function De(){return K}function Q(t){let e=new URLSearchParams(window.location.search);e.set("variant",t);let r=`${window.location.pathname}?${e.toString()}`;window.history.pushState({},"",r),st()}function ct(t){return at.push(t),K&&t(K),()=>{at=at.filter(e=>e!==t)}}function st(){let t=new URLSearchParams(window.location.search),e=t.getAll("variant"),r=e.length?e[e.length-1]:null;if(r||(r=Le),!!r){if(e.length!==1||e[0]!==r){t.delete("variant"),t.set("variant",r);let n=`${window.location.pathname}?${t.toString()}`;window.history.replaceState({},"",n)}r!==K&&(K=r,at.forEach(n=>n(r)))}}var q="GraphQL Client";var _t="An error occurred while fetching from the API. Review 'graphQLErrors' for details.",Rt="Response returned unexpected Content-Type:",Tt="An unknown error has occurred. The API did not return a data object or any errors in its response.",lt={json:"application/json",multipart:"multipart/mixed"},Ot="X-SDK-Variant",Lt="X-SDK-Version",Pe="shopify-graphql-client",Be="1.4.2",dt=1e3,qe=[429,503],kt=/@(defer)\b/i,Ne=`\r
`,He=/boundary="?([^=";]+)"?/i,Dt=Ne+Ne;function R(t,e=q){return t.startsWith(`${e}`)?t:`${e}: ${t}`}function L(t){return t instanceof Error?t.message:JSON.stringify(t)}function Nt(t){return t instanceof Error&&t.cause?t.cause:void 0}function Pt(t){return t.flatMap(({errors:e})=>e!=null?e:[])}function ut({client:t,retries:e}){if(e!==void 0&&(typeof e!="number"||e<0||e>3))throw new Error(`${t}: The provided "retries" value (${e}) is invalid - it cannot be less than ${0} or greater than ${3}`)}function S(t,e){return e&&(typeof e!="object"||Array.isArray(e)||typeof e=="object"&&Object.keys(e).length>0)?{[t]:e}:{}}function Bt(t,e){if(t.length===0)return e;let n={[t.pop()]:e};return t.length===0?n:Bt(t,n)}function Ve(t,e){return Object.keys(e||{}).reduce((r,n)=>(typeof e[n]=="object"||Array.isArray(e[n]))&&t[n]?(r[n]=Ve(t[n],e[n]),r):(r[n]=e[n],r),Array.isArray(t)?[...t]:{...t})}function qt([t,...e]){return e.reduce(Ve,{...t})}function Ht({clientLogger:t,customFetchApi:e=fetch,client:r=q,defaultRetryWaitTime:n=dt,retriableCodes:o=qe}){let i=async(s,a,c)=>{let d=a+1,f=c+1,u;try{if(u=await e(...s),t({type:"HTTP-Response",content:{requestParams:s,response:u}}),!u.ok&&o.includes(u.status)&&d<=f)throw new Error;let p=(u==null?void 0:u.headers.get("X-Shopify-API-Deprecated-Reason"))||"";return p&&t({type:"HTTP-Response-GraphQL-Deprecation-Notice",content:{requestParams:s,deprecationNotice:p}}),u}catch(p){if(d<=f){let h=u==null?void 0:u.headers.get("Retry-After");return await Xr(h?parseInt(h,10):n),t({type:"HTTP-Retry",content:{requestParams:s,lastResponse:u,retryAttempt:a,maxRetries:c}}),i(s,d,c)}throw new Error(R(`${c>0?`Attempted maximum number of ${c} network retries. Last message - `:""}${L(p)}`,r))}};return i}async function Xr(t){return new Promise(e=>setTimeout(e,t))}function Ft({headers:t,url:e,customFetchApi:r=fetch,retries:n=0,logger:o}){ut({client:q,retries:n});let i={headers:t,url:e,retries:n},s=Jr(o),a=Ht({customFetchApi:r,clientLogger:s,defaultRetryWaitTime:dt}),c=Zr(a,i),d=tn(c),f=cn(c);return{config:i,fetch:c,request:d,requestStream:f}}function Jr(t){return e=>{t&&t(e)}}async function je(t){let{errors:e,data:r,extensions:n}=await t.json();return{...S("data",r),...S("extensions",n),headers:t.headers,...e||!r?{errors:{networkStatusCode:t.status,message:R(e?_t:Tt),...S("graphQLErrors",e),response:t}}:{}}}function Zr(t,{url:e,headers:r,retries:n}){return async(o,i={})=>{let{variables:s,headers:a,url:c,retries:d,keepalive:f,signal:u}=i,p=JSON.stringify({query:o,variables:s});ut({client:q,retries:d});let h=Object.entries({...r,...a}).reduce((y,[g,v])=>(y[g]=Array.isArray(v)?v.join(", "):v.toString(),y),{});!h[Ot]&&!h[Lt]&&(h[Ot]=Pe,h[Lt]=Be);let w=[c!=null?c:e,{method:"POST",headers:h,body:p,signal:u,keepalive:f}];return t(w,1,d!=null?d:n)}}function tn(t){return async(...e)=>{if(kt.test(e[0]))throw new Error(R("This operation will result in a streamable response - use requestStream() instead."));let r=null;try{r=await t(...e);let{status:n,statusText:o}=r,i=r.headers.get("content-type")||"";return r.ok?i.includes(lt.json)?await je(r):{errors:{networkStatusCode:n,message:R(`${Rt} ${i}`),response:r}}:{errors:{networkStatusCode:n,message:R(o),response:r}}}catch(n){return{errors:{message:L(n),...r==null?{}:{networkStatusCode:r.status,response:r}}}}}}async function*en(t){let e=new TextDecoder;if(t.body[Symbol.asyncIterator])for await(let r of t.body)yield e.decode(r);else{let r=t.body.getReader(),n;try{for(;!(n=await r.read()).done;)yield e.decode(n.value)}finally{r.cancel()}}}function rn(t,e){return{async*[Symbol.asyncIterator](){try{let r="";for await(let n of t)if(r+=n,r.indexOf(e)>-1){let o=r.lastIndexOf(e),s=r.slice(0,o).split(e).filter(a=>a.trim().length>0).map(a=>a.slice(a.indexOf(Dt)+Dt.length).trim());s.length>0&&(yield s),r=r.slice(o+e.length),r.trim()==="--"&&(r="")}}catch(r){throw new Error(`Error occured while processing stream payload - ${L(r)}`)}}}}function nn(t){return{async*[Symbol.asyncIterator](){try{yield{...await je(t),hasNext:!1}}catch(e){yield{errors:{message:R(L(e)),networkStatusCode:t.status,response:t},hasNext:!1}}}}}function on(t){return t.map(e=>{try{return JSON.parse(e)}catch(r){throw new Error(`Error in parsing multipart response - ${L(r)}`)}}).map(e=>{let{data:r,incremental:n,hasNext:o,extensions:i,errors:s}=e;if(!n)return{data:r||{},...S("errors",s),...S("extensions",i),hasNext:o};let a=n.map(({data:c,path:d,errors:f})=>({data:c&&d?Bt(d,c):{},...S("errors",f)}));return{data:a.length===1?a[0].data:qt([...a.map(({data:c})=>c)]),...S("errors",Pt(a)),hasNext:o}})}function an(t,e){if(t.length>0)throw new Error(_t,{cause:{graphQLErrors:t}});if(Object.keys(e).length===0)throw new Error(Tt)}function sn(t,e){var a,c;let r=(e!=null?e:"").match(He),n=`--${r?r[1]:"-"}`;if(!((a=t.body)!=null&&a.getReader)&&!((c=t.body)!=null&&c[Symbol.asyncIterator]))throw new Error("API multipart response did not return an iterable body",{cause:t});let o=en(t),i={},s;return{async*[Symbol.asyncIterator](){var d,f;try{let u=!0;for await(let p of rn(o,n)){let h=on(p);s=(f=(d=h.find(y=>y.extensions))==null?void 0:d.extensions)!=null?f:s;let w=Pt(h);i=qt([i,...h.map(({data:y})=>y)]),u=h.slice(-1)[0].hasNext,an(w,i),yield{...S("data",i),...S("extensions",s),hasNext:u}}if(u)throw new Error("Response stream terminated unexpectedly")}catch(u){let p=Nt(u);yield{...S("data",i),...S("extensions",s),errors:{message:R(L(u)),networkStatusCode:t.status,...S("graphQLErrors",p==null?void 0:p.graphQLErrors),response:t},hasNext:!1}}}}}function cn(t){return async(...e)=>{if(!kt.test(e[0]))throw new Error(R("This operation does not result in a streamable response - use request() instead."));try{let r=await t(...e),{statusText:n}=r;if(!r.ok)throw new Error(n,{cause:r});let o=r.headers.get("content-type")||"";switch(!0){case o.includes(lt.json):return nn(r);case o.includes(lt.multipart):return sn(r,o);default:throw new Error(`${Rt} ${o}`,{cause:r})}}catch(r){return{async*[Symbol.asyncIterator](){let n=Nt(r);yield{errors:{message:R(L(r)),...S("networkStatusCode",n==null?void 0:n.status),...S("response",n)},hasNext:!1}}}}}}function Ut({client:t,storeDomain:e}){try{if(!e||typeof e!="string")throw new Error;let r=e.trim(),n=r.match(/^https?:/)?r:`https://${r}`,o=new URL(n);return o.protocol="https",o.origin}catch(r){throw new Error(`${t}: a valid store domain ("${e}") must be provided`,{cause:r})}}function ft({client:t,currentSupportedApiVersions:e,apiVersion:r,logger:n}){let o=`${t}: the provided apiVersion ("${r}")`,i=`Currently supported API versions: ${e.join(", ")}`;if(!r||typeof r!="string")throw new Error(`${o} is invalid. ${i}`);let s=r.trim();e.includes(s)||(n?n({type:"Unsupported_Api_Version",content:{apiVersion:r,supportedApiVersions:e}}):console.warn(`${o} is likely deprecated or not supported. ${i}`))}function pt(t){let e=t*3-2;return e===10?e:`0${e}`}function Vt(t,e,r){let n=e-r;return n<=0?`${t-1}-${pt(n+4)}`:`${t}-${pt(n)}`}function Me(){let t=new Date,e=t.getUTCMonth(),r=t.getUTCFullYear(),n=Math.floor(e/3+1);return{year:r,quarter:n,version:`${r}-${pt(n)}`}}function jt(){let{year:t,quarter:e,version:r}=Me(),n=e===4?`${t+1}-01`:`${t}-${pt(e+1)}`;return[Vt(t,e,3),Vt(t,e,2),Vt(t,e,1),r,n,"unstable"]}function Mt(t){return e=>({...e!=null?e:{},...t.headers})}function Kt({getHeaders:t,getApiUrl:e}){return(r,n)=>{let o=[r];if(n&&Object.keys(n).length>0){let{variables:i,apiVersion:s,headers:a,retries:c,signal:d}=n;o.push({...i?{variables:i}:{},...a?{headers:t(a)}:{},...s?{url:e(s)}:{},...c?{retries:c}:{},...d?{signal:d}:{}})}return o}}var Qt="application/json",Ke="storefront-api-client",Qe="1.0.10",Ge="X-Shopify-Storefront-Access-Token",ze="Shopify-Storefront-Private-Token",Ye="X-SDK-Variant",We="X-SDK-Version",Xe="X-SDK-Variant-Source",H="Storefront API Client";function Je(t){if(t&&typeof window!="undefined")throw new Error(`${H}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`)}function Ze(t,e){if(!t&&!e)throw new Error(`${H}: a public or private access token must be provided`);if(t&&e)throw new Error(`${H}: only provide either a public or private access token`)}function Gt({storeDomain:t,apiVersion:e,publicAccessToken:r,privateAccessToken:n,clientName:o,retries:i=0,customFetchApi:s,logger:a}){let c=jt(),d=Ut({client:H,storeDomain:t}),f={client:H,currentSupportedApiVersions:c,logger:a};ft({...f,apiVersion:e}),Ze(r,n),Je(n);let u=ln(d,e,f),p={storeDomain:d,apiVersion:e,...r?{publicAccessToken:r}:{privateAccessToken:n},headers:{"Content-Type":Qt,Accept:Qt,[Ye]:Ke,[We]:Qe,...o?{[Xe]:o}:{},...r?{[Ge]:r}:{[ze]:n}},apiUrl:u(),clientName:o},h=Ft({headers:p.headers,url:p.apiUrl,retries:i,customFetchApi:s,logger:a}),w=Mt(p),y=dn(p,u),g=Kt({getHeaders:w,getApiUrl:y});return Object.freeze({config:p,getHeaders:w,getApiUrl:y,fetch:(...$)=>h.fetch(...g(...$)),request:(...$)=>h.request(...g(...$)),requestStream:(...$)=>h.requestStream(...g(...$))})}function ln(t,e,r){return n=>{n&&ft({...r,apiVersion:n});let o=(n!=null?n:e).trim();return`${t}/api/${o}/graphql.json`}}function dn(t,e){return r=>r?e(r):t.apiUrl}var mt={SHOPIFY_STORE_DOMAIN:"shop.infinitemachine.com",SHOPIFY_STOREFRONT_PUBLIC_TOKEN:"eefb42e32220791a7472aaa5d2cf2182",SHOPIFY_API_VERSION:"2026-04"};var N=Gt({storeDomain:mt.SHOPIFY_STORE_DOMAIN,apiVersion:mt.SHOPIFY_API_VERSION,publicAccessToken:mt.SHOPIFY_STOREFRONT_PUBLIC_TOKEN});var rr="olto_cart_",un="cfg_",Yt="config",T=null,m=null,F=null,Xt=null,C=null,ht=[],gt=[];function P(t){F=t,m=t}var G=null;function nr(t){G=t}async function or(t){var r;Xt=t.id,C=tr()||cr();let e=gn();if(e)try{let n=await pn(e);n&&(T=e,P(n))}catch(n){console.warn("[Cart] Failed to restore cart, will create new:",n)}if(!T){let n=await fn();P(n),T=n.id,yn(T)}if(!tr()&&((r=m==null?void 0:m.lines)!=null&&r.length)){let n=mn(m);n&&(C=n)}return re(C),I(),ee(),m}function k(){return m}function yt(){return m==null?void 0:m.checkoutUrl}function Jt(){return C}function Zt(){return C=cr(),re(C),ee(),C}function ir(t){!t||t===C||(C=t,re(C),ee())}function bt(t){return gt.push(t),()=>{gt=gt.filter(e=>e!==t)}}async function ar(t){X();let e=F,r=((e==null?void 0:e.lines)||[]).filter(n=>{var o;return((o=n.attributesByKey)==null?void 0:o._config_id)===t}).map(n=>n.id);r.length!==0&&(await wt(r),t===C&&Zt())}async function sr(t){X();let e=m,r=Wt(C),n=t.map(i=>lr(i.variantId,i.quantity||r,{...i.attributes||{},_config_id:C})).filter(Boolean);n.length&&(m=dr(m,n),I());let o=t.map(i=>({merchandiseId:i.variantId,quantity:i.quantity||r,attributes:z({...i.attributes||{},_config_id:C})}));try{return P(await vt(()=>U("cartLinesAdd",`
...
`;async function fn(){var n;let{data:t,errors:e}=await N.request(`
    mutation CartCreate {
      cartCreate(input: {}) {
        cart { ${B} }
        userErrors { field message }
  ...
  `,{variables:{id:t}});if(r)throw new Error(`[Cart] queryCart errors: ${JSON.stringify(r)}`);return e!=null&&e.cart?te(e.cart):null}async function U(t,e,r){var s;let{data:n,errors:o}=await N.request(e,{variables:r});if(o)throw new Error(`[Cart] ${t} errors: ${JSON.stringify(o)}`);let i=n==null?void 0:n[t];if((s=i==null?void 0:i.userErrors)!=null&&s.length)throw new Error(`[Cart] ${t} userErrors: ${JSON.stringify(i.userErrors)}`);return te(i.cart)}function te(t){let e=t.attributes||[];return{id:t.id,checkoutUrl:t.checkoutUrl,totalQuantity:t.totalQuantity,cost:t.cost,attributes:e,attributesByKey:Object.fromEntries(e.map(r=>[r.key,r.value])),lines:t.lines.edges.map(({node:r})=>({id:r.id,quantity:r.quantity,attributes:r.attributes,attributesByKey:Object.fromEntries(r.attributes.map(n=>[n.key,n.value])),merchandise:r.merchandise}))}}function z(t){return Object.entries(t).filter(([,e])=>e!=null&&e!=="").map(([e,r])=>({key:e,value:String(r)}))}function X(){if(!T)throw new Error("[Cart] Called before initCart(config)")}function I(){for(let t of ht)t(m)}function cr(){return`${un}${Date.now()}_${Math.random().toString(36).slice(2,8)}`}function Wt(t){var n;let e=F||m;if(!((n=e==null?void 0:e.lines)!=null&&n.length))return 1;let r=e.lines.find(o=>{var i;return((i=o.attributesByKey)==null?void 0:i._config_id)===t});return(r==null?void 0:r.quantity)||1}function ee(){for(let t of gt)t(C)}function tr(){return typeof window=="undefined"?null:new URLSearchParams(window.location.search).get(Yt)}function re(t){if(typeof window=="undefined")return;let e=new URLSearchParams(window.location.search);t?e.set(Yt,t):e.delete(Yt),window.history.replaceState({},"",`${window.location.pathname}?${e.toString()}`)}function mn(t){var r;if(!((r=t==null?void 0:t.lines)!=null&&r.length))return null;let e=t.lines.map(n=>{var o;return(o=n.attributesByKey)==null?void 0:o._config_id}).filter(Boolean).sort();return e[e.length-1]||null}var er=Promise.resolve();async function vt(t){let e=er,r;er=new Promise(n=>{r=n}),await e;try{return await t()}finally{r()}}var zt=new Map;function hn(t,e){let r=zt.get(t)||{inflight:null,latest:null};return r.latest=e,zt.set(t,r),r.inflight||(r.inflight=(async()=>{for(;r.latest;){let n=r.latest;r.latest=null;try{await vt(n)}catch(o){console.error(`[Cart] coalesce(${t}) error:`,o)}}r.inflight=null,zt.delete(t)})()),r.inflight}async function O(t,e){X();let r=C;if(m){let n=m.lines.findIndex(o=>{var i;return o.merchandise.product.handle===t&&((i=o.attributesByKey)==null?void 0:i._config_id)===r});if(n>=0&&e===null)m={...m,lines:m.lines.filter((o,i)=>i!==n)};else if(n>=0&&e){let o=ne(e);o&&(m={...m,lines:m.lines.map((i,s)=>s===n?{...i,merchandise:o}:i)})}else if(n<0&&e){let o=Wt(r),i=lr(e,o,{_config_id:r});i&&(m=dr(m,[i]))}I()}return hn(`product:${t}:${r}`,async()=>{let n=F==null?void 0:F.lines.find(o=>{var i;return o.merchandise.product.handle===t&&((i=o.attributesByKey)==null?void 0:i._config_id)===r});if(e===null){n&&(P(await U("cartLinesRemove",`
      ...
      `,{cartId:T,lines:[{merchandiseId:e,quantity:o,attributes:z({_config_id:r})}]}))}I()})}function ne(t){if(!G)return null;let e=[G.main,G.wrap,...G.accessories||[]].filter(Boolean);for(let r of e){let n=r.variants.find(o=>o.id===t);if(n)return{id:n.id,title:n.title,price:n.price,image:n.image,selectedOptions:n.selectedOptions,product:{id:r.id,handle:r.handle,title:r.title}}}return null}function lr(t,e,r){let n=ne(t);if(!n)return null;let o=z(r);return{id:`tmp_${Math.random().toString(36).slice(2,10)}`,quantity:e,attributes:o,attributesByKey:Object.fromEntries(o.map(i=>[i.key,i.value])),merchandise:n}}function dr(t,e){return t&&{...t,lines:[...t.lines,...e],totalQuantity:(t.totalQuantity||0)+e.reduce((r,n)=>r+(n.quantity||1),0)}}function gn(){return typeof localStorage=="undefined"?null:localStorage.getItem(`${rr}${Xt}`)}function yn(t){typeof localStorage!="undefined"&&localStorage.setItem(`${rr}${Xt}`,t)}var oe=new Map,ie=`
  id
  handle
  title
  description
...
`;async function ur(t){var a;if(oe.has(t.id))return oe.get(t.id);let e=!!((a=t.wrap)!=null&&a.productHandle),r=`
...
`,Ln="mainProductHandle",Cr=null;function Er(t){var n;if(document.getElementById("cart-drawer"))return;Cr=t,Cr[Ln]=(n=t.product)==null?void 0:n.handle,l("<style>").text(On).appendTo("head");let e=l('<div id="cart-drawer-overlay"></div>'),r=l(`
  ...
  `);l("body").append(e).append(r),e.on("click",Ct),r.on("click","[data-act]",kn),x($r),$r(A())}function Sr(){l("#cart-drawer-overlay").addClass("open"),l("#cart-drawer").addClass("open").attr("aria-hidden","false")}function Ct(){l("#cart-drawer-overlay").removeClass("open"),l("#cart-drawer").removeClass("open").attr("aria-hidden","true")}function kn(t){let e=l(this),r=e.attr("data-act"),n=e.attr("data-line-id"),o=e.attr("data-session-id");if(r==="close")return Ct();if(r==="remove-line"&&n)return Y(n);if(r==="qty-up"&&n){let i=Number(e.closest(".qty").find(".v").text())||1;return W({lineId:n,quantity:i+1})}if(r==="qty-down"&&n){let i=Number(e.closest(".qty").find(".v").text())||1;return i<=1?Y(n):W({lineId:n,quantity:i-1})}if(r==="edit-config"&&o){ir(o),Ct();return}if(r==="remove-config"&&o)return confirm("Remove this entire configuration?")?ar(o):void 0;if(r==="add-another"){Zt(),Ct();return}if(r==="checkout"){let i=yt();i&&(window.location.href=i);return}}function $r(t){var i,s;if(!t)return;let e=l("#cart-drawer .body"),r=t.allConfigs||[];if(r.length===0||!((s=(i=t.cart)==null?void 0:i.lines)!=null&&s.length)){e.html('<div class="empty">Your cart is empty.</div>'),l("#cart-drawer .total-amt").text("$0.00"),l("#cart-drawer .checkout").prop("disabled",!0);return}let n=0,o=r.map((a,c)=>{var w,y;let d=[a.bikeLine,a.wrapLine,...a.accessoryLines].filter(Boolean),f=d.reduce((g,v)=>{var $;return g+parseFloat((($=v.merchandise.price)==null?void 0:$.amount)||0)*(v.quantity||1)},0);n+=f;let u=d.map(g=>Dn(g)).join(""),p=(y=(w=a.bikeLine)==null?void 0:w.merchandise.selectedOptions)==null?void 0:y.find(g=>/colou?r/i.test(g.name)),h=a.bikeLine?`Bike ${c+1}${p?` \u2014 ${p.value}`:""}`:`Configuration ${c+1}`;return`
      ...
      `}).join("");e.html(o),l("#cart-drawer .total-amt").text(fe(n)),l("#cart-drawer .checkout").prop("disabled",!1)}function Dn(t){var i,s;let e=(t.merchandise.selectedOptions||[]).filter(a=>a.value&&a.value.toLowerCase()!=="default title"),r=e.length?e.map(a=>a.value).join(" / "):"",n=((i=t.merchandise.image)==null?void 0:i.url)||"",o=parseFloat(((s=t.merchandise.price)==null?void 0:s.amount)||0)*(t.quantity||1);return`
    <div class="line">
  ...
  [data-config-qty] .stepper [data-config-qty-input] { min-width: 26px;
    text-align: center; }
`,ge=!1,ot=null;function Dr(){document.getElementById("config-qty-style")||l('<style id="config-qty-style">').text(Pn).appendTo("head");let t=l("[data-config-qty]");if(!t.length){let e=l("[buy-button]");if(!e.length){console.warn("[ConfigQuantity] No [buy-button] anchor \u2014 stepper not injected");return}t=l(`
      <div data-config-qty>
        <span>Quantity:</span>
        <div class="stepper">
    ...
    `),e.before(t)}ot=t,ot.on("click","[data-config-qty-up], [data-config-qty-down]",async function(){ge||await Bn(l(this).is("[data-config-qty-up]")?1:-1)}),x(kr),kr(A())}async function Bn(t){ge=!0;try{let e=A();if(!(e!=null&&e.cart))return;let r=e.cart.lines.filter(i=>{var s;return((s=i.attributesByKey)==null?void 0:s._config_id)===e.sessionId});if(r.length===0)return;let n=r[0].quantity||1,o=Math.max(1,n+t);if(o===n)return;await Promise.all(r.map(i=>W({lineId:i.id,quantity:o})))}catch(e){console.error("[ConfigQuantity] Error:",e)}finally{ge=!1}}function kr(t){var n;if(!ot||!(t!=null&&t.cart))return;let r=((n=t.cart.lines.filter(o=>{var i;return((i=o.attributesByKey)==null?void 0:i._config_id)===t.sessionId})[0])==null?void 0:n.quantity)||1;ot.find("[data-config-qty-input]").text(r),ot.find("[data-config-qty-down]").prop("disabled",r<=1)}var qn=`
...
`;function Nr({configId:t}){if(document.getElementById("cart-debug-panel"))return;l("<style>").text(qn).appendTo("head");let e=l(`
  ...
  `,{data:n,errors:o}=await N.request(r,{variables:{type:e}});if(o)return console.warn(`[Bundles] GraphQL errors fetching "${e}":`,o),[];let i=n.metaobjects.edges.map(({node:a})=>Hn(a));return ye.set(e,i),i}function Hn(t){var r,n;let e={id:t.id,handle:t.handle};for(let o of t.fields)(n=(r=o.references)==null?void 0:r.edges)!=null&&n.length?e[o.key]=o.references.edges.map(i=>i.node):o.reference?e[o.key]=o.reference:o.value!=null&&(e[o.key]=o.value);return e}function Fn(){l(".checkout_order-includes-items").css({height:"auto"}),l(".checkout_includes-item, .modal_ecl-image").css({opacity:1})}async function Br(t){console.log(`[Configurator] Booting "${t.id}"`),Fn(),Ae(),Te(),t.accessoriesCollection&&St("accessories"),t.wrap&&St("wraps",{startOpen:!1});let e,r=[];try{[e,r]=await Promise.all([ur(t),t.bundles?Pr(t):Promise.resolve([])])}catch(n){console.error("[Configurator] Failed to fetch products/bundles:",n);return}nr(e);try{await or(t)}catch(n){console.error("[Configurator] Failed to init cart:",n);return}pr(t,e,r),Tr(t),t.accessoriesCollection&&xr(t,e),t.accessoriesCollection&&hr(t,e),t.accessoriesCollection&&Lr(e),t.accessoryDependencies&&gr(t,e),Array.isArray(t.customImageRules)&&yr(t,e),t.bundles&&br(t,e,r),t.wrap&&wr(t,e),Er(t),Dr(),Ir(),t.product&&(_r(t,e),Ar(t,e),ke(t)),l(".checkout_product-load").hide(),console.log(`[Configurator] "${t.id}" boot complete`),Nr({configId:t.id})}var be=document.querySelector("[data-configurator]"),we=be==null?void 0:be.dataset.configurator;if(!we)console.error('[Configurator] No data-configurator attribute on <body>. Add e.g. <body data-configurator="olto">');else{let t=Et[we];t?Br(t):console.error(`[Configurator] Unknown configurator "${we}". Available: ${Object.keys(Et).join(", ")}`)}})();
